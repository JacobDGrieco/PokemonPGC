...
PPGC.register({
	dex: {
		[sub]: [
			...
			{
				id: 45, natiId: 669, name: "Flabébé", img: baseSprite(669), imgS: shinySprite(669), forms: [
			...
			{
				id: 46, natiId: 670, name: "Floette", img: baseSprite(670), imgS: shinySprite(670), forms: [
			...
			{
				id: 47, natiId: 671, name: "Florges", img: baseSprite(671), imgS: shinySprite(671), forms: [
			...
			{
				id: 54, natiId: 129, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), forms: [
					{ name: "Male", img: baseSprite(129), imgS: shinySprite(129), },
					{ name: "Female", img: baseSprite("129-f"), imgS: shinySprite("129-f"), },
				],
			},
			{
				id: 55, natiId: 130, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), forms: [
			...
			{
				id: 58, natiId: 456, name: "Finneon", img: baseSprite(456), imgS: shinySprite(456), forms: [
					{ name: "Male", img: baseSprite(456), imgS: shinySprite(456), },
					{ name: "Female", img: baseSprite("456-f"), imgS: shinySprite("456-f"), },
				],
			},
			{
				id: 59, natiId: 457, name: "Lumineon", img: baseSprite(457), imgS: shinySprite(457), forms: [
			...
			{
				id: 77, natiId: 186, name: "Politoed", img: baseSprite(186), imgS: shinySprite(186), forms: [
			...
			{
				id: 80, natiId: 550, name: "Basculin", img: baseSprite(550), imgS: shinySprite(550), forms: [
					{ name: "Blue-Striped", img: baseSprite(550), imgS: shinySprite(550), },
					{ name: "Red-Striped", img: baseSprite("550-r"), imgS: shinySprite("550-r"), },
				],
			},
			{ id: 81, natiId: 704, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), },
			{ id: 82, natiId: 705, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), },
			{ id: 83, natiId: 706, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), },
			{
				id: 84, natiId: 351, name: "Castform", img: baseSprite(351), imgS: shinySprite(351), forms: [
			...
			{
				id: 98, natiId: 774, name: "Minior", img: baseSprite(774), imgS: shinySprite(774), forms: [
			...
			{ id: 99, natiId: 374, name: "Beldum", img: baseSprite(374), imgS: shinySprite(374), },
			{ id: 100, natiId: 375, name: "Metang", img: baseSprite(375), imgS: shinySprite(375), },
			{ id: 101, natiId: 376, name: "Metagross", img: baseSprite(376), imgS: shinySprite(376), },
			...
			{
				id: 111, natiId: 229, name: "Houndoom", img: baseSprite(229), imgS: shinySprite(229), forms: [
			...
			{
				id: 128, natiId: 443, name: "Gible", img: baseSprite(443), imgS: shinySprite(443), forms: [
					{ name: "Male", img: baseSprite(443), imgS: shinySprite(443), },
					{ name: "Female", img: baseSprite("443-f"), imgS: shinySprite("443-f"), },
				],
			},
			{
				id: 129, natiId: 444, name: "Gabite", img: baseSprite(444), imgS: shinySprite(444), forms: [
					{ name: "Male", img: baseSprite(444), imgS: shinySprite(444), },
					{ name: "Female", img: baseSprite("444-f"), imgS: shinySprite("444-f"), },
				],
			},
			{
				id: 130, natiId: 445, name: "Garchomp", img: baseSprite(445), imgS: shinySprite(445), forms: [
			...
			{ id: 136, natiId: 778, name: "Mimikyu", img: baseSprite(778), imgS: shinySprite(778), },
			{ id: 137, natiId: 353, name: "Shuppet", img: baseSprite(353), imgS: shinySprite(353), },
			{ id: 138, natiId: 354, name: "Banette", img: baseSprite(354), imgS: shinySprite(354), },
			{
				id: 139, natiId: 592, name: "Frillish", img: baseSprite(592), imgS: shinySprite(592), forms: [
					{ name: "Male", img: baseSprite(592), imgS: shinySprite(592), },
					{ name: "Female", img: baseSprite("592-f"), imgS: shinySprite("592-f"), },
				],
			},
			{
				id: 140, natiId: 593, name: "Jellicent", img: baseSprite(593), imgS: shinySprite(593), forms: [
			...
			{ id: 143, natiId: 359, name: "Absol", img: baseSprite(359), imgS: shinySprite(359), },
			{ id: 144, natiId: 361, name: "Snorunt", img: baseSprite(361), imgS: shinySprite(361), },
			{ id: 145, natiId: 362, name: "Glalie", img: baseSprite(362), imgS: shinySprite(362), },
			{ id: 146, natiId: 478, name: "Froslass", img: baseSprite(478), imgS: shinySprite(478), },
			{
				id: 147, natiId: 215, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), forms: [
					{ name: "Male", img: baseSprite(215), imgS: shinySprite(215), },
					{ name: "Female", img: baseSprite("215-f"), imgS: shinySprite("215-f"), },
				],
			},
			{
				id: 148, natiId: 461, name: "Weavile", img: baseSprite(461), imgS: shinySprite(461), forms: [
			...
			{ id: 160, natiId: 787, name: "Tapu Bulu", img: baseSprite(787), imgS: shinySprite(787), legendary: true, },
		],
	},
});