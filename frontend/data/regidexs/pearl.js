...
PPGC.register({
	dex: {
		[game]: [
			...
			{ id: 146, name: "Uxie", img: baseSprite(480), imgS: shinySprite(480), dexSync: [nationalDex(480)], tags: ["legendary"] },
			{ id: 147, name: "Mesprit", img: baseSprite(481), imgS: shinySprite(481), dexSync: [nationalDex(481)], tags: ["legendary"] },
			{ id: 148, name: "Azelf", img: baseSprite(482), imgS: shinySprite(482), dexSync: [nationalDex(482)], tags: ["legendary"] },
