...
PPGC.register({
	dex: {
		[game]: [
			...
			{ id: 144, name: "Articuno", img: baseSprite(144), imgS: shinySprite(144), legendary: true, taskSync: ["blue-catching-1-01"], },
			{ id: 145, name: "Zapdos", img: baseSprite(145), imgS: shinySprite(145), legendary: true, taskSync: ["blue-catching-1-02"], },
			{ id: 146, name: "Moltres", img: baseSprite(146), imgS: shinySprite(146), legendary: true, taskSync: ["blue-catching-1-03"], },
			...
			{ id: 150, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), legendary: true, taskSync: ["blue-catching-1-04", "blue-story-2-01"], },
			{ id: 151, name: "Mew", img: baseSprite(151), imgS: shinySprite(151), mythical: true, taskSync: ["blue-extra-credit-1"], },
		],
	},
});