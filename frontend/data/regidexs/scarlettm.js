...
PPGC.register({
	dex: {
		[sub]: [
			...
			{
				id: 5, natiId: 194, name: "Wooper", img: baseSprite("194-p"), imgS: shinySprite("194-p"), forms: [
			...
			{
				id: 6, natiId: 195, name: "Quagsire", img: baseSprite(195), imgS: shinySprite(195), forms: [
			...
			{
				id: 21, natiId: 25, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), forms: [
			...
			{
				id: 22, natiId: 26, name: "Raichu", img: baseSprite(26), imgS: shinySprite(26), forms: [
			...
			{
				id: 28, natiId: 396, name: "Starly", img: baseSprite(396), imgS: shinySprite(396), forms: [
					{ name: "Male", img: baseSprite(396), imgS: shinySprite(396), },
					{ name: "Female", img: baseSprite("396-f"), imgS: shinySprite("396-f"), }
				],
			},
			{
				id: 29, natiId: 397, name: "Staravia", img: baseSprite(397), imgS: shinySprite(397), forms: [
					{ name: "Male", img: baseSprite(397), imgS: shinySprite(397), },
					{ name: "Female", img: baseSprite("397-f"), imgS: shinySprite("397-f"), }
				],
			},
			{
				id: 30, natiId: 398, name: "Staraptor", img: baseSprite(398), imgS: shinySprite(398), forms: [
			...
			{
				id: 42, natiId: 186, name: "Politoed", img: baseSprite(186), imgS: shinySprite(186), forms: [
					{ name: "Male", img: baseSprite(186), imgS: shinySprite(186) },
					{ name: "Female", img: baseSprite("186-f"), imgS: shinySprite("186-f") },
				],
			},
			{
				id: 43, natiId: 129, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), forms: [
					{ name: "Male", img: baseSprite(129), imgS: shinySprite(129), },
					{ name: "Female", img: baseSprite("129-f"), imgS: shinySprite("129-f"), }
				],
			},
			{
				id: 44, natiId: 130, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), forms: [
			...
			{
				id: 47, natiId: 190, name: "Aipom", img: baseSprite(190), imgS: shinySprite(190), forms: [
					{ name: "Male", img: baseSprite(190), imgS: shinySprite(190) },
					{ name: "Female", img: baseSprite("190-f"), imgS: shinySprite("190-f") },
				],
			},
			{
				id: 48, natiId: 424, name: "Ambipom", img: baseSprite(424), imgS: shinySprite(424), forms: [
					{ name: "Male", img: baseSprite(424), imgS: shinySprite(424) },
					{ name: "Female", img: baseSprite("424-f"), imgS: shinySprite("424-f") },
				],
			},
			{
				id: 49, natiId: 214, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), forms: [
			...
			{
				id: 51, natiId: 221, name: "Piloswine", img: baseSprite(221), imgS: shinySprite(221), forms: [
					{ name: "Male", img: baseSprite(221), imgS: shinySprite(221) },
					{ name: "Female", img: baseSprite("221-f"), imgS: shinySprite("221-f") },
				],
			},
			{
				id: 52, natiId: 473, name: "Mamoswine", img: baseSprite(473), imgS: shinySprite(473), forms: [
			...
			{
				id: 55, natiId: 274, name: "Nuzleaf", img: baseSprite(274), imgS: shinySprite(274), forms: [
					{ name: "Male", img: baseSprite(274), imgS: shinySprite(274) },
					{ name: "Female", img: baseSprite("274-f"), imgS: shinySprite("274-f") },
				],
			},
			{
				id: 56, natiId: 275, name: "Shiftry", img: baseSprite(275), imgS: shinySprite(275), forms: [
			...
			{
				id: 61, natiId: 401, name: "Kricketot", img: baseSprite(401), imgS: shinySprite(401), forms: [
					{ name: "Male", img: baseSprite(401), imgS: shinySprite(401), },
					{ name: "Female", img: baseSprite("401-f"), imgS: shinySprite("401-f"), }
				],
			},
			{
				id: 62, natiId: 402, name: "Kricketune", img: baseSprite(402), imgS: shinySprite(402), forms: [
					{ name: "Male", img: baseSprite(402), imgS: shinySprite(402), },
					{ name: "Female", img: baseSprite("402-f"), imgS: shinySprite("402-f"), }
				],
			},
			{
				id: 63, natiId: 417, name: "Pachirisu", img: baseSprite(417), imgS: shinySprite(417), forms: [
			...
			{
				id: 71, natiId: 745, name: "Lycanroc", img: baseSprite(745), imgS: shinySprite(745), forms: [
			...
			{
				id: 76, natiId: 1012, name: "Poltchageist", img: baseSprite(1012), imgS: shinySprite(1012), forms: [
			...
			{
				id: 77, natiId: 1013, name: "Sinistcha", img: baseSprite(1013), imgS: shinySprite(1013), forms: [
			...
			{
				id: 84, natiId: 185, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), forms: [
			...
			{
				id: 98, natiId: 925, name: "Maushold", img: baseSprite(925), imgS: shinySprite(925), forms: [
			...
			{
				id: 106, natiId: 272, name: "Ludicolo", img: baseSprite(272), imgS: shinySprite(272), forms: [
			...
			{
				id: 109, natiId: 403, name: "Shinx", img: baseSprite(403), imgS: shinySprite(403), forms: [
					{ name: "Male", img: baseSprite(403), imgS: shinySprite(403), },
					{ name: "Female", img: baseSprite("403-f"), imgS: shinySprite("403-f"), }
				],
			},
			{
				id: 110, natiId: 404, name: "Luxio", img: baseSprite(404), imgS: shinySprite(404), forms: [
					{ name: "Male", img: baseSprite(404), imgS: shinySprite(404), },
					{ name: "Female", img: baseSprite("404-f"), imgS: shinySprite("404-f"), }
				],
			},
			{
				id: 111, natiId: 405, name: "Luxray", img: baseSprite(405), imgS: shinySprite(405), forms: [
			...
			{
				id: 115, natiId: 741, name: "Oricorio", img: baseSprite(741), imgS: shinySprite(741), forms: [
			...
			{
				id: 121, natiId: 207, name: "Gligar", img: baseSprite(207), imgS: shinySprite(207), forms: [
			...
			{
				id: 124, natiId: 229, name: "Houndoom", img: baseSprite(229), imgS: shinySprite(229), forms: [
			...
			{ id: 131, natiId: 782, name: "Jangmo-o", img: baseSprite(782), imgS: shinySprite(782), },
			{ id: 132, natiId: 783, name: "Hakamo-o", img: baseSprite(783), imgS: shinySprite(783), },
			{ id: 133, natiId: 784, name: "Kommo-o", img: baseSprite(784), imgS: shinySprite(784), },
			...
			{
				id: 159, natiId: 350, name: "Milotic", img: baseSprite(350), imgS: shinySprite(350), forms: [
			...
			{
				id: 161, natiId: 982, name: "Dudunsparce", img: baseSprite(982), imgS: shinySprite(982), forms: [
			...
			{
				id: 164, natiId: 443, name: "Gible", img: baseSprite(443), imgS: shinySprite(443), forms: [
					{ name: "Male", img: baseSprite(443), imgS: shinySprite(443), },
					{ name: "Female", img: baseSprite("443-f"), imgS: shinySprite("443-f"), }
				],
			},
			{
				id: 165, natiId: 444, name: "Gabite", img: baseSprite(444), imgS: shinySprite(444), forms: [
					{ name: "Male", img: baseSprite(444), imgS: shinySprite(444), },
					{ name: "Female", img: baseSprite("444-f"), imgS: shinySprite("444-f"), }
				],
			},
			{
				id: 166, natiId: 445, name: "Garchomp", img: baseSprite(445), imgS: shinySprite(445), forms: [
			...
			{
				id: 170, natiId: 215, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), forms: [
			...
			{
				id: 171, natiId: 461, name: "Weavile", img: baseSprite(461), imgS: shinySprite(461), forms: [
			...
			{
				id: 193, natiId: 876, name: "Indeedee", img: baseSprite(876), imgS: shinySprite(876), forms: [
					{ name: "Male", img: baseSprite(876), imgS: shinySprite(876), },
					{ name: "Female", img: baseSprite("876-f"), imgS: shinySprite("876-f"), }
				],
			},
			{
				id: 194, natiId: 550, name: "Basculin", img: baseSprite(550), imgS: shinySprite(550), forms: [
			...
			{
				id: 195, natiId: 902, name: "Basculegion", img: baseSprite(902), imgS: shinySprite(902), forms: [
					{ name: "Male", img: baseSprite(902), imgS: shinySprite(902) },
					{ name: "Female", img: baseSprite("902-f"), imgS: shinySprite("902-f") },
				],
			},
			{
				id: 196, natiId: 901, name: "Ursaluna", img: baseSprite(901), imgS: shinySprite(901), forms: [
			...
			{ id: 197, natiId: 1014, name: "Okidogi", img: baseSprite(1014), imgS: shinySprite(1014), maxStatus: "caught", legendary: true, },
			{ id: 198, natiId: 1015, name: "Munkidori", img: baseSprite(1015), imgS: shinySprite(1015), maxStatus: "caught", legendary: true, },
			{ id: 199, natiId: 1016, name: "Fezandipiti", img: baseSprite(1016), imgS: shinySprite(1016), maxStatus: "caught", legendary: true, },
			{ id: 200, natiId: 1017, name: "Ogerpon", img: baseSprite(1017), imgS: shinySprite(1017), maxStatus: "caught", legendary: true, }
		],
	},
});