		...
		[sub]: [
			...
			{ id: 14, name: "Gumshoos", img: baseSprite(735), imgS: shinySprite(735), dexSync: [{ game: "ultrasun", dexType: "alola", id: 14 }, akalaDex(5), ulaulaDex(5), poniDex(5),], },
			{
				id: 15, name: "Rattata", img: baseSprite("019-a"), imgS: shinySprite("019-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 15 }, akalaDex(6), ulaulaDex(6), poniDex(6),], forms: [
					{ name: "Kantonian Male", img: baseSprite(19), imgS: shinySprite(19), dexSync: [alolaDex(15, "Kantonian Male"), akalaDex(6, "Kantonian Male"), ulaulaDex(6, "Kantonian Male"), poniDex(6, "Kantonian Male"),], },
					{ name: "Kantonian Female", img: baseSprite("019-f"), imgS: shinySprite("019-f"), dexSync: [alolaDex(15, "Kantonian Female"), akalaDex(6, "Kantonian Female"), ulaulaDex(6, "Kantonian Female"), poniDex(6, "Kantonian Female"),], },
					{ name: "alola", img: baseSprite("019-a"), imgS: shinySprite("019-a"), dexSync: [alolaDex(15, "alola"), akalaDex(6, "alola"), ulaulaDex(6, "alola"), poniDex(6, "alola"),], },],
			},
			{
				id: 16, name: "Raticate", img: baseSprite("020-a"), imgS: shinySprite("020-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 16 }, akalaDex(7), ulaulaDex(7), poniDex(7),], forms: [
					{ name: "Kantonian Male", img: baseSprite(20), imgS: shinySprite(20), dexSync: [alolaDex(16, "Kantonian Male"), akalaDex(7, "Kantonian Male"), ulaulaDex(7, "Kantonian Male"), poniDex(7, "Kantonian Male"),], },
					{ name: "Kantonian Female", img: baseSprite("020-f"), imgS: shinySprite("020-f"), dexSync: [alolaDex(16, "Kantonian Female"), akalaDex(7, "Kantonian Female"), ulaulaDex(7, "Kantonian Female"), poniDex(7, "Kantonian Female"),], },
					{ name: "alola", img: baseSprite("020-a"), imgS: shinySprite("020-a"), dexSync: [alolaDex(16, "alola"), akalaDex(7, "alola"), ulaulaDex(7, "alola"), poniDex(7, "alola"),], },],
			},
			...
			{ id: 18, name: "Metapod", img: baseSprite(11), imgS: shinySprite(11), dexSync: [{ game: "ultrasun", dexType: "alola", id: 18 }, akalaDex(9),], },
			{
				id: 19, name: "Butterfree", img: baseSprite(12), imgS: shinySprite(12), dexSync: [{ game: "ultrasun", dexType: "alola", id: 19 }, akalaDex(10),], forms: [
					{ name: "Male", img: baseSprite(12), imgS: shinySprite(12), dexSync: [alolaDex(19, "Male"), akalaDex(10, "Male"),], },
					{ name: "Female", img: baseSprite("012-f"), imgS: shinySprite("012-f"), dexSync: [alolaDex(19, "Female"), akalaDex(10, "Female"),], },],
			},
			{
				id: 20, name: "Ledyba", img: baseSprite(165), imgS: shinySprite(165), dexSync: [{ game: "ultrasun", dexType: "alola", id: 20 }, ulaulaDex(8),], forms: [
					{ name: "Male", img: baseSprite(165), imgS: shinySprite(165), dexSync: [alolaDex(20, "Male"), ulaulaDex(8, "Male"),], },
					{ name: "Female", img: baseSprite("165-f"), imgS: shinySprite("165-f"), dexSync: [alolaDex(20, "Female"), ulaulaDex(8, "Female"),], },],
			},
			{
				id: 21, name: "Ledian", img: baseSprite(166), imgS: shinySprite(166), dexSync: [{ game: "ultrasun", dexType: "alola", id: 21 }, ulaulaDex(9),], forms: [
					{ name: "Male", img: baseSprite(166), imgS: shinySprite(166), dexSync: [alolaDex(21, "Male"), ulaulaDex(9, "Male"),], },
					{ name: "Female", img: baseSprite("166-f"), imgS: shinySprite("166-f"), dexSync: [alolaDex(21, "Female"), ulaulaDex(9, "Female"),], },],
			},
			...
			{ id: 29, name: "Zoroark", img: baseSprite(571), imgS: shinySprite(571), dexSync: [{ game: "ultrasun", dexType: "alola", id: 29 }, poniDex(13),], },
			{
				id: 30, name: "Furfrou", img: baseSprite(676), imgS: shinySprite(676), dexSync: [{ game: "ultrasun", dexType: "alola", id: 30 }, poniDex(14),], forms: [
					{ name: "Natural Trim", img: baseSprite(676), imgS: shinySprite(676), dexSync: [alolaDex(30, "Natural Trim"), poniDex(14, "Natural Trim"),], },
					{ name: "Heart Trim", img: baseSprite("676-he"), imgS: shinySprite("676-he"), dexSync: [alolaDex(30, "Heart Trim"), poniDex(14, "Heart Trim"),], },
					{ name: "Star Trim", img: baseSprite("676-st"), imgS: shinySprite("676-st"), dexSync: [alolaDex(30, "Star Trim"), poniDex(14, "Star Trim"),], },
					{ name: "Diamond Trim", img: baseSprite("676-di"), imgS: shinySprite("676-di"), dexSync: [alolaDex(30, "Diamond Trim"), poniDex(14, "Diamond Trim"),], },
					{ name: "Debutante Trim", img: baseSprite("676-de"), imgS: shinySprite("676-de"), dexSync: [alolaDex(30, "Debutante Trim"), poniDex(14, "Debutante Trim"),], },
					{ name: "Matron Trim", img: baseSprite("676-ma"), imgS: shinySprite("676-ma"), dexSync: [alolaDex(30, "Matron Trim"), poniDex(14, "Matron Trim"),], },
					{ name: "Dandy Trim", img: baseSprite("676-da"), imgS: shinySprite("676-da"), dexSync: [alolaDex(30, "Dandy Trim"), poniDex(14, "Dandy Trim"),], },
					{ name: "Le Reine Trim", img: baseSprite("676-la"), imgS: shinySprite("676-la"), dexSync: [alolaDex(30, "Le Reine Trim"), poniDex(14, "Le Reine Trim"),], },
					{ name: "Kabuki Trim", img: baseSprite("676-ka"), imgS: shinySprite("676-ka"), dexSync: [alolaDex(30, "Kabuki Trim"), poniDex(14, "Kabuki Trim"),], },
					{ name: "Pharaoh Trim", img: baseSprite("676-ph"), imgS: shinySprite("676-ph"), dexSync: [alolaDex(30, "Pharaoh Trim"), poniDex(14, "Pharaoh Trim"),], },],
			},
			{ id: 31, name: "Pichu", img: baseSprite(172), imgS: shinySprite(172), dexSync: [{ game: "ultrasun", dexType: "alola", id: 31 }], },
			{
				id: 32, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), dexSync: [{ game: "ultrasun", dexType: "alola", id: 32 }], forms: [
					{ name: "Male", img: baseSprite(25), imgS: shinySprite(25), dexSync: [alolaDex(32, "Male")], },
					{ name: "Female", img: baseSprite("025-f"), imgS: shinySprite("025-f"), dexSync: [alolaDex(32, "Female")], },
					{ name: "Alola Cap", img: baseSprite("025-a"), imgS: shinySprite("025-a"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Alola Cap")], },
					{ name: "Hoenn Cap", img: baseSprite("025-h"), imgS: shinySprite("025-h"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Hoenn Cap")], },
					{ name: "Kalos Cap", img: baseSprite("025-k"), imgS: shinySprite("025-k"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Kalos Cap")], },
					{ name: "Original Cap", img: baseSprite("025-o"), imgS: shinySprite("025-o"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Original Cap")], },
					{ name: "Partner Cap", img: baseSprite("025-p"), imgS: shinySprite("025-p"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Partner Cap")], },
					{ name: "Sinnoh Cap", img: baseSprite("025-s"), imgS: shinySprite("025-s"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Sinnoh Cap")], },
					{ name: "Unova Cap", img: baseSprite("025-u"), imgS: shinySprite("025-u"), maxStatus: "caught", mythical: true, dexSync: [alolaDex(32, "Unova Cap")], },],
			},
			{
				id: 33, name: "Raichu", img: baseSprite("026-a"), imgS: shinySprite("026-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 33 }], forms: [
					{ name: "Kantonian Male", img: baseSprite(26), imgS: shinySprite(26), dexSync: [alolaDex(33, "Kantonian Male")], },
					{ name: "Kantonian Female", img: baseSprite("026-f"), imgS: shinySprite("026-f"), dexSync: [alolaDex(33, "Kantonian Female")], },
					{ name: "alola", img: baseSprite("026-a"), imgS: shinySprite("026-a"), dexSync: [alolaDex(33, "alola")], },],
			},
			...
			{ id: 37, name: "Bonsly", img: baseSprite(438), imgS: shinySprite(438), dexSync: [{ game: "ultrasun", dexType: "alola", id: 37 }, akalaDex(13),], },
			{
				id: 38, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), dexSync: [{ game: "ultrasun", dexType: "alola", id: 38 }, akalaDex(14),], forms: [
					{ name: "Male", img: baseSprite(185), imgS: shinySprite(185), dexSync: [alolaDex(38, "Male"), akalaDex(14, "Male"),], },
					{ name: "Female", img: baseSprite("185-f"), imgS: shinySprite("185-f"), dexSync: [alolaDex(38, "Female"), akalaDex(14, "Female"),], },],
			},
			...
			{ id: 49, name: "Abra", img: baseSprite(63), imgS: shinySprite(63), dexSync: [{ game: "ultrasun", dexType: "alola", id: 49 }], },
			{
				id: 50, name: "Kadabra", img: baseSprite(64), imgS: shinySprite(64), dexSync: [{ game: "ultrasun", dexType: "alola", id: 50 }], forms: [
					{ name: "Male", img: baseSprite(64), imgS: shinySprite(64), dexSync: [alolaDex(50, "Male")], },
					{ name: "Female", img: baseSprite("064-f"), imgS: shinySprite("064-f"), dexSync: [alolaDex(50, "Female")], },],
			},
			{
				id: 51, name: "Alakazam", img: baseSprite(65), imgS: shinySprite(65), dexSync: [{ game: "ultrasun", dexType: "alola", id: 51 }], forms: [
					{ name: "Male", img: baseSprite(65), imgS: shinySprite(65), dexSync: [alolaDex(51, "Male")], },
					{ name: "Female", img: baseSprite("065-f"), imgS: shinySprite("065-f"), dexSync: [alolaDex(51, "Female")], },],
			},
			{
				id: 52, name: "Meowth", img: baseSprite("052-a"), imgS: shinySprite("052-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 52 }, ulaulaDex(23),], forms: [
					{ name: "Kantonian", img: baseSprite(52), imgS: shinySprite(52), dexSync: [alolaDex(52, "Kantonian"), ulaulaDex(23, "Kantonian"),], },
					{ name: "alola", img: baseSprite("052-a"), imgS: shinySprite("052-a"), dexSync: [alolaDex(52, "alola"), ulaulaDex(23, "alola"),], },],
			},
			{
				id: 53, name: "Persian", img: baseSprite("053-a"), imgS: shinySprite("053-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 53 }, ulaulaDex(24),], forms: [
					{ name: "Kantonian", img: baseSprite(53), imgS: shinySprite(53), dexSync: [alolaDex(53, "Kantonian"), ulaulaDex(24, "Kantonian"),], },
					{ name: "alola", img: baseSprite("053-a"), imgS: shinySprite("053-a"), dexSync: [alolaDex(53, "alola"), ulaulaDex(24, "alola"),], },],
			},
			...
			{ id: 56, name: "Magnezone", img: baseSprite(462), imgS: shinySprite(462), dexSync: [{ game: "ultrasun", dexType: "alola", id: 56 }, ulaulaDex(27),], },
			{
				id: 57, name: "Grimer", img: baseSprite("088-a"), imgS: shinySprite("088-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 57 }, ulaulaDex(28),], forms: [
					{ name: "Kantonian", img: baseSprite(88), imgS: shinySprite(88), dexSync: [alolaDex(57, "Kantonian"), ulaulaDex(28, "Kantonian"),], },
					{ name: "alola", img: baseSprite("088-a"), imgS: shinySprite("088-a"), dexSync: [alolaDex(57, "alola"), ulaulaDex(28, "alola"),], },],
			},
			{
				id: 58, name: "Muk", img: baseSprite("089-a"), imgS: shinySprite("089-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 58 }, ulaulaDex(29),], forms: [
					{ name: "Kantonian", img: baseSprite(89), imgS: shinySprite(89), dexSync: [alolaDex(58, "Kantonian"), ulaulaDex(29, "Kantonian"),], },
					{ name: "alola", img: baseSprite("089-a"), imgS: shinySprite("089-a"), dexSync: [alolaDex(58, "alola"), ulaulaDex(29, "alola"),], },],
			},
			...
			{ id: 66, name: "Drowzee", img: baseSprite(96), imgS: shinySprite(96), dexSync: [{ game: "ultrasun", dexType: "alola", id: 66 }, poniDex(20),], },
			{
				id: 67, name: "Hypno", img: baseSprite(97), imgS: shinySprite(97), dexSync: [{ game: "ultrasun", dexType: "alola", id: 67 }, poniDex(21),], forms: [
					{ name: "Male", img: baseSprite(97), imgS: shinySprite(97), dexSync: [alolaDex(67, "Male"), poniDex(21, "Male"),], },
					{ name: "Female", img: baseSprite("097-f"), imgS: shinySprite("097-f"), dexSync: [alolaDex(67, "Female"), poniDex(21, "Female"),], },],
			},
			...
			{ id: 77, name: "Drifblim", img: baseSprite(426), imgS: shinySprite(426), dexSync: [{ game: "ultrasun", dexType: "alola", id: 77 }], },
			{
				id: 78, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), dexSync: [{ game: "ultrasun", dexType: "alola", id: 78 }], forms: [
					{ name: "Male", img: baseSprite(198), imgS: shinySprite(198), dexSync: [alolaDex(78, "Male")], },
					{ name: "Female", img: baseSprite("198-f"), imgS: shinySprite("198-f"), dexSync: [alolaDex(78, "Female")], },],
			},
			{ id: 79, name: "Honchkrow", img: baseSprite(430), imgS: shinySprite(430), dexSync: [{ game: "ultrasun", dexType: "alola", id: 79 }], },
			{
				id: 80, name: "Zubat", img: baseSprite(41), imgS: shinySprite(41), dexSync: [{ game: "ultrasun", dexType: "alola", id: 80 }, akalaDex(26), ulaulaDex(35), poniDex(26),], forms: [
					{ name: "Male", img: baseSprite(41), imgS: shinySprite(41), dexSync: [alolaDex(80, "Male"), akalaDex(26, "Male"), ulaulaDex(35, "Male"), poniDex(26, "Male"),], },
					{ name: "Female", img: baseSprite("041-f"), imgS: shinySprite("041-f"), dexSync: [alolaDex(80, "Female"), akalaDex(26, "Female"), ulaulaDex(35, "Female"), poniDex(26, "Female"),], },],
			},
			{
				id: 81, name: "Golbat", img: baseSprite(42), imgS: shinySprite(42), dexSync: [{ game: "ultrasun", dexType: "alola", id: 81 }, akalaDex(27), ulaulaDex(36), poniDex(27),], forms: [
					{ name: "Male", img: baseSprite(42), imgS: shinySprite(42), dexSync: [alolaDex(81, "Male"), akalaDex(27, "Male"), ulaulaDex(36, "Male"), poniDex(27, "Male"),], },
					{ name: "Female", img: baseSprite("042-f"), imgS: shinySprite("042-f"), dexSync: [alolaDex(81, "Female"), akalaDex(27, "Female"), ulaulaDex(36, "Female"), poniDex(27, "Female"),], },],
			},
			...
			{ id: 84, name: "Noivern", img: baseSprite(715), imgS: shinySprite(715), dexSync: [{ game: "ultrasun", dexType: "alola", id: 84 }, poniDex(30),], },
			{
				id: 85, name: "Diglett", img: baseSprite("050-a"), imgS: shinySprite("050-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 85 }, akalaDex(29), ulaulaDex(38), poniDex(31),], forms: [
					{ name: "Kantonian", img: baseSprite(50), imgS: shinySprite(50), dexSync: [alolaDex(85, "Kantonian"), akalaDex(29, "Kantonian"), ulaulaDex(38, "Kantonian"), poniDex(31, "Kantonian"),], },
					{ name: "alola", img: baseSprite("050-a"), imgS: shinySprite("050-a"), dexSync: [alolaDex(85, "alola"), akalaDex(29, "alola"), ulaulaDex(38, "alola"), poniDex(31, "alola"),], },],
			},
			{
				id: 86, name: "Dugtrio", img: baseSprite("051-a"), imgS: shinySprite("051-a"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 86 }, akalaDex(30), ulaulaDex(39), poniDex(32),], forms: [
					{ name: "Kantonian", img: baseSprite(51), imgS: shinySprite(51), dexSync: [alolaDex(86, "Kantonian"), akalaDex(30, "Kantonian"), ulaulaDex(39, "Kantonian"), poniDex(32, "Kantonian"),], },
					{ name: "alola", img: baseSprite("051-a"), imgS: shinySprite("051-a"), dexSync: [alolaDex(86, "alola"), akalaDex(30, "alola"), ulaulaDex(39, "alola"), poniDex(32, "alola"),], },],
			},
			...
			{ id: 96, name: "Hawlucha", img: baseSprite(701), imgS: shinySprite(701), dexSync: [{ game: "ultrasun", dexType: "alola", id: 96 }], },
			{
				id: 97, name: "Oricorio", img: baseSprite("741-po"), imgS: shinySprite("741-po"), dexSync: [{ game: "ultrasun", dexType: "alola", id: 97 }, akalaDex(31), ulaulaDex(42), poniDex(41),], forms: [
					{ name: "Baile Style", img: baseSprite(741), imgS: shinySprite(741), dexSync: [alolaDex(97, "Baile Style"), akalaDex(31, "Baile Style"), ulaulaDex(42, "Baile Style"), poniDex(41, "Baile Style"),], },
					{ name: "Pa'u Style", img: baseSprite("741-pa"), imgS: shinySprite("741-pa"), dexSync: [alolaDex(97, "Pa'u Style"), akalaDex(31, "Pa'u Style"), ulaulaDex(42, "Pa'u Style"), poniDex(41, "Pa'u Style"),], },
					{ name: "Pom-Pom Style", img: baseSprite("741-po"), imgS: shinySprite("741-po"), dexSync: [alolaDex(97, "Pom-Pom Style"), akalaDex(31, "Pom-Pom Style"), ulaulaDex(42, "Pom-Pom Style"), poniDex(41, "Pom-Pom Style"),], },
					{ name: "Sensu Style", img: baseSprite("741-s"), imgS: shinySprite("741-s"), dexSync: [alolaDex(97, "Sensu Style"), akalaDex(31, "Sensu Style"), ulaulaDex(42, "Sensu Style"), poniDex(41, "Sensu Style"),], },],
			},
			...
			{ id: 99, name: "Ribombee", img: baseSprite(743), imgS: shinySprite(743), dexSync: [{ game: "ultrasun", dexType: "alola", id: 99 }, ulaulaDex(44), poniDex(43),], },
			{
				id: 100, name: "Flabébé", img: baseSprite(669), imgS: shinySprite(669), dexSync: [{ game: "ultrasun", dexType: "alola", id: 100 }, ulaulaDex(45), poniDex(44),], forms: [
					{ name: "Red Flower", img: baseSprite(669), imgS: shinySprite(669), dexSync: [alolaDex(100, "Red Flower"), ulaulaDex(45, "Red Flower"), poniDex(44, "Red Flower"),], },
					{ name: "Orange Flower", img: baseSprite("669-o"), imgS: shinySprite("669-o"), dexSync: [alolaDex(100, "Orange Flower"), ulaulaDex(45, "Orange Flower"), poniDex(44, "Orange Flowerale"),], },
					{ name: "Yellow Flower", img: baseSprite("669-y"), imgS: shinySprite("669-y"), dexSync: [alolaDex(100, "Yellow Flower"), ulaulaDex(45, "Yellow Flower"), poniDex(44, "Yellow Flower"),], },
					{ name: "Blue Flower", img: baseSprite("669-b"), imgS: shinySprite("669-b"), dexSync: [alolaDex(100, "Blue Flower"), ulaulaDex(45, "Blue Flower"), poniDex(44, "Blue Flower"),], },
					{ name: "White Flower", img: baseSprite("669-w"), imgS: shinySprite("669-w"), dexSync: [alolaDex(100, "White Flower"), ulaulaDex(45, "White Flower"), poniDex(44, "White Flower"),], },],
			},
			{
				id: 101, name: "Floette", img: baseSprite(670), imgS: shinySprite(670), dexSync: [{ game: "ultrasun", dexType: "alola", id: 101 }, ulaulaDex(46), poniDex(45),], forms: [
					{ name: "Red Flower", img: baseSprite(670), imgS: shinySprite(670), dexSync: [alolaDex(101, "Red Flower"), ulaulaDex(46, "Red Flower"), poniDex(45, "Red Flower"),], },
					{ name: "Orange Flower", img: baseSprite("670-o"), imgS: shinySprite("670-o"), dexSync: [alolaDex(101, "Orange Flower"), ulaulaDex(46, "Orange Flower"), poniDex(45, "Orange Flower"),], },
					{ name: "Yellow Flower", img: baseSprite("670-y"), imgS: shinySprite("670-y"), dexSync: [alolaDex(101, "Yellow Flower"), ulaulaDex(46, "Yellow Flower"), poniDex(45, "Yellow Flower"),], },
					{ name: "Blue Flower", img: baseSprite("670-b"), imgS: shinySprite("670-b"), dexSync: [alolaDex(101, "Blue Flower"), ulaulaDex(46, "Blue Flower"), poniDex(45, "Blue Flower"),], },
					{ name: "White Flower", img: baseSprite("670-w"), imgS: shinySprite("670-w"), dexSync: [alolaDex(101, "White Flower"), ulaulaDex(46, "White Flower"), poniDex(45, "White Flower"),], },],
			},
			{
				id: 102, name: "Florges", img: baseSprite(671), imgS: shinySprite(671), dexSync: [{ game: "ultrasun", dexType: "alola", id: 102 }, ulaulaDex(47), poniDex(46),], forms: [
					{ name: "Red Flower", img: baseSprite(671), imgS: shinySprite(671), dexSync: [alolaDex(102, "Red Flower"), ulaulaDex(47, "Red Flower"), poniDex(46, "Red Flower"),], },
					{ name: "Orange Flower", img: baseSprite("671-o"), imgS: shinySprite("671-o"), dexSync: [alolaDex(102, "Orange Flower"), ulaulaDex(47, "Orange Flower"), poniDex(46, "Orange Flower"),], },
					{ name: "Yellow Flower", img: baseSprite("671-y"), imgS: shinySprite("671-y"), dexSync: [alolaDex(102, "Yellow Flower"), ulaulaDex(47, "Yellow Flower"), poniDex(46, "Yellow Flower"),], },
					{ name: "Blue Flower", img: baseSprite("671-b"), imgS: shinySprite("671-b"), dexSync: [alolaDex(102, "Blue Flower"), ulaulaDex(47, "Blue Flower"), poniDex(46, "Blue Flower"),], },
					{ name: "White Flower", img: baseSprite("671-w"), imgS: shinySprite("671-w"), dexSync: [alolaDex(102, "White Flower"), ulaulaDex(47, "White Flower"), poniDex(46, "White Flower"),], },],
			},
			...
			{ id: 110, name: "Jynx", img: baseSprite(124), imgS: shinySprite(124), dexSync: [{ game: "ultrasun", dexType: "alola", id: 110 }], },
			{
				id: 111, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), dexSync: [{ game: "ultrasun", dexType: "alola", id: 111 }, akalaDex(34), ulaulaDex(54), poniDex(53),], forms: [
					{ name: "Male", img: baseSprite(129), imgS: shinySprite(129), dexSync: [alolaDex(111, "Male"), akalaDex(34, "Male"), ulaulaDex(54, "Male"), poniDex(53, "Male"),], },
					{ name: "Female", img: baseSprite("129-f"), imgS: shinySprite("129-f"), dexSync: [alolaDex(111, "Female"), akalaDex(34, "Female"), ulaulaDex(54, "Female"), poniDex(53, "Female"),], },],
			},
			{
				id: 112, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), dexSync: [{ game: "ultrasun", dexType: "alola", id: 112 }, akalaDex(35), ulaulaDex(55), poniDex(54),], forms: [
					{ name: "Male", img: baseSprite(130), imgS: shinySprite(130), dexSync: [alolaDex(112, "Male"), akalaDex(35, "Male"), ulaulaDex(55, "Male"), poniDex(54, "Male"),], },
					{ name: "Female", img: baseSprite("130-f"), imgS: shinySprite("130-f"), dexSync: [alolaDex(112, "Female"), akalaDex(35, "Female"), ulaulaDex(55, "Female"), poniDex(54, "Female"),], },],
			},
			...
			{ id: 126, name: "Rockruff", img: baseSprite(744), imgS: shinySprite(744), dexSync: [{ game: "ultrasun", dexType: "alola", id: 126 }, poniDex(65),], },
			{
				id: 127, name: "Lycanroc", img: baseSprite(745), imgS: shinySprite(745), dexSync: [{ game: "ultrasun", dexType: "alola", id: 127 }, poniDex(66),], forms: [
					{ name: "Midday", img: baseSprite(745), imgS: shinySprite(745), dexSync: [alolaDex(127, "Midday"), poniDex(66, "Midday"),], },
					{ name: "Midnight", img: baseSprite("745-m"), imgS: shinySprite("745-m"), dexSync: [alolaDex(127, "Midnight"), poniDex(66, "Midnight"),], },
					{ name: "Dusk", img: baseSprite("745-d"), imgS: shinySprite("745-d"), dexSync: [alolaDex(127, "Dusk"), poniDex(66, "Dusk"),], },],
			},
			...
			{ id: 130, name: "Tentacruel", img: baseSprite(73), imgS: shinySprite(73), dexSync: [{ game: "ultrasun", dexType: "alola", id: 130 }, akalaDex(39), ulaulaDex(57), poniDex(68),], },
			{
				id: 131, name: "Finneon", img: baseSprite(456), imgS: shinySprite(456), dexSync: [{ game: "ultrasun", dexType: "alola", id: 131 }, akalaDex(40), ulaulaDex(58), poniDex(69),], forms: [
					{ name: "Male", img: baseSprite(456), imgS: shinySprite(456), dexSync: [alolaDex(131, "Male"), akalaDex(40, "Male"), ulaulaDex(58, "Male"), poniDex(69, "Male"),], },
					{ name: "Female", img: baseSprite("456-f"), imgS: shinySprite("456-f"), dexSync: [alolaDex(131, "Female"), akalaDex(40, "Female"), ulaulaDex(58, "Female"), poniDex(69, "Female"),], },],
			},
			{
				id: 132, name: "Lumineon", img: baseSprite(457), imgS: shinySprite(457), dexSync: [{ game: "ultrasun", dexType: "alola", id: 132 }, akalaDex(41), ulaulaDex(59), poniDex(70),], forms: [
					{ name: "Male", img: baseSprite(457), imgS: shinySprite(457), dexSync: [alolaDex(132, "Male"), akalaDex(41, "Male"), ulaulaDex(59, "Male"), poniDex(70, "Male"),], },
					{ name: "Female", img: baseSprite("457-f"), imgS: shinySprite("457-f"), dexSync: [alolaDex(132, "Female"), akalaDex(41, "Female"), ulaulaDex(59, "Female"), poniDex(70, "Female"),], },],
			},
			...
			{ id: 143, name: "Remoraid", img: baseSprite(223), imgS: shinySprite(223), dexSync: [{ game: "ultrasun", dexType: "alola", id: 143 }, akalaDex(47),], },
			{
				id: 144, name: "Octillery", img: baseSprite(224), imgS: shinySprite(224), dexSync: [{ game: "ultrasun", dexType: "alola", id: 144 }, akalaDex(48),], forms: [
					{ name: "Male", img: baseSprite(224), imgS: shinySprite(224), dexSync: [alolaDex(144, "Male"), akalaDex(48, "Male"),], },
					{ name: "Female", img: baseSprite("224-f"), imgS: shinySprite("224-f"), dexSync: [alolaDex(144, "Female"), akalaDex(48, "Female"),], },],
			},
