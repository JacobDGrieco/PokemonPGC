(() => {
	...
	const BASE_DEX = [
		...
		{
			id: 32, natiId: 741, name: "Oricorio", img: () => baseSprite("0741-s"), imgS: () => shinySprite("0741-s"), tags: ["other"], forms: [
		...
		{
			id: 85, natiId: 103, name: "Exeggutor", img: () => baseSprite("0103-a"), imgS: () => shinySprite("0103-a"), forms: [
