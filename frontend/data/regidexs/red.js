...
PPGC.register({
	dex: {
		[game]: [
			...
			{ id: 144, name: "Articuno", img: baseSprite(144), imgS: shinySprite(144), taskSync: ["red-catching-1-01"], tags: ["legendary"], },
			{ id: 145, name: "Zapdos", img: baseSprite(145), imgS: shinySprite(145), taskSync: ["red-catching-1-02"], tags: ["legendary"], },
			{ id: 146, name: "Moltres", img: baseSprite(146), imgS: shinySprite(146), taskSync: ["red-catching-1-03"], tags: ["legendary"], },
			...
			{ id: 150, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), taskSync: ["red-catching-1-04", "red-story-2-01"], tags: ["legendary"], },
			{ id: 151, name: "Mew", img: baseSprite(151), imgS: shinySprite(151), taskSync: ["red-extra-credit-1"], tags: ["mythical"], },
		],
	},
});