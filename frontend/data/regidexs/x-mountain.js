...
PPGC.register({
	dex: {
		[sub]: [
			...
			{
				id: 6, name: "Gible", img: baseSprite(443), imgS: shinySprite(443), gender: true, pseudo: true, dexSync: nationalDex(443), forms: [
			...
			{
				id: 7, name: "Gabite", img: baseSprite(444), imgS: shinySprite(444), gender: true, pseudo: true, dexSync: nationalDex(444), forms: [
			...
			{
				id: 8, name: "Garchomp", img: baseSprite(445), imgS: shinySprite(445), gender: true, mega: true, pseudo: true, dexSync: nationalDex(445), forms: [
			...
			{
				id: 17, name: "Wooper", img: baseSprite(194), imgS: shinySprite(194), gender: true, dexSync: nationalDex(194), forms: [
			...
			{
				id: 18, name: "Quagsire", img: baseSprite(195), imgS: shinySprite(195), gender: true, dexSync: nationalDex(195), forms: [
			...
			{ id: 19, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), pseudo: true, dexSync: nationalDex(704), },
			{ id: 20, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), pseudo: true, dexSync: nationalDex(705), },
			{ id: 21, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), pseudo: true, dexSync: nationalDex(706), },
			...
			{ id: 32, name: "Gengar", img: baseSprite(94), imgS: shinySprite(94), mega: true, dexSync: nationalDex(94), },
			...
			{
				id: 36, name: "Politoed", img: baseSprite(186), imgS: shinySprite(186), gender: true, dexSync: nationalDex(186), forms: [
			...
			{
				id: 51, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), gender: true, dexSync: nationalDex(198), forms: [
			...
			{
				id: 57, name: "Ludicolo", img: baseSprite(272), imgS: shinySprite(272), gender: true, dexSync: nationalDex(272), forms: [
			...
			{
				id: 60, name: "Basculin", img: baseSprite(550), imgS: shinySprite(550), otherForms: true, dexSync: nationalDex(550), forms: [
			...
			{
				id: 63, name: "Pumpkaboo", img: baseSprite(710), imgS: shinySprite(710), otherForms: true, dexSync: nationalDex(710), forms: [
			...
			{
				id: 64, name: "Gourgeist", img: baseSprite(711), imgS: shinySprite(711), otherForms: true, dexSync: nationalDex(711), forms: [
			...
			{
				id: 68, name: "Rotom", img: baseSprite(479), imgS: shinySprite(479), otherForms: true, dexSync: nationalDex(479), forms: [
			...
			{
				id: 77, name: "Piloswine", img: baseSprite(221), imgS: shinySprite(221), gender: true, dexSync: nationalDex(221), forms: [
			...
			{
				id: 78, name: "Mamoswine", img: baseSprite(473), imgS: shinySprite(473), gender: true, dexSync: nationalDex(473), forms: [
			...
			{
				id: 88, name: "Snover", img: baseSprite(459), imgS: shinySprite(459), gender: true, dexSync: nationalDex(459), forms: [
			...
			{
				id: 89, name: "Abomasnow", img: baseSprite(460), imgS: shinySprite(460), gender: true, mega: true, dexSync: nationalDex(460), forms: [
			...
			{
				id: 91, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), gender: true, dexSync: nationalDex(215), forms: [
			...
			{ id: 101, name: "Aggron", img: baseSprite(306), imgS: shinySprite(306), mega: true, dexSync: nationalDex(306), },
			{ id: 102, name: "Larvitar", img: baseSprite(246), imgS: shinySprite(246), pseudo: true, dexSync: nationalDex(246), },
			{ id: 103, name: "Pupitar", img: baseSprite(247), imgS: shinySprite(247), pseudo: true, dexSync: nationalDex(247), },
			{ id: 104, name: "Tyranitar", img: baseSprite(248), imgS: shinySprite(248), mega: true, pseudo: true, dexSync: nationalDex(248), },
			...
			{
				id: 115, name: "Gligar", img: baseSprite(207), imgS: shinySprite(207), gender: true, dexSync: nationalDex(207), forms: [
			...
			{ id: 123, name: "Banette", img: baseSprite(354), imgS: shinySprite(354), mega: true, dexSync: nationalDex(354), },
			...
			{
				id: 130, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), gender: true, dexSync: nationalDex(185), forms: [
			...
			{
				id: 133, name: "Ursaring", img: baseSprite(217), imgS: shinySprite(217), gender: true, dexSync: nationalDex(217), forms: [
			...
			{
				id: 136, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), gender: true, dexSync: nationalDex(123), forms: [
			...
			{
				id: 137, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), gender: true, mega: true, dexSync: nationalDex(212), forms: [
			...
			{ id: 142, name: "Deino", img: baseSprite(633), imgS: shinySprite(633), pseudo: true, dexSync: nationalDex(633), },
			{ id: 143, name: "Zweilous", img: baseSprite(634), imgS: shinySprite(634), pseudo: true, dexSync: nationalDex(634), },
			{ id: 144, name: "Hydreigon", img: baseSprite(635), imgS: shinySprite(635), pseudo: true, dexSync: nationalDex(635), },
			{ id: 145, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), pseudo: true, dexSync: nationalDex(147), },
			{ id: 146, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), pseudo: true, dexSync: nationalDex(148), },
			{ id: 147, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), pseudo: true, dexSync: nationalDex(149), },
			...
			{ id: 151, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), mega: true, legendary: true, dexSync: nationalDex(150), }
		]
	},
});
