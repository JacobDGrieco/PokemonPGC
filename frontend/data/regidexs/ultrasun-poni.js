...
PPGC.register({
	dex: {
		[sub]: [
			...
			{
				id: 6, natiId: 19, name: "Rattata", img: baseSprite(19), imgS: shinySprite(19), forms: [
			...
			{
				id: 7, natiId: 20, name: "Raticate", img: baseSprite(20), imgS: shinySprite(20), forms: [
			...
			{ id: 9, natiId: 428, name: "Lopunny", img: baseSprite(428), imgS: shinySprite(428), },
			...
			{
				id: 14, natiId: 676, name: "Furfrou", img: baseSprite(676), imgS: shinySprite(676), forms: [
			...
			{
				id: 21, natiId: 97, name: "Hypno", img: baseSprite(97), imgS: shinySprite(97), forms: [
			...
			{
				id: 41, natiId: 741, name: "Oricorio", img: baseSprite("741-s"), imgS: shinySprite("741-s"), forms: [
			...
			{
				id: 44, natiId: 669, name: "Flabébé", img: baseSprite(669), imgS: shinySprite(669), forms: [
			...
			{
				id: 45, natiId: 670, name: "Floette", img: baseSprite(670), imgS: shinySprite(670), forms: [
			...
			{
				id: 46, natiId: 671, name: "Florges", img: baseSprite(671), imgS: shinySprite(671), forms: [
			...
			{
				id: 66, natiId: 745, name: "Lycanroc", img: baseSprite(745), imgS: shinySprite(745), forms: [
			...
			{
				id: 69, natiId: 456, name: "Finneon", img: baseSprite(456), imgS: shinySprite(456), forms: [
					{ name: "Male", img: baseSprite(456), imgS: shinySprite(456), },
					{ name: "Female", img: baseSprite("456-f"), imgS: shinySprite("456-f"), },
				],
			},
			{
				id: 70, natiId: 457, name: "Lumineon", img: baseSprite(457), imgS: shinySprite(457), forms: [
			...
			{
				id: 75, natiId: 550, name: "Basculin", img: baseSprite(550), imgS: shinySprite(550), forms: [
			...
			{ id: 79, natiId: 704, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), },
			{ id: 80, natiId: 705, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), },
			{ id: 81, natiId: 706, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), },
			{
				id: 82, natiId: 351, name: "Castform", img: baseSprite(351), imgS: shinySprite(351), forms: [
			...
			{
				id: 88, natiId: 422, name: "Shellos", img: baseSprite(422), imgS: shinySprite(422), forms: [
					{ name: "West Sea", img: baseSprite(422), imgS: shinySprite(422), },
					{ name: "East Sea", img: baseSprite("422-e"), imgS: shinySprite("422-e"), },
				],
			},
			{
				id: 89, natiId: 423, name: "Gastrodon", img: baseSprite(423), imgS: shinySprite(423), forms: [
					{ name: "West Sea", img: baseSprite(423), imgS: shinySprite(423), },
					{ name: "East Sea", img: baseSprite("423-e"), imgS: shinySprite("423-e"), },
				],
			},
			{
				id: 90, natiId: 369, name: "Relicanth", img: baseSprite(369), imgS: shinySprite(369), forms: [
			...
			{ id: 108, natiId: 782, name: "Jangmo-o", img: baseSprite(782), imgS: shinySprite(782), },
			{ id: 109, natiId: 783, name: "Hakamo-o", img: baseSprite(783), imgS: shinySprite(783), },
			{ id: 110, natiId: 784, name: "Kommo-o", img: baseSprite(784), imgS: shinySprite(784), },
			{ id: 111, natiId: 587, name: "Emolga", img: baseSprite(587), imgS: shinySprite(587), },
			{
				id: 112, natiId: 123, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), forms: [
					{ name: "Male", img: baseSprite(123), imgS: shinySprite(123), },
					{ name: "Female", img: baseSprite("123-f"), imgS: shinySprite("123-f"), },
				],
			},
			{
				id: 113, natiId: 212, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), forms: [
					{ name: "Male", img: baseSprite(212), imgS: shinySprite(212), },
					{ name: "Female", img: baseSprite("212-f"), imgS: shinySprite("212-f"), },
				],
			},
			{
				id: 114, natiId: 214, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), forms: [
					{ name: "Male", img: baseSprite(214), imgS: shinySprite(214), },
					{ name: "Female", img: baseSprite("214-f"), imgS: shinySprite("214-f"), },
				],
			},
			{
				id: 115, natiId: 190, name: "Aipom", img: baseSprite(190), imgS: shinySprite(190), forms: [
					{ name: "Male", img: baseSprite(190), imgS: shinySprite(190), },
					{ name: "Female", img: baseSprite("190-f"), imgS: shinySprite("190-f"), },
				],
			},
			{
				id: 116, natiId: 424, name: "Ambipom", img: baseSprite(424), imgS: shinySprite(424), forms: [
			...
			{
				id: 118, natiId: 668, name: "Pyroar", img: baseSprite(668), imgS: shinySprite(668), forms: [
			...
			{ id: 125, natiId: 448, name: "Lucario", img: baseSprite(448), imgS: shinySprite(448), },
			{ id: 126, natiId: 147, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), },
			{ id: 127, natiId: 148, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), },
			{ id: 128, natiId: 149, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), },
			{ id: 129, natiId: 142, name: "Aerodactyl", img: baseSprite(142), imgS: shinySprite(142), },
			{ id: 130, natiId: 788, name: "Tapu Fini", img: baseSprite(788), imgS: shinySprite(788), legendary: true, }
		],
	},
});