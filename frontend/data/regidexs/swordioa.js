...
PPGC.register({
	dex: {
		[sub]: [
			...
			{ id: 16, natiId: 826, name: "Orbeetle", img: baseSprite(826), imgS: shinySprite(826), },
			...
			{ id: 20, natiId: 841, name: "Flapple", img: baseSprite(841), imgS: shinySprite(841), },
			{ id: 21, natiId: 842, name: "Appletun", img: baseSprite(842), imgS: shinySprite(842), },
			...
			{
				id: 25, natiId: 403, name: "Shinx", img: baseSprite(403), imgS: shinySprite(403), forms: [
					{ name: "Male", img: baseSprite(403), imgS: shinySprite(403), },
					{ name: "Female", img: baseSprite("403-f"), imgS: shinySprite("403-f"), },
				],
			},
			{
				id: 26, natiId: 404, name: "Luxio", img: baseSprite(404), imgS: shinySprite(404), forms: [
					{ name: "Male", img: baseSprite(404), imgS: shinySprite(404), },
					{ name: "Female", img: baseSprite("404-f"), imgS: shinySprite("404-f"), },
				],
			},
			{
				id: 27, natiId: 405, name: "Luxray", img: baseSprite(405), imgS: shinySprite(405), forms: [
			...
			{
				id: 32, natiId: 64, name: "Kadabra", img: baseSprite(64), imgS: shinySprite(64), forms: [
					{ name: "Male", img: baseSprite(64), imgS: shinySprite(64), },
					{ name: "Female", img: baseSprite("064-f"), imgS: shinySprite("064-f"), },
				],
			},
			{
				id: 33, natiId: 65, name: "Alakazam", img: baseSprite(65), imgS: shinySprite(65), forms: [
			...
			{ id: 39, natiId: 99, name: "Kingler", img: baseSprite(99), imgS: shinySprite(99), },
			...
			{
				id: 42, natiId: 129, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), forms: [
					{ name: "Male", img: baseSprite(129), imgS: shinySprite(129), },
					{ name: "Female", img: baseSprite("129-f"), imgS: shinySprite("129-f"), },
				],
			},
			{
				id: 43, natiId: 130, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), forms: [
			...
			{
				id: 45, natiId: 224, name: "Octillery", img: baseSprite(224), imgS: shinySprite(224), forms: [
			...
			{ id: 57, natiId: 834, name: "Drednaw", img: baseSprite(834), imgS: shinySprite(834), },
			{
				id: 58, natiId: 194, name: "Wooper", img: baseSprite(194), imgS: shinySprite(194), forms: [
					{ name: "Male", img: baseSprite(194), imgS: shinySprite(194), },
					{ name: "Female", img: baseSprite("194-f"), imgS: shinySprite("194-f"), },
				],
			},
			{
				id: 59, natiId: 195, name: "Quagsire", img: baseSprite(195), imgS: shinySprite(195), forms: [
					{ name: "Male", img: baseSprite(195), imgS: shinySprite(195), },
					{ name: "Female", img: baseSprite("195-f"), imgS: shinySprite("195-f"), },
				],
			},
			{ id: 60, natiId: 704, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), },
			{ id: 61, natiId: 705, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), },
			{ id: 62, natiId: 706, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), },
			...
			{ id: 68, natiId: 1, name: "Bulbasaur", img: baseSprite(1), imgS: shinySprite(1), },
			{ id: 69, natiId: 2, name: "Ivysaur", img: baseSprite(2), imgS: shinySprite(2), },
			{
				id: 70, natiId: 3, name: "Venusaur", img: baseSprite(3), imgS: shinySprite(3), forms: [
					{ name: "Male", img: baseSprite(3), imgS: shinySprite(3), },
					{ name: "Female", img: baseSprite("003-f"), imgS: shinySprite("003-f"), },
				],
			},
			{ id: 71, natiId: 7, name: "Squirtle", img: baseSprite(7), imgS: shinySprite(7), },
			{ id: 72, natiId: 8, name: "Wartortle", img: baseSprite(8), imgS: shinySprite(8), },
			{ id: 73, natiId: 9, name: "Blastoise", img: baseSprite(9), imgS: shinySprite(9), },
			...
			{
				id: 81, natiId: 465, name: "Tangrowth", img: baseSprite(465), imgS: shinySprite(465), forms: [
					{ name: "Male", img: baseSprite(465), imgS: shinySprite(465), },
					{ name: "Female", img: baseSprite("465-f"), imgS: shinySprite("465-f"), },
				],
			},
			{
				id: 82, natiId: 453, name: "Croagunk", img: baseSprite(453), imgS: shinySprite(453), forms: [
					{ name: "Male", img: baseSprite(453), imgS: shinySprite(453), },
					{ name: "Female", img: baseSprite("453-f"), imgS: shinySprite("453-f"), },
				],
			},
			{
				id: 83, natiId: 454, name: "Toxicroak", img: baseSprite(454), imgS: shinySprite(454), forms: [
			...
			{
				id: 85, natiId: 25, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), forms: [
					...
					{ name: "World Cap", img: baseSprite("025-w"), imgS: shinySprite("025-w"), maxStatus: "caught", mythical: true, },
				],
			},
			{
				id: 86, natiId: 26, name: "Raichu", img: baseSprite(26), imgS: shinySprite(26), forms: [
			...
			{
				id: 94, natiId: 118, name: "Goldeen", img: baseSprite(118), imgS: shinySprite(118), forms: [
					{ name: "Male", img: baseSprite(118), imgS: shinySprite(118), },
					{ name: "Female", img: baseSprite("118-f"), imgS: shinySprite("118-f"), },
				],
			},
			{
				id: 95, natiId: 119, name: "Seaking", img: baseSprite(119), imgS: shinySprite(119), forms: [
			...
			{ id: 100, natiId: 891, name: "Kubfu", img: baseSprite(891), imgS: shinySprite(891), maxStatus: "caught", legendary: true, },
			{
				id: 101, natiId: 892, name: "Urshifu", img: baseSprite(892), imgS: shinySprite(892), maxStatus: "caught", legendary: true, forms: [
			...
			{
				id: 118, natiId: 123, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), forms: [
					{ name: "Male", img: baseSprite(123), imgS: shinySprite(123), },
					{ name: "Female", img: baseSprite("123-f"), imgS: shinySprite("123-f"), },
				],
			},
			{
				id: 119, natiId: 212, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), forms: [
			...
			{
				id: 121, natiId: 214, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), forms: [
			...
			{
				id: 145, natiId: 186, name: "Politoed", img: baseSprite(186), imgS: shinySprite(186), forms: [
			...
			{
				id: 158, natiId: 745, name: "Lycanroc", img: baseSprite(745), imgS: shinySprite(745), forms: [
			...
			{ id: 165, natiId: 782, name: "Jangmo-o", img: baseSprite(782), imgS: shinySprite(782), },
			{ id: 166, natiId: 783, name: "Hakamo-o", img: baseSprite(783), imgS: shinySprite(783), },
			{ id: 167, natiId: 784, name: "Kommo-o", img: baseSprite(784), imgS: shinySprite(784), },
			{
			...
			{ id: 175, natiId: 844, name: "Sandaconda", img: baseSprite(844), imgS: shinySprite(844), },
			...
			{
				id: 183, natiId: 111, name: "Rhyhorn", img: baseSprite(111), imgS: shinySprite(111), forms: [
					{ name: "Male", img: baseSprite(111), imgS: shinySprite(111), },
					{ name: "Female", img: baseSprite("111-f"), imgS: shinySprite("111-f"), },
				],
			},
			{
				id: 184, natiId: 112, name: "Rhydon", img: baseSprite(112), imgS: shinySprite(112), forms: [
					{ name: "Male", img: baseSprite(112), imgS: shinySprite(112), },
					{ name: "Female", img: baseSprite("112-f"), imgS: shinySprite("112-f"), },
				],
			},
			{
				id: 185, natiId: 464, name: "Rhyperior", img: baseSprite(464), imgS: shinySprite(464), forms: [
			...
			{
				id: 192, natiId: 592, name: "Frillish", img: baseSprite(592), imgS: shinySprite(592), forms: [
					{ name: "Male", img: baseSprite(592), imgS: shinySprite(592), },
					{ name: "Female", img: baseSprite("592-f"), imgS: shinySprite("592-f"), },
				],
			},
			{
				id: 193, natiId: 593, name: "Jellicent", img: baseSprite(593), imgS: shinySprite(593), forms: [
			...
			{
				id: 203, natiId: 415, name: "Combee", img: baseSprite(415), imgS: shinySprite(415), forms: [
			...
			{
				id: 211, natiId: 893, name: "Zarude", img: baseSprite(893), imgS: shinySprite(893), maxStatus: "caught", mythical: true, forms: [
