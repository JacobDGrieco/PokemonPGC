...
PPGC.register({
	dex: {
		[game]: [
			...
			{ id: 3, name: "Venusaur", img: baseSprite(3), imgS: shinySprite(3), tags: ["starter"], },
			...
			{ id: 6, name: "Charizard", img: baseSprite(6), imgS: shinySprite(6), tags: ["starter"], },
			...
			{ id: 9, name: "Blastoise", img: baseSprite(9), imgS: shinySprite(9), tags: ["starter"], },
			...
			{ id: 142, name: "Aerodactyl", img: baseSprite(142), imgS: shinySprite(142), tags: ["fossil"], },
			{ id: 143, name: "Snorlax", img: baseSprite(143), imgS: shinySprite(143), },
			{ id: 144, name: "Articuno", img: baseSprite(144), imgS: shinySprite(144), taskSync: ["yellow-catching-1-01"], tags: ["legendary"], },
			{ id: 145, name: "Zapdos", img: baseSprite(145), imgS: shinySprite(145), taskSync: ["yellow-catching-1-02"], tags: ["legendary"], },
			{ id: 146, name: "Moltres", img: baseSprite(146), imgS: shinySprite(146), taskSync: ["yellow-catching-1-03"], tags: ["legendary"], },
			{ id: 147, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), tags: ["pseudo"], },
			{ id: 148, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), tags: ["pseudo"], },
			{ id: 149, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), tags: ["pseudo"], },
			{ id: 150, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), taskSync: ["yellow-catching-1-04", "yellow-story-2-01"], tags: ["legendary"], },
			{ id: 151, name: "Mew", img: baseSprite(151), imgS: shinySprite(151), taskSync: ["yellow-extra-credit-1"], tags: ["mythical"], },
		],
	},
});