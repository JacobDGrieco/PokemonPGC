...
PPGC.register({
	dex: {
		[game]: [
			{ id: 1, name: "Bulbasaur", img: baseSprite(1), imgS: shinySprite(1), starter: true, },
			{ id: 2, name: "Ivysaur", img: baseSprite(2), imgS: shinySprite(2), starter: true, },
			{ id: 3, name: "Venusaur", img: baseSprite(3), imgS: shinySprite(3), starter: true, },
			{ id: 4, name: "Charmander", img: baseSprite(4), imgS: shinySprite(4), starter: true, },
			{ id: 5, name: "Charmeleon", img: baseSprite(5), imgS: shinySprite(5), starter: true, },
			{ id: 6, name: "Charizard", img: baseSprite(6), imgS: shinySprite(6), starter: true, },
			{ id: 7, name: "Squirtle", img: baseSprite(7), imgS: shinySprite(7), starter: true, },
			{ id: 8, name: "Wartortle", img: baseSprite(8), imgS: shinySprite(8), starter: true, },
			{ id: 9, name: "Blastoise", img: baseSprite(9), imgS: shinySprite(9), starter: true, },
			...
			{ id: 138, name: "Omanyte", img: baseSprite(138), imgS: shinySprite(138), fossil: true, },
			{ id: 139, name: "Omastar", img: baseSprite(139), imgS: shinySprite(139), fossil: true, },
			{ id: 140, name: "Kabuto", img: baseSprite(140), imgS: shinySprite(140), fossil: true, },
			{ id: 141, name: "Kabutops", img: baseSprite(141), imgS: shinySprite(141), fossil: true, },
			{ id: 142, name: "Aerodactyl", img: baseSprite(142), imgS: shinySprite(142), fossil: true, },
			...
			{ id: 147, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), pseduo: true, },
			{ id: 148, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), pseduo: true, },
			{ id: 149, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), pseduo: true, },
			{ id: 150, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), legendary: true, taskSync: ["yellow-catching-1-04", "yellow-story-2-01"], },
