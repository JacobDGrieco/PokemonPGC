...
PPGC.register({
	dex: {
		[sub]: [
			...
			{
				id: 7, natiId: 20, name: "Raticate", img: baseSprite("20-a"), imgS: shinySprite("20-a"), forms: [
			...
			{
				id: 14, natiId: 97, name: "Hypno", img: baseSprite(97), imgS: shinySprite(97), forms: [
			...
			{
				id: 19, natiId: 41, name: "Zubat", img: baseSprite(41), imgS: shinySprite(41), forms: [
					{ name: "Male", img: baseSprite(41), imgS: shinySprite(41), },
					{ name: "Female", img: baseSprite("041-f"), imgS: shinySprite("041-f"), },
				],
			},
			{
				id: 20, natiId: 42, name: "Golbat", img: baseSprite(42), imgS: shinySprite(42), forms: [
			...
			{
				id: 32, natiId: 741, name: "Oricorio", img: baseSprite("741-s"), imgS: shinySprite("741-s"), forms: [
			...
			{
				id: 41, natiId: 129, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), forms: [
					{ name: "Male", img: baseSprite(129), imgS: shinySprite(129), },
					{ name: "Female", img: baseSprite("129-f"), imgS: shinySprite("129-f"), },
				],
			},
			{
				id: 42, natiId: 130, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), forms: [
			...
			{
				id: 54, natiId: 745, name: "Lycanroc", img: baseSprite(745), imgS: shinySprite(745), forms: [
			...
			{
				id: 57, natiId: 456, name: "Finneon", img: baseSprite(456), imgS: shinySprite(456), forms: [
					{ name: "Male", img: baseSprite(456), imgS: shinySprite(456), },
					{ name: "Female", img: baseSprite("456-f"), imgS: shinySprite("456-f"), },
				],
			},
			{
				id: 58, natiId: 457, name: "Lumineon", img: baseSprite(457), imgS: shinySprite(457), forms: [
			...
			{ id: 65, natiId: 127, name: "Pinsir", img: baseSprite(127), imgS: shinySprite(127), },
			{ id: 66, natiId: 704, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), },
			{ id: 67, natiId: 705, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), },
			{ id: 68, natiId: 706, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), },
			{
				id: 69, natiId: 351, name: "Castform", img: baseSprite(351), imgS: shinySprite(351), forms: [
			...
			{
				id: 75, natiId: 422, name: "Shellos", img: baseSprite(422), imgS: shinySprite(422), forms: [
					{ name: "West Sea", img: baseSprite(422), imgS: shinySprite(422), },
					{ name: "East Sea", img: baseSprite("422-e"), imgS: shinySprite("422-e"), },
				],
			},
			{
				id: 76, natiId: 423, name: "Gastrodon", img: baseSprite(423), imgS: shinySprite(423), forms: [
					{ name: "West Sea", img: baseSprite(423), imgS: shinySprite(423), },
					{ name: "East Sea", img: baseSprite("423-e"), imgS: shinySprite("423-e"), },
				],
			},
			{
				id: 77, natiId: 369, name: "Relicanth", img: baseSprite(369), imgS: shinySprite(369), forms: [
			...
			{ id: 80, natiId: 319, name: "Sharpedo", img: baseSprite(319), imgS: shinySprite(319), },
			...
			{ id: 86, natiId: 782, name: "Jangmo-o", img: baseSprite(782), imgS: shinySprite(782), },
			{ id: 87, natiId: 783, name: "Hakamo-o", img: baseSprite(783), imgS: shinySprite(783), },
			{ id: 88, natiId: 784, name: "Kommo-o", img: baseSprite(784), imgS: shinySprite(784), },
			{ id: 89, natiId: 587, name: "Emolga", img: baseSprite(587), imgS: shinySprite(587), },
			{
				id: 90, natiId: 123, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), forms: [
					{ name: "Male", img: baseSprite(123), imgS: shinySprite(123), },
					{ name: "Female", img: baseSprite("123-f"), imgS: shinySprite("123-f"), },
				],
			},
			{
				id: 91, natiId: 212, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), forms: [
					{ name: "Male", img: baseSprite(212), imgS: shinySprite(212), },
					{ name: "Female", img: baseSprite("212-f"), imgS: shinySprite("212-f"), },
				],
			},
			{
				id: 92, natiId: 198, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), forms: [
			...
			{ id: 95, natiId: 448, name: "Lucario", img: baseSprite(448), imgS: shinySprite(448), },
			{ id: 96, natiId: 147, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), },
			{ id: 97, natiId: 148, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), },
			{ id: 98, natiId: 149, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), },
			{ id: 99, natiId: 142, name: "Aerodactyl", img: baseSprite(142), imgS: shinySprite(142), },
			{ id: 100, natiId: 788, name: "Tapu Fini", img: baseSprite(788), imgS: shinySprite(788), legendary: true, }
		],
	},
});