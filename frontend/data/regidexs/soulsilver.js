...
PPGC.register({
	dex: {
		[game]: [
			{ id: 1, name: "Chikorita", img: baseSprite(152), imgS: shinySprite(152), dexSync: nationalDex(152), tags: ["starter"] },
			{ id: 2, name: "Bayleef", img: baseSprite(153), imgS: shinySprite(153), dexSync: nationalDex(153), tags: ["starter"] },
			{
				id: 3, name: "Meganium", img: baseSprite(154), imgS: shinySprite(154), dexSync: nationalDex(154), tags: ["gender", "starter"], forms: [
			...
			{ id: 4, name: "Cyndaquil", img: baseSprite(155), imgS: shinySprite(155), dexSync: nationalDex(155), tags: ["starter"] },
			{ id: 5, name: "Quilava", img: baseSprite(156), imgS: shinySprite(156), dexSync: nationalDex(156), tags: ["starter"] },
			{ id: 6, name: "Typhlosion", img: baseSprite(157), imgS: shinySprite(157), dexSync: nationalDex(157), tags: ["starter"] },
			{ id: 7, name: "Totodile", img: baseSprite(158), imgS: shinySprite(158), dexSync: nationalDex(158), tags: ["starter"] },
			{ id: 8, name: "Croconaw", img: baseSprite(159), imgS: shinySprite(159), dexSync: nationalDex(159), tags: ["starter"] },
			{ id: 9, name: "Feraligatr", img: baseSprite(160), imgS: shinySprite(160), dexSync: nationalDex(160), tags: ["starter"] },
			...
			{
				id: 17, name: "Rattata", img: baseSprite(19), imgS: shinySprite(19), dexSync: nationalDex(19), tags: ["gender"], forms: [
			...
			{
				id: 18, name: "Raticate", img: baseSprite(20), imgS: shinySprite(20), dexSync: nationalDex(20), tags: ["gender"], forms: [
			...
			{
				id: 21, name: "Pichu", img: baseSprite(172), imgS: shinySprite(172), dexSync: nationalDex(172), tags: ["other"], forms: [
			...
			{
				id: 22, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), dexSync: nationalDex(25), tags: ["gender"], forms: [
			...
			{
				id: 23, name: "Raichu", img: baseSprite(26), imgS: shinySprite(26), dexSync: nationalDex(26), tags: ["gender"], forms: [
			...
			{
				id: 26, name: "Butterfree", img: baseSprite(12), imgS: shinySprite(12), dexSync: nationalDex(12), tags: ["gender"], forms: [
			...
			{
				id: 30, name: "Ledyba", img: baseSprite(165), imgS: shinySprite(165), dexSync: nationalDex(165), tags: ["gender"], forms: [
			...
			{
				id: 31, name: "Ledian", img: baseSprite(166), imgS: shinySprite(166), dexSync: nationalDex(166), tags: ["gender"], forms: [
			...
			{
				id: 37, name: "Zubat", img: baseSprite(41), imgS: shinySprite(41), dexSync: nationalDex(41), tags: ["gender"], forms: [
			...
			{
				id: 38, name: "Golbat", img: baseSprite(42), imgS: shinySprite(42), dexSync: nationalDex(42), tags: ["gender"], forms: [
			...
			{
				id: 56, name: "Wooper", img: baseSprite(194), imgS: shinySprite(194), dexSync: nationalDex(194), tags: ["gender"], forms: [
			...
			{
				id: 57, name: "Quagsire", img: baseSprite(195), imgS: shinySprite(195), dexSync: nationalDex(195), tags: ["gender"], forms: [
			...
			{
				id: 61, name: "Unown", img: baseSprite(201), imgS: shinySprite(201), dexSync: nationalDex(201), tags: ["other"], forms: [
			...
			{
				id: 63, name: "Steelix", img: baseSprite(208), imgS: shinySprite(208), dexSync: nationalDex(208), tags: ["gender"], forms: [
			...
			{
				id: 75, name: "Politoed", img: baseSprite(186), imgS: shinySprite(186), dexSync: nationalDex(186), tags: ["gender"], forms: [
			...
			{
				id: 76, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), dexSync: nationalDex(129), tags: ["gender"], forms: [
			...
			{
				id: 77, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), dexSync: nationalDex(130), tags: ["gender"], forms: [
			...
			{
				id: 84, name: "Gloom", img: baseSprite(44), imgS: shinySprite(44), dexSync: nationalDex(44), tags: ["gender"], forms: [
			...
			{
				id: 85, name: "Vileplume", img: baseSprite(45), imgS: shinySprite(45), dexSync: nationalDex(45), tags: ["gender"], forms: [
			...
			{
				id: 88, name: "Hypno", img: baseSprite(97), imgS: shinySprite(97), dexSync: nationalDex(97), tags: ["gender"], forms: [
			...
			{
				id: 90, name: "Kadabra", img: baseSprite(64), imgS: shinySprite(64), dexSync: nationalDex(64), tags: ["gender"], forms: [
			...
			{
				id: 91, name: "Alakazam", img: baseSprite(65), imgS: shinySprite(65), dexSync: nationalDex(65), tags: ["gender"], forms: [
			...
			{
				id: 107, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), dexSync: nationalDex(185), tags: ["gender"], forms: [
			...
			{
				id: 108, name: "Wobbuffet", img: baseSprite(202), imgS: shinySprite(202), dexSync: nationalDex(202), tags: ["gender"], forms: [
			...
			{
				id: 111, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), dexSync: nationalDex(123), tags: ["gender"], forms: [
			...
			{
				id: 112, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), dexSync: nationalDex(212), tags: ["gender"], forms: [
			...
			{
				id: 114, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), dexSync: nationalDex(214), tags: ["gender"], forms: [
			...
			{
				id: 123, name: "Aipom", img: baseSprite(190), imgS: shinySprite(190), dexSync: nationalDex(190), tags: ["gender"], forms: [
			...
			{
				id: 124, name: "Ambipom", img: baseSprite(424), imgS: shinySprite(424), dexSync: nationalDex(424), tags: ["gender"], forms: [
			...
			{
				id: 149, name: "Girafarig", img: baseSprite(203), imgS: shinySprite(203), dexSync: nationalDex(203), tags: ["gender"], forms: [
			...
			{
				id: 162, name: "Xatu", img: baseSprite(178), imgS: shinySprite(178), dexSync: nationalDex(178), tags: ["gender"], forms: [
			...
			{
				id: 175, name: "Octillery", img: baseSprite(224), imgS: shinySprite(224), dexSync: nationalDex(224), tags: ["gender"], forms: [
			...
			{
				id: 183, name: "Tangrowth", img: baseSprite(465), imgS: shinySprite(465), dexSync: nationalDex(465), tags: ["gender"], forms: [
			...
			{
				id: 193, name: "Gligar", img: baseSprite(207), imgS: shinySprite(207), dexSync: nationalDex(207), tags: ["gender"], forms: [
			...
			{
				id: 196, name: "Piloswine", img: baseSprite(221), imgS: shinySprite(221), dexSync: nationalDex(221), tags: ["gender"], forms: [
			...
			{
				id: 197, name: "Mamoswine", img: baseSprite(473), imgS: shinySprite(473), dexSync: nationalDex(473), tags: ["gender"], forms: [
			...
			{
				id: 199, name: "Ursaring", img: baseSprite(217), imgS: shinySprite(217), dexSync: nationalDex(217), tags: ["gender"], forms: [
			...
			{
				id: 201, name: "Donphan", img: baseSprite(232), imgS: shinySprite(232), dexSync: nationalDex(232), tags: ["gender"], forms: [
			...
			{
				id: 204, name: "Doduo", img: baseSprite(84), imgS: shinySprite(84), dexSync: nationalDex(84), tags: ["gender"], forms: [
			...
			{
				id: 205, name: "Dodrio", img: baseSprite(85), imgS: shinySprite(85), dexSync: nationalDex(85), tags: ["gender"], forms: [
			...
			{
				id: 211, name: "Rhyhorn", img: baseSprite(111), imgS: shinySprite(111), dexSync: nationalDex(111), tags: ["gender"], forms: [
			...
			{
				id: 212, name: "Rhydon", img: baseSprite(112), imgS: shinySprite(112), dexSync: nationalDex(112), tags: ["gender"], forms: [
			...
			{
				id: 213, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), dexSync: nationalDex(198), tags: ["gender"], forms: [
			...
			{
				id: 215, name: "Houndoom", img: baseSprite(229), imgS: shinySprite(229), dexSync: nationalDex(229), tags: ["gender"], forms: [
			...
			{
				id: 218, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), dexSync: nationalDex(215), tags: ["gender"], forms: [
			...
			{ id: 225, name: "Omanyte", img: baseSprite(138), imgS: shinySprite(138), dexSync: nationalDex(138), tags: ["fossil"] },
			{ id: 226, name: "Omastar", img: baseSprite(139), imgS: shinySprite(139), dexSync: nationalDex(139), tags: ["fossil"] },
			{ id: 227, name: "Kabuto", img: baseSprite(140), imgS: shinySprite(140), dexSync: nationalDex(140), tags: ["fossil"] },
			{ id: 228, name: "Kabutops", img: baseSprite(141), imgS: shinySprite(141), dexSync: nationalDex(141), tags: ["fossil"] },
			{ id: 229, name: "Aerodactyl", img: baseSprite(142), imgS: shinySprite(142), dexSync: nationalDex(142), tags: ["fossil"] },
			{ id: 230, name: "Snorlax", img: baseSprite(143), imgS: shinySprite(143), dexSync: nationalDex(143) },
			{ id: 231, name: "Bulbasaur", img: baseSprite(1), imgS: shinySprite(1), dexSync: nationalDex(1), tags: ["starter"] },
			{ id: 232, name: "Ivysaur", img: baseSprite(2), imgS: shinySprite(2), dexSync: nationalDex(2), tags: ["starter"] },
			{
				id: 233, name: "Venusaur", img: baseSprite(3), imgS: shinySprite(3), dexSync: nationalDex(3), tags: ["gender", "starter"], forms: [
			...
			{ id: 234, name: "Charmander", img: baseSprite(4), imgS: shinySprite(4), dexSync: nationalDex(4), tags: ["starter"] },
			{ id: 235, name: "Charmeleon", img: baseSprite(5), imgS: shinySprite(5), dexSync: nationalDex(5), tags: ["starter"] },
			{ id: 236, name: "Charizard", img: baseSprite(6), imgS: shinySprite(6), dexSync: nationalDex(6), tags: ["starter"] },
			{ id: 237, name: "Squirtle", img: baseSprite(7), imgS: shinySprite(7), dexSync: nationalDex(7), tags: ["starter"] },
			{ id: 238, name: "Wartortle", img: baseSprite(8), imgS: shinySprite(8), dexSync: nationalDex(8), tags: ["starter"] },
			{ id: 239, name: "Blastoise", img: baseSprite(9), imgS: shinySprite(9), dexSync: nationalDex(9), tags: ["starter"] },
			{ id: 240, name: "Articuno", img: baseSprite(144), imgS: shinySprite(144), dexSync: nationalDex(144), tags: ["legendary"] },
			{ id: 241, name: "Zapdos", img: baseSprite(145), imgS: shinySprite(145), dexSync: nationalDex(145), tags: ["legendary"] },
			{ id: 242, name: "Moltres", img: baseSprite(146), imgS: shinySprite(146), dexSync: nationalDex(146), tags: ["legendary"] },
			{ id: 243, name: "Raikou", img: baseSprite(243), imgS: shinySprite(243), dexSync: nationalDex(243), tags: ["legendary"] },
			{ id: 244, name: "Entei", img: baseSprite(244), imgS: shinySprite(244), dexSync: nationalDex(244), tags: ["legendary"] },
			{ id: 245, name: "Suicune", img: baseSprite(245), imgS: shinySprite(245), dexSync: nationalDex(245), tags: ["legendary"] },
			{ id: 246, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), dexSync: nationalDex(147), tags: ["pseudo"] },
			{ id: 247, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), dexSync: nationalDex(148), tags: ["pseudo"] },
			{ id: 248, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), dexSync: nationalDex(149), tags: ["pseudo"] },
			{ id: 249, name: "Larvitar", img: baseSprite(246), imgS: shinySprite(246), dexSync: nationalDex(246), tags: ["pseudo"] },
			{ id: 250, name: "Pupitar", img: baseSprite(247), imgS: shinySprite(247), dexSync: nationalDex(247), tags: ["pseudo"] },
			{ id: 251, name: "Tyranitar", img: baseSprite(248), imgS: shinySprite(248), dexSync: nationalDex(248), tags: ["pseudo"] },
			{ id: 252, name: "Lugia", img: baseSprite(249), imgS: shinySprite(249), dexSync: nationalDex(249), tags: ["legendary"] },
			{ id: 253, name: "Ho-oh", img: baseSprite(250), imgS: shinySprite(250), dexSync: nationalDex(250), tags: ["legendary"] },
			{ id: 254, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), dexSync: nationalDex(150), tags: ["legendary"] },
			{ id: 255, name: "Mew", img: baseSprite(151), imgS: shinySprite(151), dexSync: nationalDex(151), tags: ["mythical"] },
			{ id: 256, name: "Celebi", img: baseSprite(251), imgS: shinySprite(251), dexSync: nationalDex(251), tags: ["mythical"] }
		],
	},
});
