...
PPGC.register({
	dex: {
		[sub]: [
			...
			{ id: 15, name: "Scovillain", img: baseSprite(952), imgS: shinySprite(952), },
			...
			{ id: 21, name: "Glimmora", img: baseSprite(970), imgS: shinySprite(970), },
			{
				id: 22, name: "Rotom", img: baseSprite(479), imgS: shinySprite(479), forms: [
			...
			{
				id: 31, name: "Tatsugiri", img: baseSprite(978), imgS: shinySprite(978), forms: [
			...
			{ id: 32, name: "Frigibax", img: baseSprite(996), imgS: shinySprite(996), },
			{ id: 33, name: "Arctibax", img: baseSprite(997), imgS: shinySprite(997), },
			{ id: 34, name: "Baxcalibur", img: baseSprite(998), imgS: shinySprite(998), },
			...
			{ id: 39, name: "Treecko", img: baseSprite(252), imgS: shinySprite(252), },
			{ id: 40, name: "Grovyle", img: baseSprite(253), imgS: shinySprite(253), },
			{ id: 41, name: "Sceptile", img: baseSprite(254), imgS: shinySprite(254), },
			{
				id: 42, name: "Torchic", img: baseSprite(255), imgS: shinySprite(255), forms: [
					{ name: "Male", img: baseSprite(255), imgS: shinySprite(255), },
					{ name: "Female", img: baseSprite("255-f"), imgS: shinySprite("255-f"), },
				],
			},
			{
				id: 43, name: "Combusken", img: baseSprite(256), imgS: shinySprite(256), forms: [
					{ name: "Male", img: baseSprite(256), imgS: shinySprite(256), },
					{ name: "Female", img: baseSprite("256-f"), imgS: shinySprite("256-f"), },
				],
			},
			{
				id: 44, name: "Blaziken", img: baseSprite(257), imgS: shinySprite(257), forms: [
					{ name: "Male", img: baseSprite(257), imgS: shinySprite(257), },
					{ name: "Female", img: baseSprite("257-f"), imgS: shinySprite("257-f"), },
				],
			},
			{ id: 45, name: "Mudkip", img: baseSprite(258), imgS: shinySprite(258), },
			{ id: 46, name: "Marshtomp", img: baseSprite(259), imgS: shinySprite(259), },
			{ id: 47, name: "Swampert", img: baseSprite(260), imgS: shinySprite(260), },
			...
			{ id: 51, name: "Chimecho", img: baseSprite(358), imgS: shinySprite(358), },
			{
				id: 52, name: "Indeedee", img: baseSprite(876), imgS: shinySprite(876), forms: [
			...
			{ id: 63, name: "Golisopod", img: baseSprite(768), imgS: shinySprite(768), },
			...
			{ id: 72, name: "Golurk", img: baseSprite(623), imgS: shinySprite(623), },
			...
			{
				id: 86, name: "Squawkabilly", img: baseSprite(931), imgS: shinySprite(931), forms: [
			...
			{ id: 88, name: "Crabominable", img: baseSprite(740), imgS: shinySprite(740), },
			...
			{
				id: 92, name: "Gulpin", img: baseSprite(316), imgS: shinySprite(316), forms: [
					{ name: "Male", img: baseSprite(316), imgS: shinySprite(316), },
					{ name: "Female", img: baseSprite("316-f"), imgS: shinySprite("316-f"), },
				],
			},
			{
				id: 93, name: "Swalot", img: baseSprite(317), imgS: shinySprite(317), forms: [
			...
			{
				id: 103, name: "Toxtricity", img: baseSprite(849), imgS: shinySprite(849), forms: [
			...
			{ id: 113, name: "Heatran", img: baseSprite(485), imgS: shinySprite(485), },
			{ id: 114, name: "Volcanion", img: baseSprite(721), imgS: shinySprite(721), },
			{ id: 115, name: "Cobalion", img: baseSprite(638), imgS: shinySprite(638), },
			{ id: 116, name: "Terrakion", img: baseSprite(639), imgS: shinySprite(639), },
			{ id: 117, name: "Virizion", img: baseSprite(640), imgS: shinySprite(640), },
			{
				id: 118, name: "Keldeo", img: baseSprite(647), imgS: shinySprite(647), forms: [
			...
			{
				id: 121, name: "Hoopa", img: baseSprite(720), imgS: shinySprite(720), forms: [
			...
			{ id: 125, name: "Darkrai", img: baseSprite(491), imgS: shinySprite(491), },
			{ id: 126, name: "Latias", img: baseSprite(380), imgS: shinySprite(380), },
			{ id: 127, name: "Latios", img: baseSprite(381), imgS: shinySprite(381), },
			{ id: 128, name: "Kyogre", img: baseSprite(382), imgS: shinySprite(382), },
			{ id: 129, name: "Groudon", img: baseSprite(383), imgS: shinySprite(383), },
			{ id: 130, name: "Rayquaza", img: baseSprite(384), imgS: shinySprite(384), },
			{
				id: 131, name: "Magearna", img: baseSprite(801), imgS: shinySprite(801), forms: [
					{ name: "Normal", img: baseSprite(801), imgS: shinySprite(801), },
					{ name: "Original Color", img: baseSprite("801-o"), imgS: shinySprite("801-o"), },
				],
			},
			{ id: 132, name: "Zeraora", img: baseSprite(807), imgS: shinySprite(807), },
