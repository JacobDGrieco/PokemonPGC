...
PPGC.register({
	dex: {
		[game]: [
			{ id: 1, natiId: 252, name: "Treecko", img: baseSprite(252), imgS: shinySprite(252), },
			{ id: 2, natiId: 253, name: "Grovyle", img: baseSprite(253), imgS: shinySprite(253), },
			{ id: 3, natiId: 254, name: "Sceptile", img: baseSprite(254), imgS: shinySprite(254), },
			{
				id: 4, natiId: 255, name: "Torchic", img: baseSprite(255), imgS: shinySprite(255), forms: [
					{ name: "Male", img: baseSprite(255), imgS: shinySprite(255), },
					{ name: "Female", img: baseSprite("255-f"), imgS: shinySprite("255-f"), },
				],
			},
			{
				id: 5, natiId: 256, name: "Combusken", img: baseSprite(256), imgS: shinySprite(256), forms: [
					{ name: "Male", img: baseSprite(256), imgS: shinySprite(256), },
					{ name: "Female", img: baseSprite("256-f"), imgS: shinySprite("256-f"), },
				],
			},
			{
				id: 6, natiId: 257, name: "Blaziken", img: baseSprite(257), imgS: shinySprite(257), forms: [
					{ name: "Male", img: baseSprite(257), imgS: shinySprite(257), },
					{ name: "Female", img: baseSprite("257-f"), imgS: shinySprite("257-f"), },],
			},
			{ id: 7, natiId: 258, name: "Mudkip", img: baseSprite(258), imgS: shinySprite(258), },
			{ id: 8, natiId: 259, name: "Marshtomp", img: baseSprite(259), imgS: shinySprite(259), },
			{ id: 9, natiId: 260, name: "Swampert", img: baseSprite(260), imgS: shinySprite(260), },
			...
			{
				id: 16, natiId: 267, name: "Beautifly", img: baseSprite(267), imgS: shinySprite(267), forms: [
			...
			{
				id: 18, natiId: 269, name: "Dustox", img: baseSprite(269), imgS: shinySprite(269), forms: [
			...
			{
				id: 21, natiId: 272, name: "Ludicolo", img: baseSprite(272), imgS: shinySprite(272), forms: [
			...
			{
				id: 23, natiId: 274, name: "Nuzleaf", img: baseSprite(274), imgS: shinySprite(274), forms: [
					{ name: "Male", img: baseSprite(274), imgS: shinySprite(274), },
					{ name: "Female", img: baseSprite("274-f"), imgS: shinySprite("274-f"), },
				],
			},
			{
				id: 24, natiId: 275, name: "Shiftry", img: baseSprite(275), imgS: shinySprite(275), forms: [
			...
			{
				id: 41, natiId: 64, name: "Kadabra", img: baseSprite(64), imgS: shinySprite(64), forms: [
					{ name: "Male", img: baseSprite(64), imgS: shinySprite(64), },
					{ name: "Female", img: baseSprite("064-f"), imgS: shinySprite("064-f"), },
				],
			},
			{
				id: 42, natiId: 65, name: "Alakazam", img: baseSprite(65), imgS: shinySprite(65), forms: [
			...
			{
				id: 65, natiId: 41, name: "Zubat", img: baseSprite(41), imgS: shinySprite(41), forms: [
					{ name: "Male", img: baseSprite(41), imgS: shinySprite(41), },
					{ name: "Female", img: baseSprite("041-f"), imgS: shinySprite("041-f"), },
				],
			},
			{
				id: 66, natiId: 42, name: "Golbat", img: baseSprite(42), imgS: shinySprite(42), forms: [
			...
			{ id: 70, natiId: 302, name: "Sableye", img: baseSprite(302), imgS: shinySprite(302), },
			{ id: 71, natiId: 303, name: "Mawile", img: baseSprite(303), imgS: shinySprite(303), },
			...
			{ id: 74, natiId: 306, name: "Aggron", img: baseSprite(306), imgS: shinySprite(306), },
			...
			{
				id: 78, natiId: 307, name: "Meditite", img: baseSprite(307), imgS: shinySprite(307), forms: [
					{ name: "Male", img: baseSprite(307), imgS: shinySprite(307), },
					{ name: "Female", img: baseSprite("307-f"), imgS: shinySprite("307-f"), },
				],
			},
			{
				id: 79, natiId: 308, name: "Medicham", img: baseSprite(308), imgS: shinySprite(308), forms: [
			...
			{ id: 81, natiId: 310, name: "Manectric", img: baseSprite(310), imgS: shinySprite(310), },
			...
			{
				id: 92, natiId: 44, name: "Gloom", img: baseSprite(44), imgS: shinySprite(44), forms: [
					{ name: "Male", img: baseSprite(44), imgS: shinySprite(44), },
					{ name: "Female", img: baseSprite("044-f"), imgS: shinySprite("044-f"), },
				],
			},
			{
				id: 93, natiId: 45, name: "Vileplume", img: baseSprite(45), imgS: shinySprite(45), forms: [
			...
			{
				id: 95, natiId: 84, name: "Doduo", img: baseSprite(84), imgS: shinySprite(84), forms: [
					{ name: "Male", img: baseSprite(84), imgS: shinySprite(84), },
					{ name: "Female", img: baseSprite("084-f"), imgS: shinySprite("084-f"), },
				],
			},
			{
				id: 96, natiId: 85, name: "Dodrio", img: baseSprite(85), imgS: shinySprite(85), forms: [
			...
			{ id: 103, natiId: 319, name: "Sharpedo", img: baseSprite(319), imgS: shinySprite(319), },
			...
			{
				id: 106, natiId: 322, name: "Numel", img: baseSprite(322), imgS: shinySprite(322), forms: [
					{ name: "Male", img: baseSprite(322), imgS: shinySprite(322), },
					{ name: "Female", img: baseSprite("322-f"), imgS: shinySprite("322-f"), },
				],
			},
			{
				id: 107, natiId: 323, name: "Camerupt", img: baseSprite(323), imgS: shinySprite(323), forms: [
			...
			{
				id: 125, natiId: 332, name: "Cacturne", img: baseSprite(332), imgS: shinySprite(332), forms: [
			...
			{ id: 127, natiId: 334, name: "Altaria", img: baseSprite(334), imgS: shinySprite(334), },
			...
			{ id: 138, natiId: 345, name: "Lileep", img: baseSprite(345), imgS: shinySprite(345), },
			{ id: 139, natiId: 346, name: "Cradily", img: baseSprite(346), imgS: shinySprite(346), },
			{ id: 140, natiId: 347, name: "Anorith", img: baseSprite(347), imgS: shinySprite(347), },
			{ id: 141, natiId: 348, name: "Armaldo", img: baseSprite(348), imgS: shinySprite(348), },
			...
			{
				id: 146, natiId: 350, name: "Milotic", img: baseSprite(350), imgS: shinySprite(350), forms: [
					{ name: "Male", img: baseSprite(350), imgS: shinySprite(350), },
					{ name: "Female", img: baseSprite("350-f"), imgS: shinySprite("350-f"), },
				],
			},
			{
				id: 147, natiId: 351, name: "Castform", img: baseSprite(351), imgS: shinySprite(351), forms: [
			...
			{ id: 152, natiId: 354, name: "Banette", img: baseSprite(354), imgS: shinySprite(354), },
			...
			{ id: 159, natiId: 359, name: "Absol", img: baseSprite(359), imgS: shinySprite(359), },
			...
			{
				id: 163, natiId: 25, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), forms: [
					{ name: "Male", img: baseSprite(25), imgS: shinySprite(25), },
					{ name: "Female", img: baseSprite("025-f"), imgS: shinySprite("025-f"), },
				],
			},
			{
				id: 164, natiId: 26, name: "Raichu", img: baseSprite(26), imgS: shinySprite(26), forms: [
			...
			{
				id: 168, natiId: 202, name: "Wobbuffet", img: baseSprite(202), imgS: shinySprite(202), forms: [
			...
			{
				id: 170, natiId: 178, name: "Xatu", img: baseSprite(178), imgS: shinySprite(178), forms: [
					{ name: "Male", img: baseSprite(178), imgS: shinySprite(178), },
					{ name: "Female", img: baseSprite("178-f"), imgS: shinySprite("178-f"), },
				],
			},
			{
				id: 171, natiId: 203, name: "Girafarig", img: baseSprite(203), imgS: shinySprite(203), forms: [
			...
			{
				id: 173, natiId: 232, name: "Donphan", img: baseSprite(232), imgS: shinySprite(232), forms: [
					{ name: "Male", img: baseSprite(232), imgS: shinySprite(232), },
					{ name: "Female", img: baseSprite("232-f"), imgS: shinySprite("232-f"), },
				],
			},
			{ id: 174, natiId: 127, name: "Pinsir", img: baseSprite(127), imgS: shinySprite(127), },
			{
				id: 175, natiId: 214, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), forms: [
					{ name: "Male", img: baseSprite(214), imgS: shinySprite(214), },
					{ name: "Female", img: baseSprite("214-f"), imgS: shinySprite("214-f"), },],
			},
			{
				id: 176, natiId: 111, name: "Rhyhorn", img: baseSprite(111), imgS: shinySprite(111), forms: [
					{ name: "Male", img: baseSprite(111), imgS: shinySprite(111), },
					{ name: "Female", img: baseSprite("111-f"), imgS: shinySprite("111-f"), },
				],
			},
			{
				id: 177, natiId: 112, name: "Rhydon", img: baseSprite(112), imgS: shinySprite(112), forms: [
					{ name: "Male", img: baseSprite(112), imgS: shinySprite(112), },
					{ name: "Female", img: baseSprite("112-f"), imgS: shinySprite("112-f"), },
				],
			},
			{
				id: 178, natiId: 464, name: "Rhyperior", img: baseSprite(464), imgS: shinySprite(464), forms: [
			...
			{ id: 180, natiId: 362, name: "Glalie", img: baseSprite(362), imgS: shinySprite(362), },
			...
			{
				id: 188, natiId: 369, name: "Relicanth", img: baseSprite(369), imgS: shinySprite(369), forms: [
			...
			{ id: 196, natiId: 371, name: "Bagon", img: baseSprite(371), imgS: shinySprite(371), },
			{ id: 197, natiId: 372, name: "Shelgon", img: baseSprite(372), imgS: shinySprite(372), },
			{ id: 198, natiId: 373, name: "Salamence", img: baseSprite(373), imgS: shinySprite(373), },
			{ id: 199, natiId: 374, name: "Beldum", img: baseSprite(374), imgS: shinySprite(374), },
			{ id: 200, natiId: 375, name: "Metang", img: baseSprite(375), imgS: shinySprite(375), },
			{ id: 201, natiId: 376, name: "Metagross", img: baseSprite(376), imgS: shinySprite(376), },
			{ id: 202, natiId: 377, name: "Regirock", img: baseSprite(377), imgS: shinySprite(377), legendary: true, },
			{ id: 203, natiId: 378, name: "Regice", img: baseSprite(378), imgS: shinySprite(378), legendary: true, },
			{ id: 204, natiId: 379, name: "Registeel", img: baseSprite(379), imgS: shinySprite(379), legendary: true, },
			{ id: 205, natiId: 380, name: "Latias", img: baseSprite(380), imgS: shinySprite(380), },
			{ id: 206, natiId: 381, name: "Latios", img: baseSprite(381), imgS: shinySprite(381), legendary: true, },
			{ id: 207, natiId: 382, name: "Kyogre", img: baseSprite(382), imgS: shinySprite(382), legendary: true, },
			{ id: 208, natiId: 383, name: "Groudon", img: baseSprite(383), imgS: shinySprite(383), legendary: true, },
			{ id: 209, natiId: 384, name: "Rayquaza", img: baseSprite(384), imgS: shinySprite(384), legendary: true, },
			{ id: 210, natiId: 385, name: "Jirachi", img: baseSprite(385), imgS: shinySprite(385), mythical: true, },
			{
				id: 211, natiId: 386, name: "Deoxys", img: baseSprite(386), imgS: shinySprite(386), legendary: true, forms: [
					{ name: "Normal", img: baseSprite(386), imgS: shinySprite(386), legendary: true, },
					{ name: "Attack", img: baseSprite("386-a"), imgS: shinySprite("386-a"), legendary: true, },
					{ name: "Defense", img: baseSprite("386-d"), imgS: shinySprite("386-d"), legendary: true, },
					{ name: "Speed", img: baseSprite("386-s"), imgS: shinySprite("386-s"), legendary: true, },
				],
			}
		],
	},
