...
PPGC.register({
	dex: {
		[game]: [
			...
			{
				id: 122, natiId: 449, name: "Hippopotas", img: () => baseSprite(449), imgS: () => shinySprite(449), tags: ["gender"], forms: [
			...
			{ id: 146, natiId: 480, name: "Uxie", img: () => baseSprite(480), imgS: () => shinySprite(480) },
			{ id: 147, natiId: 481, name: "Mesprit", img: () => baseSprite(481), imgS: () => shinySprite(481) },
			{ id: 148, natiId: 482, name: "Azelf", img: () => baseSprite(482), imgS: () => shinySprite(482) },
			...
			{
				id: 152, natiId: 479, name: "Rotom", img: () => baseSprite(479), imgS: () => shinySprite(479), tags: ["other"], forms: [
			...
			{
				id: 153, natiId: 207, name: "Gligar", img: () => baseSprite(207), imgS: () => shinySprite(207), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(207), imgS: () => shinySprite(207), },
					{ name: "Female", img: () => baseSprite("0207-f"), imgS: () => shinySprite("0207-f"), },
				]
			},
			{ id: 154, natiId: 472, name: "Gliscor", img: () => baseSprite(472), imgS: () => shinySprite(472) },
			...
			{ id: 157, natiId: 280, name: "Ralts", img: () => baseSprite(280), imgS: () => shinySprite(280) },
			{ id: 158, natiId: 281, name: "Kirlia", img: () => baseSprite(281), imgS: () => shinySprite(281) },
			{ id: 159, natiId: 282, name: "Gardevoir", img: () => baseSprite(282), imgS: () => shinySprite(282) },
			{ id: 160, natiId: 475, name: "Gallade", img: () => baseSprite(475), imgS: () => shinySprite(475) },
			{ id: 161, natiId: 108, name: "Lickitung", img: () => baseSprite(108), imgS: () => shinySprite(108) },
			{ id: 162, natiId: 463, name: "Lickilicky", img: () => baseSprite(463), imgS: () => shinySprite(463) },
			{ id: 163, natiId: 133, name: "Eevee", img: () => baseSprite(133), imgS: () => shinySprite(133) },
			{ id: 164, natiId: 134, name: "Vaporeon", img: () => baseSprite(134), imgS: () => shinySprite(134) },
			{ id: 165, natiId: 135, name: "Jolteon", img: () => baseSprite(135), imgS: () => shinySprite(135) },
			{ id: 166, natiId: 136, name: "Flareon", img: () => baseSprite(136), imgS: () => shinySprite(136) },
			{ id: 167, natiId: 196, name: "Espeon", img: () => baseSprite(196), imgS: () => shinySprite(196) },
			{ id: 168, natiId: 197, name: "Umbreon", img: () => baseSprite(197), imgS: () => shinySprite(197) },
			{ id: 169, natiId: 470, name: "Leafeon", img: () => baseSprite(470), imgS: () => shinySprite(470) },
			{ id: 170, natiId: 471, name: "Glaceon", img: () => baseSprite(471), imgS: () => shinySprite(471) },
			{ id: 171, natiId: 333, name: "Swablu", img: () => baseSprite(333), imgS: () => shinySprite(333) },
			{ id: 172, natiId: 334, name: "Altaria", img: () => baseSprite(334), imgS: () => shinySprite(334) },
			{ id: 173, natiId: 175, name: "Togepi", img: () => baseSprite(175), imgS: () => shinySprite(175) },
			{ id: 174, natiId: 176, name: "Togetic", img: () => baseSprite(176), imgS: () => shinySprite(176) },
			{ id: 175, natiId: 468, name: "Togekiss", img: () => baseSprite(468), imgS: () => shinySprite(468) },
			{ id: 176, natiId: 228, name: "Houndour", img: () => baseSprite(228), imgS: () => shinySprite(228) },
			{
				id: 177, natiId: 229, name: "Houndoom", img: () => baseSprite(229), imgS: () => shinySprite(229), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(229), imgS: () => shinySprite(229), },
					{ name: "Female", img: () => baseSprite("0229-f"), imgS: () => shinySprite("0229-f"), },
				]
			},
			{ id: 178, natiId: 81, name: "Magnemite", img: () => baseSprite(81), imgS: () => shinySprite(81) },
			{ id: 179, natiId: 82, name: "Magneton", img: () => baseSprite(82), imgS: () => shinySprite(82) },
			{ id: 180, natiId: 462, name: "Magnezone", img: () => baseSprite(462), imgS: () => shinySprite(462) },
			{ id: 181, natiId: 114, name: "Tangela", img: () => baseSprite(114), imgS: () => shinySprite(114) },
			{
				id: 182, natiId: 465, name: "Tangrowth", img: () => baseSprite(465), imgS: () => shinySprite(465), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(465), imgS: () => shinySprite(465), },
					{ name: "Female", img: () => baseSprite("0465-f"), imgS: () => shinySprite("0465-f"), },
				]
			},
			{ id: 183, natiId: 193, name: "Yanma", img: () => baseSprite(193), imgS: () => shinySprite(193) },
			{ id: 184, natiId: 469, name: "Yanmega", img: () => baseSprite(469), imgS: () => shinySprite(469) },
			{ id: 185, natiId: 357, name: "Tropius", img: () => baseSprite(357), imgS: () => shinySprite(357) },
			{
				id: 186, natiId: 111, name: "Rhyhorn", img: () => baseSprite(111), imgS: () => shinySprite(111), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(111), imgS: () => shinySprite(111), },
					{ name: "Female", img: () => baseSprite("0111-f"), imgS: () => shinySprite("0111-f"), },
				]
			},
			{
				id: 187, natiId: 112, name: "Rhydon", img: () => baseSprite(112), imgS: () => shinySprite(112), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(112), imgS: () => shinySprite(112), },
					{ name: "Female", img: () => baseSprite("0112-f"), imgS: () => shinySprite("0112-f"), },
				]
			},
			{
				id: 188, natiId: 464, name: "Rhyperior", img: () => baseSprite(464), imgS: () => shinySprite(464), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(464), imgS: () => shinySprite(464), },
					{ name: "Female", img: () => baseSprite("0464-f"), imgS: () => shinySprite("0464-f"), },
				]
			},
			{ id: 189, natiId: 355, name: "Duskull", img: () => baseSprite(355), imgS: () => shinySprite(355) },
			{ id: 190, natiId: 356, name: "Dusclops", img: () => baseSprite(356), imgS: () => shinySprite(356) },
			{ id: 191, natiId: 477, name: "Dusknoir", img: () => baseSprite(477), imgS: () => shinySprite(477) },
			{ id: 192, natiId: 137, name: "Porygon", img: () => baseSprite(137), imgS: () => shinySprite(137) },
			{ id: 193, natiId: 233, name: "Porygon2", img: () => baseSprite(233), imgS: () => shinySprite(233) },
			{ id: 194, natiId: 474, name: "Porygon-Z", img: () => baseSprite(474), imgS: () => shinySprite(474) },
			{
				id: 195, natiId: 123, name: "Scyther", img: () => baseSprite(123), imgS: () => shinySprite(123), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(123), imgS: () => shinySprite(123), },
					{ name: "Female", img: () => baseSprite("0123-f"), imgS: () => shinySprite("0123-f"), },
				]
			},
			{
				id: 196, natiId: 212, name: "Scizor", img: () => baseSprite(212), imgS: () => shinySprite(212), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(212), imgS: () => shinySprite(212), },
					{ name: "Female", img: () => baseSprite("0212-f"), imgS: () => shinySprite("0212-f"), },
				]
			},
			{ id: 197, natiId: 239, name: "Elekid", img: () => baseSprite(239), imgS: () => shinySprite(239) },
			{ id: 198, natiId: 125, name: "Electabuzz", img: () => baseSprite(125), imgS: () => shinySprite(125) },
			{ id: 199, natiId: 466, name: "Electivire", img: () => baseSprite(466), imgS: () => shinySprite(466) },
			...
			{ id: 203, natiId: 220, name: "Swinub", img: () => baseSprite(220), imgS: () => shinySprite(220) },
			{
				id: 204, natiId: 221, name: "Piloswine", img: () => baseSprite(221), imgS: () => shinySprite(221), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(221), imgS: () => shinySprite(221), },
					{ name: "Female", img: () => baseSprite("0221-f"), imgS: () => shinySprite("0221-f"), },
				]
			},
			{
				id: 205, natiId: 473, name: "Mamoswine", img: () => baseSprite(473), imgS: () => shinySprite(473), tags: ["gender"], forms: [
					{ name: "Male", img: () => baseSprite(473), imgS: () => shinySprite(473), },
					{ name: "Female", img: () => baseSprite("0473-f"), imgS: () => shinySprite("0473-f"), },
				]
			},
			{ id: 206, natiId: 361, name: "Snorunt", img: () => baseSprite(361), imgS: () => shinySprite(361) },
			{ id: 207, natiId: 362, name: "Glalie", img: () => baseSprite(362), imgS: () => shinySprite(362) },
			{ id: 208, natiId: 478, name: "Froslass", img: () => baseSprite(478), imgS: () => shinySprite(478) },
			{ id: 209, natiId: 359, name: "Absol", img: () => baseSprite(359), imgS: () => shinySprite(359) },
			{
				id: 210, natiId: 487, name: "Giratina", img: () => baseSprite(487), imgS: () => shinySprite(487), tags: ["other", "legendary"], forms: [
					{ name: "Altered", img: () => baseSprite(487), imgS: () => shinySprite(487), tags: ["legendary"] },
					{ name: "Origin", img: () => baseSprite("0487-o"), imgS: () => shinySprite("0487-o"), tags: ["legendary"] },
				]
			}
		],
	},
