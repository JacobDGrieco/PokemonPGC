...
PPGC.register({
	dex: {
		[game]: [
			{ id: 1, name: "Turtwig", img: baseSprite(387), imgS: shinySprite(387), dexSync: nationalDex(387), tags: ["starter"] },
			{ id: 2, name: "Grotle", img: baseSprite(388), imgS: shinySprite(388), dexSync: nationalDex(388), tags: ["starter"] },
			{ id: 3, name: "Torterra", img: baseSprite(389), imgS: shinySprite(389), dexSync: nationalDex(389), tags: ["starter"] },
			{ id: 4, name: "Chimchar", img: baseSprite(390), imgS: shinySprite(390), dexSync: nationalDex(390), tags: ["starter"] },
			{ id: 5, name: "Monferno", img: baseSprite(391), imgS: shinySprite(391), dexSync: nationalDex(391), tags: ["starter"] },
			{ id: 6, name: "Infernape", img: baseSprite(392), imgS: shinySprite(392), dexSync: nationalDex(392), tags: ["starter"] },
			{ id: 7, name: "Piplup", img: baseSprite(393), imgS: shinySprite(393), dexSync: nationalDex(393), tags: ["starter"] },
			{ id: 8, name: "Prinplup", img: baseSprite(394), imgS: shinySprite(394), dexSync: nationalDex(394), tags: ["starter"] },
			{ id: 9, name: "Empoleon", img: baseSprite(395), imgS: shinySprite(395), dexSync: nationalDex(395), tags: ["starter"] },
			{
				id: 10, name: "Starly", img: baseSprite(396), imgS: shinySprite(396), dexSync: nationalDex(396), tags: ["gender"], forms: [
			...
			{
				id: 11, name: "Staravia", img: baseSprite(397), imgS: shinySprite(397), dexSync: nationalDex(397), tags: ["gender"], forms: [
			...
			{
				id: 12, name: "Staraptor", img: baseSprite(398), imgS: shinySprite(398), dexSync: nationalDex(398), tags: ["gender"], forms: [
			...
			{
				id: 13, name: "Bidoof", img: baseSprite(399), imgS: shinySprite(399), dexSync: nationalDex(399), tags: ["gender"], forms: [
			...
			{
				id: 14, name: "Bibarel", img: baseSprite(400), imgS: shinySprite(400), dexSync: nationalDex(400), tags: ["gender"], forms: [
			...
			{
				id: 15, name: "Kricketot", img: baseSprite(401), imgS: shinySprite(401), dexSync: nationalDex(401), tags: ["gender"], forms: [
			...
			{
				id: 16, name: "Kricketune", img: baseSprite(402), imgS: shinySprite(402), dexSync: nationalDex(402), tags: ["gender"], forms: [
			...
			{
				id: 17, name: "Shinx", img: baseSprite(403), imgS: shinySprite(403), dexSync: nationalDex(403), tags: ["gender"], forms: [
			...
			{
				id: 18, name: "Luxio", img: baseSprite(404), imgS: shinySprite(404), dexSync: nationalDex(404), tags: ["gender"], forms: [
			...
			{
				id: 19, name: "Luxray", img: baseSprite(405), imgS: shinySprite(405), dexSync: nationalDex(405), tags: ["gender"], forms: [
			...
			{
				id: 21, name: "Kadabra", img: baseSprite(64), imgS: shinySprite(64), dexSync: nationalDex(64), tags: ["gender"], forms: [
			...
			{
				id: 22, name: "Alakazam", img: baseSprite(65), imgS: shinySprite(65), dexSync: nationalDex(65), tags: ["gender"], forms: [
			...
			{
				id: 23, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), dexSync: nationalDex(129), tags: ["gender"], forms: [
			...
			{
				id: 24, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), dexSync: nationalDex(130), tags: ["gender"], forms: [
			...
			{
				id: 26, name: "Roselia", img: baseSprite(315), imgS: shinySprite(315), dexSync: nationalDex(315), tags: ["gender"], forms: [
			...
			{
				id: 27, name: "Roserade", img: baseSprite(407), imgS: shinySprite(407), dexSync: nationalDex(407), tags: ["gender"], forms: [
			...
			{
				id: 28, name: "Zubat", img: baseSprite(41), imgS: shinySprite(41), dexSync: nationalDex(41), tags: ["gender"], forms: [
			...
			{
				id: 29, name: "Golbat", img: baseSprite(42), imgS: shinySprite(42), dexSync: nationalDex(42), tags: ["gender"], forms: [
			...
			{
				id: 35, name: "Steelix", img: baseSprite(208), imgS: shinySprite(208), dexSync: nationalDex(208), tags: ["gender"], forms: [
			...
			{ id: 36, name: "Cranidos", img: baseSprite(408), imgS: shinySprite(408), dexSync: nationalDex(408), tags: ["fossil"] },
			{ id: 37, name: "Rampardos", img: baseSprite(409), imgS: shinySprite(409), dexSync: nationalDex(409), tags: ["fossil"] },
			{ id: 38, name: "Shieldon", img: baseSprite(410), imgS: shinySprite(410), dexSync: nationalDex(410), tags: ["fossil"] },
			{ id: 39, name: "Bastiodon", img: baseSprite(411), imgS: shinySprite(411), dexSync: nationalDex(411), tags: ["fossil"] },
			...
			{
				id: 45, name: "Burmy", img: baseSprite(412), imgS: shinySprite(412), dexSync: nationalDex(412), tags: ["other"], forms: [
			...
			{
				id: 46, name: "Wormadam", img: baseSprite(413), imgS: shinySprite(413), dexSync: nationalDex(413), tags: ["other"], forms: [
			...
			{
				id: 50, name: "Beautifly", img: baseSprite(267), imgS: shinySprite(267), dexSync: nationalDex(267), tags: ["gender"], forms: [
			...
			{
				id: 52, name: "Dustox", img: baseSprite(269), imgS: shinySprite(269), dexSync: nationalDex(269), tags: ["gender"], forms: [
			...
			{
				id: 53, name: "Combee", img: baseSprite(415), imgS: shinySprite(415), dexSync: nationalDex(415), tags: ["gender"], forms: [
			...
			{
				id: 55, name: "Pachirisu", img: baseSprite(417), imgS: shinySprite(417), dexSync: nationalDex(417), tags: ["gender"], forms: [
			...
			{
				id: 56, name: "Buizel", img: baseSprite(418), imgS: shinySprite(418), dexSync: nationalDex(418), tags: ["gender"], forms: [
			...
			{
				id: 57, name: "Floatzel", img: baseSprite(419), imgS: shinySprite(419), dexSync: nationalDex(419), tags: ["gender"], forms: [
			...
			{
				id: 59, name: "Cherrim", img: baseSprite(421), imgS: shinySprite(421), dexSync: nationalDex(421), tags: ["other"], forms: [
					{ name: "Overcast", img: baseSprite(421), imgS: shinySprite(421), dexSync: nationalDex(421, "Overcast") },
					{ name: "Sunshine", img: baseSprite("421-s"), imgS: shinySprite("421-s"), dexSync: nationalDex(421, "Sunshine") },
				]
			},
			{
				id: 60, name: "Shellos", img: baseSprite(422), imgS: shinySprite(422), dexSync: nationalDex(422), tags: ["other"], forms: [
					{ name: "West Sea", img: baseSprite(422), imgS: shinySprite(422), dexSync: nationalDex(422, "West Sea") },
					{ name: "East Sea", img: baseSprite("422-e"), imgS: shinySprite("422-e"), dexSync: nationalDex(422, "East Sea") },]
			},
			{
				id: 61, name: "Gastrodon", img: baseSprite(423), imgS: shinySprite(423), dexSync: nationalDex(423), tags: ["other"], forms: [
					{ name: "West Sea", img: baseSprite(423), imgS: shinySprite(423), dexSync: nationalDex(423, "West Sea") },
					{ name: "East Sea", img: baseSprite("423-e"), imgS: shinySprite("423-e"), dexSync: nationalDex(423, "East Sea") },]
			},
			{
				id: 62, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), dexSync: nationalDex(214), tags: ["gender"], forms: [
			...
			{
				id: 63, name: "Aipom", img: baseSprite(190), imgS: shinySprite(190), dexSync: nationalDex(190), tags: ["gender"], forms: [
			...
			{
				id: 64, name: "Ambipom", img: baseSprite(424), imgS: shinySprite(424), dexSync: nationalDex(424), tags: ["gender"], forms: [
			...
			{
				id: 74, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), dexSync: nationalDex(198), tags: ["gender"], forms: [
			...
			{
				id: 78, name: "Goldeen", img: baseSprite(118), imgS: shinySprite(118), dexSync: nationalDex(118), tags: ["gender"], forms: [
			...
			{
				id: 79, name: "Seaking", img: baseSprite(119), imgS: shinySprite(119), dexSync: nationalDex(119), tags: ["gender"], forms: [
			...
			{
				id: 86, name: "Meditite", img: baseSprite(307), imgS: shinySprite(307), dexSync: nationalDex(307), tags: ["gender"], forms: [
			...
			{
				id: 87, name: "Medicham", img: baseSprite(308), imgS: shinySprite(308), dexSync: nationalDex(308), tags: ["gender"], forms: [
			...
			{
				id: 93, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), dexSync: nationalDex(185), tags: ["gender"], forms: [
			...
			{
				id: 104, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), dexSync: nationalDex(25), tags: ["gender"], forms: [
			...
			{
				id: 105, name: "Raichu", img: baseSprite(26), imgS: shinySprite(26), dexSync: nationalDex(26), tags: ["gender"], forms: [
			...
			{
				id: 109, name: "Gible", img: baseSprite(443), imgS: shinySprite(443), dexSync: nationalDex(443), tags: ["gender", "pseudo"], forms: [
			...
			{
				id: 110, name: "Gabite", img: baseSprite(444), imgS: shinySprite(444), dexSync: nationalDex(444), tags: ["gender", "pseudo"], forms: [
			...
			{
				id: 111, name: "Garchomp", img: baseSprite(445), imgS: shinySprite(445), dexSync: nationalDex(445), tags: ["gender", "pseudo"], forms: [
			...
			{
				id: 114, name: "Unown", img: baseSprite(201), imgS: shinySprite(201), dexSync: nationalDex(201), tags: ["other"], forms: [
			...
			{
				id: 117, name: "Wooper", img: baseSprite(194), imgS: shinySprite(194), dexSync: nationalDex(194), tags: ["gender"], forms: [
			...
			{
				id: 118, name: "Quagsire", img: baseSprite(195), imgS: shinySprite(195), dexSync: nationalDex(195), tags: ["gender"], forms: [
			...
			{
				id: 121, name: "Girafarig", img: baseSprite(203), imgS: shinySprite(203), dexSync: nationalDex(203), tags: ["gender"], forms: [
			...
			{
				id: 122, name: "Hippopotas", img: baseSprite(449), imgS: shinySprite(449), dexSync: nationalDex(449), tags: ["gender"], forms: [
			...
			{
				id: 123, name: "Hippowdon", img: baseSprite(450), imgS: shinySprite(450), dexSync: nationalDex(450), tags: ["gender"], forms: [
			...
			{
				id: 129, name: "Croagunk", img: baseSprite(453), imgS: shinySprite(453), dexSync: nationalDex(453), tags: ["gender"], forms: [
			...
			{
				id: 130, name: "Toxicroak", img: baseSprite(454), imgS: shinySprite(454), dexSync: nationalDex(454), tags: ["gender"], forms: [
			...
			{
				id: 133, name: "Octillery", img: baseSprite(224), imgS: shinySprite(224), dexSync: nationalDex(224), tags: ["gender"], forms: [
			...
			{
				id: 134, name: "Finneon", img: baseSprite(456), imgS: shinySprite(456), dexSync: nationalDex(456), tags: ["gender"], forms: [
			...
			{
				id: 135, name: "Lumineon", img: baseSprite(457), imgS: shinySprite(457), dexSync: nationalDex(457), tags: ["gender"], forms: [
			...
			{
				id: 139, name: "Milotic", img: baseSprite(350), imgS: shinySprite(350), dexSync: nationalDex(350), tags: ["gender"], forms: [
			...
			{
				id: 142, name: "Snover", img: baseSprite(459), imgS: shinySprite(459), dexSync: nationalDex(459), tags: ["gender"], forms: [
			...
			{
				id: 143, name: "Abomasnow", img: baseSprite(460), imgS: shinySprite(460), dexSync: nationalDex(460), tags: ["gender"], forms: [
			...
			{
				id: 144, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), dexSync: nationalDex(215), tags: ["gender"], forms: [
			...
			{
				id: 145, name: "Weavile", img: baseSprite(461), imgS: shinySprite(461), dexSync: nationalDex(461), tags: ["gender"], forms: [
			...
			{ id: 146, name: "Uxie", img: baseSprite(480), imgS: shinySprite(480), dexSync: nationalDex(480) },
			{ id: 147, name: "Mesprit", img: baseSprite(481), imgS: shinySprite(481), dexSync: nationalDex(481) },
			{ id: 148, name: "Azelf", img: baseSprite(482), imgS: shinySprite(482), dexSync: nationalDex(482) },
			{ id: 149, name: "Dialga", img: baseSprite(483), imgS: shinySprite(483), dexSync: nationalDex(483), tags: ["legendary"] },
			{ id: 150, name: "Palkia", img: baseSprite(484), imgS: shinySprite(484), dexSync: nationalDex(484), tags: ["legendary"] },
			{ id: 151, name: "Manaphy", img: baseSprite(490), imgS: shinySprite(490), dexSync: nationalDex(490), tags: ["mythical"] },
			{
				id: 152, name: "Rotom", img: baseSprite(479), imgS: shinySprite(479), dexSync: nationalDex(479), tags: ["other"], forms: [
			...
			{
				id: 153, name: "Gligar", img: baseSprite(207), imgS: shinySprite(207), dexSync: nationalDex(207), tags: ["gender"], forms: [
			...
			{ id: 154, name: "Gliscor", img: baseSprite(472), imgS: shinySprite(472), dexSync: nationalDex(472) },
			{ id: 155, name: "Nosepass", img: baseSprite(299), imgS: shinySprite(299), dexSync: nationalDex(299) },
			{ id: 156, name: "Probopass", img: baseSprite(476), imgS: shinySprite(476), dexSync: nationalDex(476) },
			{ id: 157, name: "Ralts", img: baseSprite(280), imgS: shinySprite(280), dexSync: nationalDex(280) },
			{ id: 158, name: "Kirlia", img: baseSprite(281), imgS: shinySprite(281), dexSync: nationalDex(281) },
			{ id: 159, name: "Gardevoir", img: baseSprite(282), imgS: shinySprite(282), dexSync: nationalDex(282) },
			{ id: 160, name: "Gallade", img: baseSprite(475), imgS: shinySprite(475), dexSync: nationalDex(475) },
			{ id: 161, name: "Lickitung", img: baseSprite(108), imgS: shinySprite(108), dexSync: nationalDex(108) },
			{ id: 162, name: "Lickilicky", img: baseSprite(463), imgS: shinySprite(463), dexSync: nationalDex(463) },
			{ id: 163, name: "Eevee", img: baseSprite(133), imgS: shinySprite(133), dexSync: nationalDex(133) },
			{ id: 164, name: "Vaporeon", img: baseSprite(134), imgS: shinySprite(134), dexSync: nationalDex(134) },
			{ id: 165, name: "Jolteon", img: baseSprite(135), imgS: shinySprite(135), dexSync: nationalDex(135) },
			{ id: 166, name: "Flareon", img: baseSprite(136), imgS: shinySprite(136), dexSync: nationalDex(136) },
			{ id: 167, name: "Espeon", img: baseSprite(196), imgS: shinySprite(196), dexSync: nationalDex(196) },
			{ id: 168, name: "Umbreon", img: baseSprite(197), imgS: shinySprite(197), dexSync: nationalDex(197) },
			{ id: 169, name: "Leafeon", img: baseSprite(470), imgS: shinySprite(470), dexSync: nationalDex(470) },
			{ id: 170, name: "Glaceon", img: baseSprite(471), imgS: shinySprite(471), dexSync: nationalDex(471) },
			{ id: 171, name: "Swablu", img: baseSprite(333), imgS: shinySprite(333), dexSync: nationalDex(333) },
			{ id: 172, name: "Altaria", img: baseSprite(334), imgS: shinySprite(334), dexSync: nationalDex(334) },
			{ id: 173, name: "Togepi", img: baseSprite(175), imgS: shinySprite(175), dexSync: nationalDex(175) },
			{ id: 174, name: "Togetic", img: baseSprite(176), imgS: shinySprite(176), dexSync: nationalDex(176) },
			{ id: 175, name: "Togekiss", img: baseSprite(468), imgS: shinySprite(468), dexSync: nationalDex(468) },
			{ id: 176, name: "Houndour", img: baseSprite(228), imgS: shinySprite(228), dexSync: nationalDex(228) },
			{
				id: 177, name: "Houndoom", img: baseSprite(229), imgS: shinySprite(229), dexSync: nationalDex(229), tags: ["gender"], forms: [
			...
			{ id: 178, name: "Magnemite", img: baseSprite(81), imgS: shinySprite(81), dexSync: nationalDex(81) },
			{ id: 179, name: "Magneton", img: baseSprite(82), imgS: shinySprite(82), dexSync: nationalDex(82) },
			{ id: 180, name: "Magnezone", img: baseSprite(462), imgS: shinySprite(462), dexSync: nationalDex(462) },
			{ id: 181, name: "Tangela", img: baseSprite(114), imgS: shinySprite(114), dexSync: nationalDex(114) },
			{
				id: 182, name: "Tangrowth", img: baseSprite(465), imgS: shinySprite(465), dexSync: nationalDex(465), tags: ["gender"], forms: [
			...
			{ id: 183, name: "Yanma", img: baseSprite(193), imgS: shinySprite(193), dexSync: nationalDex(193) },
			{ id: 184, name: "Yanmega", img: baseSprite(469), imgS: shinySprite(469), dexSync: nationalDex(469) },
			{ id: 185, name: "Tropius", img: baseSprite(357), imgS: shinySprite(357), dexSync: nationalDex(357) },
			{
				id: 186, name: "Rhyhorn", img: baseSprite(111), imgS: shinySprite(111), dexSync: nationalDex(111), tags: ["gender"], forms: [
			...
			{
				id: 187, name: "Rhydon", img: baseSprite(112), imgS: shinySprite(112), dexSync: nationalDex(112), tags: ["gender"], forms: [
			...
			{
				id: 188, name: "Rhyperior", img: baseSprite(464), imgS: shinySprite(464), dexSync: nationalDex(464), tags: ["gender"], forms: [
			...
			{ id: 189, name: "Duskull", img: baseSprite(355), imgS: shinySprite(355), dexSync: nationalDex(355) },
			{ id: 190, name: "Dusclops", img: baseSprite(356), imgS: shinySprite(356), dexSync: nationalDex(356) },
			{ id: 191, name: "Dusknoir", img: baseSprite(477), imgS: shinySprite(477), dexSync: nationalDex(477) },
			{ id: 192, name: "Porygon", img: baseSprite(137), imgS: shinySprite(137), dexSync: nationalDex(137) },
			{ id: 193, name: "Porygon2", img: baseSprite(233), imgS: shinySprite(233), dexSync: nationalDex(233) },
			{ id: 194, name: "Porygon-Z", img: baseSprite(474), imgS: shinySprite(474), dexSync: nationalDex(474) },
			{
				id: 195, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), dexSync: nationalDex(123), tags: ["gender"], forms: [
			...
			{
				id: 196, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), dexSync: nationalDex(212), tags: ["gender"], forms: [
			...
			{ id: 197, name: "Elekid", img: baseSprite(239), imgS: shinySprite(239), dexSync: nationalDex(239) },
			{ id: 198, name: "Electabuzz", img: baseSprite(125), imgS: shinySprite(125), dexSync: nationalDex(125) },
			{ id: 199, name: "Electivire", img: baseSprite(466), imgS: shinySprite(466), dexSync: nationalDex(466) },
			{ id: 200, name: "Magby", img: baseSprite(240), imgS: shinySprite(240), dexSync: nationalDex(240) },
			{ id: 201, name: "Magmar", img: baseSprite(126), imgS: shinySprite(126), dexSync: nationalDex(126) },
			{ id: 202, name: "Magmortar", img: baseSprite(467), imgS: shinySprite(467), dexSync: nationalDex(467) },
			{ id: 203, name: "Swinub", img: baseSprite(220), imgS: shinySprite(220), dexSync: nationalDex(220) },
			{
				id: 204, name: "Piloswine", img: baseSprite(221), imgS: shinySprite(221), dexSync: nationalDex(221), tags: ["gender"], forms: [
			...
			{
				id: 205, name: "Mamoswine", img: baseSprite(473), imgS: shinySprite(473), dexSync: nationalDex(473), tags: ["gender"], forms: [
			...
			{ id: 206, name: "Snorunt", img: baseSprite(361), imgS: shinySprite(361), dexSync: nationalDex(361) },
			{ id: 207, name: "Glalie", img: baseSprite(362), imgS: shinySprite(362), dexSync: nationalDex(362) },
			{ id: 208, name: "Froslass", img: baseSprite(478), imgS: shinySprite(478), dexSync: nationalDex(478) },
			{ id: 209, name: "Absol", img: baseSprite(359), imgS: shinySprite(359), dexSync: nationalDex(359) },
			{
				id: 210, name: "Giratina", img: baseSprite(487), imgS: shinySprite(487), dexSync: nationalDex(487), tags: ["other", "legendary"], forms: [
					{ name: "Altered", img: baseSprite(487), imgS: shinySprite(487), dexSync: nationalDex(487, "Altered"), tags: ["legendary"] },
					{ name: "Origin", img: baseSprite("487-o"), imgS: shinySprite("487-o"), dexSync: nationalDex(487, "Origin"), tags: ["legendary"] },
				]
			}
		],
	},
