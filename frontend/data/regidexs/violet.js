...
PPGC.register({
	dex: {
		[sub]: [
			{ id: 1, natiId: 906, name: "Sprigatito", img: baseSprite(906), imgS: shinySprite(906), },
			{ id: 2, natiId: 907, name: "Floragato", img: baseSprite(907), imgS: shinySprite(907), },
			{ id: 3, natiId: 908, name: "Meowscarada", img: baseSprite(908), imgS: shinySprite(908), },
			{ id: 4, natiId: 909, name: "Fuecoco", img: baseSprite(909), imgS: shinySprite(909), },
			{ id: 5, natiId: 910, name: "Crocalor", img: baseSprite(910), imgS: shinySprite(910), },
			{ id: 6, natiId: 911, name: "Skeledirge", img: baseSprite(911), imgS: shinySprite(911), },
			{ id: 7, natiId: 912, name: "Quaxly", img: baseSprite(912), imgS: shinySprite(912), },
			{ id: 8, natiId: 913, name: "Quaxwell", img: baseSprite(913), imgS: shinySprite(913), },
			{ id: 9, natiId: 914, name: "Quaquaval", img: baseSprite(914), imgS: shinySprite(914), },
			{ id: 10, natiId: 915, name: "Lechonk", img: baseSprite(915), imgS: shinySprite(915), },
			{
				id: 11, natiId: 916, name: "Oinkologne", img: baseSprite(916), imgS: shinySprite(916), forms: [
			...
			{
				id: 26, natiId: 229, name: "Houndoom", img: baseSprite(229), imgS: shinySprite(229), forms: [
			...
			{
				id: 33, natiId: 401, name: "Kricketot", img: baseSprite(401), imgS: shinySprite(401), forms: [
					{ name: "Male", img: baseSprite(401), imgS: shinySprite(401), },
					{ name: "Female", img: baseSprite("401-f"), imgS: shinySprite("401-f"), }
				],
			},
			{
				id: 34, natiId: 402, name: "Kricketune", img: baseSprite(402), imgS: shinySprite(402), forms: [
			...
			{
				id: 37, natiId: 666, name: "Vivillon", img: baseSprite(666), imgS: shinySprite(666), forms: [
			...
			{
				id: 38, natiId: 415, name: "Combee", img: baseSprite(415), imgS: shinySprite(415), forms: [
			...
			{
				id: 51, natiId: 418, name: "Buizel", img: baseSprite(418), imgS: shinySprite(418), forms: [
					{ name: "Male", img: baseSprite(418), imgS: shinySprite(418), },
					{ name: "Female", img: baseSprite("418-f"), imgS: shinySprite("418-f"), }
				],
			},
			{
				id: 52, natiId: 419, name: "Floatzel", img: baseSprite(419), imgS: shinySprite(419), forms: [
					{ name: "Male", img: baseSprite(419), imgS: shinySprite(419), },
					{ name: "Female", img: baseSprite("419-f"), imgS: shinySprite("419-f"), }
				],
			},
			{
				id: 53, natiId: 194, name: "Wooper", img: baseSprite("194-p"), imgS: shinySprite("194-p"), forms: [
					...
					{ name: "Paldean", img: baseSprite("194-p"), imgS: shinySprite("194-p"), }
				],
			},
			...
			{
				id: 72, natiId: 925, name: "Maushold", img: baseSprite(925), imgS: shinySprite(925), forms: [
			...
			{
				id: 74, natiId: 25, name: "Pikachu", img: baseSprite(25), imgS: shinySprite(25), forms: [
					{ name: "Male", img: baseSprite(25), imgS: shinySprite(25), },
					{ name: "Female", img: baseSprite("025-f"), imgS: shinySprite("025-f"), },
					{ name: "Alola Cap", img: baseSprite("025-a"), imgS: shinySprite("025-a"), },
					{ name: "Hoenn Cap", img: baseSprite("025-h"), imgS: shinySprite("025-h"), },
					{ name: "Kalos Cap", img: baseSprite("025-k"), imgS: shinySprite("025-k"), },
					{ name: "Original Cap", img: baseSprite("025-o"), imgS: shinySprite("025-o"), },
					{ name: "Partner Cap", img: baseSprite("025-p"), imgS: shinySprite("025-p"), },
					{ name: "Sinnoh Cap", img: baseSprite("025-s"), imgS: shinySprite("025-s"), },
					{ name: "Unova Cap", img: baseSprite("025-u"), imgS: shinySprite("025-u"), },
					{ name: "World Cap", img: baseSprite("025-w"), imgS: shinySprite("025-w"), }
				],
			},
			{
				id: 75, natiId: 26, name: "Raichu", img: baseSprite(26), imgS: shinySprite(26), forms: [
			...
			{
				id: 88, natiId: 185, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), forms: [
			...
			{
				id: 90, natiId: 745, name: "Lycanroc", img: baseSprite(745), imgS: shinySprite(745), forms: [
			...
			{
				id: 113, natiId: 931, name: "Squawkabilly", img: baseSprite(931), imgS: shinySprite(931), forms: [
			...
			{
				id: 123, natiId: 232, name: "Donphan", img: baseSprite(232), imgS: shinySprite(232), forms: [
			...
			{
				id: 126, natiId: 443, name: "Gible", img: baseSprite(443), imgS: shinySprite(443), forms: [
					{ name: "Male", img: baseSprite(443), imgS: shinySprite(443), },
					{ name: "Female", img: baseSprite("443-f"), imgS: shinySprite("443-f"), }
				],
			},
			{
				id: 127, natiId: 444, name: "Gabite", img: baseSprite(444), imgS: shinySprite(444), forms: [
					{ name: "Male", img: baseSprite(444), imgS: shinySprite(444), },
					{ name: "Female", img: baseSprite("444-f"), imgS: shinySprite("444-f"), }
				],
			},
			{
				id: 128, natiId: 445, name: "Garchomp", img: baseSprite(445), imgS: shinySprite(445), forms: [
			...
			{
				id: 134, natiId: 129, name: "Magikarp", img: baseSprite(129), imgS: shinySprite(129), forms: [
					{ name: "Male", img: baseSprite(129), imgS: shinySprite(129), },
					{ name: "Female", img: baseSprite("129-f"), imgS: shinySprite("129-f"), }
				],
			},
			{
				id: 135, natiId: 130, name: "Gyarados", img: baseSprite(130), imgS: shinySprite(130), forms: [
			...
			{
				id: 138, natiId: 550, name: "Basculin", img: baseSprite(550), imgS: shinySprite(550), forms: [
			...
			{
				id: 139, natiId: 316, name: "Gulpin", img: baseSprite(316), imgS: shinySprite(316), forms: [
					{ name: "Male", img: baseSprite(316), imgS: shinySprite(316), },
					{ name: "Female", img: baseSprite("316-f"), imgS: shinySprite("316-f"), }
				],
			},
			{
				id: 140, natiId: 317, name: "Swalot", img: baseSprite(317), imgS: shinySprite(317), forms: [
					{ name: "Male", img: baseSprite(317), imgS: shinySprite(317), },
					{ name: "Female", img: baseSprite("317-f"), imgS: shinySprite("317-f"), }
				],
			},
			{
				id: 141, natiId: 52, name: "Meowth", img: baseSprite(52), imgS: shinySprite(52), forms: [
			...
			{
				id: 145, natiId: 669, name: "Flabébé", img: baseSprite(669), imgS: shinySprite(669), forms: [
			...
			{
				id: 146, natiId: 670, name: "Floette", img: baseSprite(670), imgS: shinySprite(670), forms: [
			...
			{
				id: 147, natiId: 671, name: "Florges", img: baseSprite(671), imgS: shinySprite(671), forms: [
			...
			{
				id: 151, natiId: 322, name: "Numel", img: baseSprite(322), imgS: shinySprite(322), forms: [
					{ name: "Male", img: baseSprite(322), imgS: shinySprite(322), },
					{ name: "Female", img: baseSprite("322-f"), imgS: shinySprite("322-f"), }
				],
			},
			{
				id: 152, natiId: 323, name: "Camerupt", img: baseSprite(323), imgS: shinySprite(323), forms: [
			...
			{
				id: 161, natiId: 307, name: "Meditite", img: baseSprite(307), imgS: shinySprite(307), forms: [
					{ name: "Male", img: baseSprite(307), imgS: shinySprite(307), },
					{ name: "Female", img: baseSprite("307-f"), imgS: shinySprite("307-f"), }
				],
			},
			{
				id: 162, natiId: 308, name: "Medicham", img: baseSprite(308), imgS: shinySprite(308), forms: [
			...
			{ id: 172, natiId: 704, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), },
			{
				id: 173, natiId: 705, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), forms: [
					{ name: "Kalosian", img: baseSprite(705), imgS: shinySprite(705), },
					{ name: "Hisuian", img: baseSprite("705-h"), imgS: shinySprite("705-h"), }
				],
			},
			{
				id: 174, natiId: 706, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), forms: [
					{ name: "Kalosian", img: baseSprite(706), imgS: shinySprite(706), },
					{ name: "Hisuian", img: baseSprite("706-h"), imgS: shinySprite("706-h"), }
				],
			},
			{
				id: 175, natiId: 453, name: "Croagunk", img: baseSprite(453), imgS: shinySprite(453), forms: [
					{ name: "Male", img: baseSprite(453), imgS: shinySprite(453), },
					{ name: "Female", img: baseSprite("453-f"), imgS: shinySprite("453-f"), }
				],
			},
			{
				id: 176, natiId: 454, name: "Toxicroak", img: baseSprite(454), imgS: shinySprite(454), forms: [
			...
			{
				id: 179, natiId: 133, name: "Eevee", img: baseSprite(133), imgS: shinySprite(133), forms: [
			...
			{
				id: 189, natiId: 982, name: "Dudunsparce", img: baseSprite(982), imgS: shinySprite(982), forms: [
					{ name: "Three-Segment", img: baseSprite(982), imgS: shinySprite(982), },
					{ name: "Two-Segment", img: baseSprite("982-2"), imgS: shinySprite("982-2"), }
				],
			},
			{
				id: 190, natiId: 585, name: "Deerling", img: baseSprite(585), imgS: shinySprite(585), forms: [
			...
			{
				id: 191, natiId: 586, name: "Sawsbuck", img: baseSprite(586), imgS: shinySprite(586), forms: [
			...
			{
				id: 192, natiId: 203, name: "Girafarig", img: baseSprite(203), imgS: shinySprite(203), forms: [
			...
			{
				id: 199, natiId: 849, name: "Toxtricity", img: baseSprite(849), imgS: shinySprite(849), forms: [
			...
			{
				id: 201, natiId: 417, name: "Pachirisu", img: baseSprite(417), imgS: shinySprite(417), forms: [
			...
			{
				id: 216, natiId: 217, name: "Ursaring", img: baseSprite(217), imgS: shinySprite(217), forms: [
			...
			{
				id: 225, natiId: 668, name: "Pyroar", img: baseSprite(668), imgS: shinySprite(668), forms: [
			...
			{
				id: 230, natiId: 215, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), forms: [
			...
			{
				id: 231, natiId: 461, name: "Weavile", img: baseSprite(461), imgS: shinySprite(461), forms: [
					{ name: "Male", img: baseSprite(461), imgS: shinySprite(461), },
					{ name: "Female", img: baseSprite("461-f"), imgS: shinySprite("461-f"), }
				],
			},
			{
				id: 232, natiId: 198, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), forms: [
			...
			{
				id: 237, natiId: 854, name: "Sinistea", img: baseSprite(854), imgS: shinySprite(854), forms: [
					{ name: "Phony", img: baseSprite(854), imgS: shinySprite(854), },
					{ name: "Authentic", img: baseSprite("854-a"), imgS: shinySprite("854-a"), },]
			},
			{
				id: 238, natiId: 855, name: "Polteageist", img: baseSprite(855), imgS: shinySprite(855), forms: [
			...
			{
				id: 241, natiId: 876, name: "Indeedee", img: baseSprite(876), imgS: shinySprite(876), forms: [
			...
			{
				id: 253, natiId: 332, name: "Cacturne", img: baseSprite(332), imgS: shinySprite(332), forms: [
			...
			{
				id: 260, natiId: 123, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), forms: [
					{ name: "Male", img: baseSprite(123), imgS: shinySprite(123), },
					{ name: "Female", img: baseSprite("123-f"), imgS: shinySprite("123-f"), }
				],
			},
			{
				id: 261, natiId: 212, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), forms: [
					{ name: "Male", img: baseSprite(212), imgS: shinySprite(212), },
					{ name: "Female", img: baseSprite("212-f"), imgS: shinySprite("212-f"), },],
			},
			{
				id: 262, natiId: 214, name: "Heracross", img: baseSprite(214), imgS: shinySprite(214), forms: [
			...
			{
				id: 265, natiId: 449, name: "Hippopotas", img: baseSprite(449), imgS: shinySprite(449), forms: [
					{ name: "Male", img: baseSprite(449), imgS: shinySprite(449), },
					{ name: "Female", img: baseSprite("449-f"), imgS: shinySprite("449-f"), }
				],
			},
			{
				id: 266, natiId: 450, name: "Hippowdon", img: baseSprite(450), imgS: shinySprite(450), forms: [
			...
			{ id: 276, natiId: 371, name: "Bagon", img: baseSprite(371), imgS: shinySprite(371), },
			{ id: 277, natiId: 372, name: "Shelgon", img: baseSprite(372), imgS: shinySprite(372), },
			{ id: 278, natiId: 373, name: "Salamence", img: baseSprite(373), imgS: shinySprite(373), },
			...
			{ id: 305, natiId: 885, name: "Dreepy", img: baseSprite(885), imgS: shinySprite(885), },
			{ id: 306, natiId: 886, name: "Drakloak", img: baseSprite(886), imgS: shinySprite(886), },
			{ id: 307, natiId: 887, name: "Dragapult", img: baseSprite(887), imgS: shinySprite(887), },
			...
			{
				id: 310, natiId: 479, name: "Rotom", img: baseSprite(479), imgS: shinySprite(479), forms: [
			...
			{ id: 316, natiId: 246, name: "Larvitar", img: baseSprite(246), imgS: shinySprite(246), },
			{ id: 317, natiId: 247, name: "Pupitar", img: baseSprite(247), imgS: shinySprite(247), },
			{ id: 318, natiId: 248, name: "Tyranitar", img: baseSprite(248), imgS: shinySprite(248), },
			...
			{
				id: 327, natiId: 422, name: "Shellos", img: baseSprite(422), imgS: shinySprite(422), forms: [
					{ name: "West Sea", img: baseSprite(422), imgS: shinySprite(422), },
					{ name: "East Sea", img: baseSprite("422-e"), imgS: shinySprite("422-e"), },],
			},
			{
				id: 328, natiId: 423, name: "Gastrodon", img: baseSprite(423), imgS: shinySprite(423), forms: [
			...
			{
				id: 333, natiId: 456, name: "Finneon", img: baseSprite(456), imgS: shinySprite(456), forms: [
					{ name: "Male", img: baseSprite(456), imgS: shinySprite(456), },
					{ name: "Female", img: baseSprite("456-f"), imgS: shinySprite("456-f"), }
				],
			},
			{
				id: 334, natiId: 457, name: "Lumineon", img: baseSprite(457), imgS: shinySprite(457), forms: [
			...
			{ id: 347, natiId: 147, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), },
			{ id: 348, natiId: 148, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), },
			{ id: 349, natiId: 149, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), },
			...
			{
				id: 352, natiId: 459, name: "Snover", img: baseSprite(459), imgS: shinySprite(459), forms: [
					{ name: "Male", img: baseSprite(459), imgS: shinySprite(459), },
					{ name: "Female", img: baseSprite("459-f"), imgS: shinySprite("459-f"), }
				],
			},
			{
				id: 353, natiId: 460, name: "Abomasnow", img: baseSprite(460), imgS: shinySprite(460), forms: [
			...
			{ id: 370, natiId: 633, name: "Deino", img: baseSprite(633), imgS: shinySprite(633), },
			{ id: 371, natiId: 634, name: "Zweilous", img: baseSprite(634), imgS: shinySprite(634), },
			{ id: 372, natiId: 635, name: "Hydreigon", img: baseSprite(635), imgS: shinySprite(635), },
			...
			{
				id: 375, natiId: 978, name: "Tatsugiri", img: baseSprite(978), imgS: shinySprite(978), forms: [
			...
			{ id: 376, natiId: 984, name: "Great Tusk", img: baseSprite(984), imgS: shinySprite(984), },
			{ id: 377, natiId: 985, name: "Scream Tail", img: baseSprite(985), imgS: shinySprite(985), },
			{ id: 378, natiId: 986, name: "Brute Bonnet", img: baseSprite(986), imgS: shinySprite(986), },
			{ id: 379, natiId: 987, name: "Flutter Mane", img: baseSprite(987), imgS: shinySprite(987), },
			{ id: 380, natiId: 988, name: "Slither Wing", img: baseSprite(988), imgS: shinySprite(988), },
			{ id: 381, natiId: 989, name: "Sandy Shocks", img: baseSprite(989), imgS: shinySprite(989), },
			{ id: 382, natiId: 990, name: "Iron Treads", img: baseSprite(990), imgS: shinySprite(990), },
			{ id: 383, natiId: 991, name: "Iron Bundle", img: baseSprite(991), imgS: shinySprite(991), },
			{ id: 384, natiId: 992, name: "Iron Hands", img: baseSprite(992), imgS: shinySprite(992), },
			{ id: 385, natiId: 993, name: "Iron Jugulis", img: baseSprite(993), imgS: shinySprite(993), },
			{ id: 386, natiId: 994, name: "Iron Moth", img: baseSprite(994), imgS: shinySprite(994), },
			{ id: 387, natiId: 995, name: "Iron Thorns", img: baseSprite(995), imgS: shinySprite(995), },
			{ id: 388, natiId: 996, name: "Frigibax", img: baseSprite(996), imgS: shinySprite(996), },
			{ id: 389, natiId: 997, name: "Arctibax", img: baseSprite(997), imgS: shinySprite(997), },
			{ id: 390, natiId: 998, name: "Baxcalibur", img: baseSprite(998), imgS: shinySprite(998), },
			{
				id: 391, natiId: 999, name: "Gimmighoul", img: baseSprite(999), imgS: shinySprite(999), forms: [
			...
			{ id: 393, natiId: 1001, name: "Wo-Chien", img: baseSprite(1001), imgS: shinySprite(1001), legendary: true, },
			{ id: 394, natiId: 1002, name: "Chien-Pao", img: baseSprite(1002), imgS: shinySprite(1002), legendary: true, },
			{ id: 395, natiId: 1003, name: "Ting-Lu", img: baseSprite(1003), imgS: shinySprite(1003), legendary: true, },
			{ id: 396, natiId: 1004, name: "Chi-Yu", img: baseSprite(1004), imgS: shinySprite(1004), legendary: true, },
			{ id: 397, natiId: 1005, name: "Roaring Moon", img: baseSprite(1005), imgS: shinySprite(1005), },
			{ id: 398, natiId: 1006, name: "Iron Valiant", img: baseSprite(1006), imgS: shinySprite(1006), },
			{ id: 399, natiId: 1007, name: "Koraidon", img: baseSprite(1007), imgS: shinySprite(1007), legendary: true, },
			{ id: 400, natiId: 1008, name: "Miraidon", img: baseSprite(1008), imgS: shinySprite(1008), legendary: true, }
		],
	},
});