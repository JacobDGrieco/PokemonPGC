...
PPGC.register({
	dex: {
		[sub]: [
			...
			{
				id: 6, name: "Gible", img: baseSprite(443), imgS: shinySprite(443), dexSync: nationalDex(443), tags: ["gender", "pseudo"], forms: [
			...
			{
				id: 7, name: "Gabite", img: baseSprite(444), imgS: shinySprite(444), dexSync: nationalDex(444), tags: ["gender", "pseudo"], forms: [
			...
			{
				id: 8, name: "Garchomp", img: baseSprite(445), imgS: shinySprite(445), dexSync: nationalDex(445), tags: ["gender", "pseudo", "mega"], forms: [
			...
			{
				id: 17, name: "Wooper", img: baseSprite(194), imgS: shinySprite(194), dexSync: nationalDex(194), tags: ["gender"], forms: [
			...
			{
				id: 18, name: "Quagsire", img: baseSprite(195), imgS: shinySprite(195), dexSync: nationalDex(195), tags: ["gender"], forms: [
			...
			{ id: 19, name: "Goomy", img: baseSprite(704), imgS: shinySprite(704), dexSync: nationalDex(704), tags: ["pseudo"] },
			{ id: 20, name: "Sliggoo", img: baseSprite(705), imgS: shinySprite(705), dexSync: nationalDex(705), tags: ["pseudo"] },
			{ id: 21, name: "Goodra", img: baseSprite(706), imgS: shinySprite(706), dexSync: nationalDex(706), tags: ["pseudo"] },
			...
			{ id: 32, name: "Gengar", img: baseSprite(94), imgS: shinySprite(94), dexSync: nationalDex(94), tags: ["mega"] },
			...
			{
				id: 36, name: "Politoed", img: baseSprite(186), imgS: shinySprite(186), dexSync: nationalDex(186), tags: ["gender"], forms: [
			...
			{
				id: 51, name: "Murkrow", img: baseSprite(198), imgS: shinySprite(198), dexSync: nationalDex(198), tags: ["gender"], forms: [
			...
			{
				id: 57, name: "Ludicolo", img: baseSprite(272), imgS: shinySprite(272), dexSync: nationalDex(272), tags: ["gender"], forms: [
			...
			{
				id: 60, name: "Basculin", img: baseSprite(550), imgS: shinySprite(550), dexSync: nationalDex(550), tags: ["other"], forms: [
			...
			{
				id: 63, name: "Pumpkaboo", img: baseSprite(710), imgS: shinySprite(710), dexSync: nationalDex(710), tags: ["other"], forms: [
			...
			{
				id: 64, name: "Gourgeist", img: baseSprite(711), imgS: shinySprite(711), dexSync: nationalDex(711), tags: ["other"], forms: [
			...
			{
				id: 68, name: "Rotom", img: baseSprite(479), imgS: shinySprite(479), dexSync: nationalDex(479), tags: ["other"], forms: [
			...
			{
				id: 77, name: "Piloswine", img: baseSprite(221), imgS: shinySprite(221), dexSync: nationalDex(221), tags: ["gender"], forms: [
			...
			{
				id: 78, name: "Mamoswine", img: baseSprite(473), imgS: shinySprite(473), dexSync: nationalDex(473), tags: ["gender"], forms: [
			...
			{
				id: 88, name: "Snover", img: baseSprite(459), imgS: shinySprite(459), dexSync: nationalDex(459), tags: ["gender"], forms: [
			...
			{
				id: 89, name: "Abomasnow", img: baseSprite(460), imgS: shinySprite(460), dexSync: nationalDex(460), tags: ["gender", "mega"], forms: [
			...
			{
				id: 91, name: "Sneasel", img: baseSprite(215), imgS: shinySprite(215), dexSync: nationalDex(215), tags: ["gender"], forms: [
			...
			{ id: 101, name: "Aggron", img: baseSprite(306), imgS: shinySprite(306), dexSync: nationalDex(306), tags: ["mega"] },
			{ id: 102, name: "Larvitar", img: baseSprite(246), imgS: shinySprite(246), dexSync: nationalDex(246), tags: ["pseudo"] },
			{ id: 103, name: "Pupitar", img: baseSprite(247), imgS: shinySprite(247), dexSync: nationalDex(247), tags: ["pseudo"] },
			{ id: 104, name: "Tyranitar", img: baseSprite(248), imgS: shinySprite(248), dexSync: nationalDex(248), tags: ["pseudo", "mega"] },
			...
			{
				id: 115, name: "Gligar", img: baseSprite(207), imgS: shinySprite(207), dexSync: nationalDex(207), tags: ["gender"], forms: [
			...
			{ id: 123, name: "Banette", img: baseSprite(354), imgS: shinySprite(354), dexSync: nationalDex(354), tags: ["mega"] },
			...
			{
				id: 130, name: "Sudowoodo", img: baseSprite(185), imgS: shinySprite(185), dexSync: nationalDex(185), tags: ["gender"], forms: [
			...
			{
				id: 133, name: "Ursaring", img: baseSprite(217), imgS: shinySprite(217), dexSync: nationalDex(217), tags: ["gender"], forms: [
			...
			{
				id: 136, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), dexSync: nationalDex(123), tags: ["gender"], forms: [
			...
			{
				id: 137, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), dexSync: nationalDex(212), tags: ["gender", "mega"], forms: [
			...
			{ id: 142, name: "Deino", img: baseSprite(633), imgS: shinySprite(633), dexSync: nationalDex(633), tags: ["pseudo"] },
			{ id: 143, name: "Zweilous", img: baseSprite(634), imgS: shinySprite(634), dexSync: nationalDex(634), tags: ["pseudo"] },
			{ id: 144, name: "Hydreigon", img: baseSprite(635), imgS: shinySprite(635), dexSync: nationalDex(635), tags: ["pseudo"] },
			{ id: 145, name: "Dratini", img: baseSprite(147), imgS: shinySprite(147), dexSync: nationalDex(147), tags: ["pseudo"] },
			{ id: 146, name: "Dragonair", img: baseSprite(148), imgS: shinySprite(148), dexSync: nationalDex(148), tags: ["pseudo"] },
			{ id: 147, name: "Dragonite", img: baseSprite(149), imgS: shinySprite(149), dexSync: nationalDex(149), tags: ["pseudo"] },
			{ id: 148, name: "Xerneas", img: baseSprite(716), imgS: shinySprite(716), dexSync: nationalDex(716), tags: ["legendary"] },
			{ id: 149, name: "Yveltal", img: baseSprite(717), imgS: shinySprite(717), dexSync: nationalDex(717), tags: ["legendary"] },
			{ id: 150, name: "Zygarde", img: baseSprite(718), imgS: shinySprite(718), dexSync: nationalDex(718), maxStatus: "caught", tags: ["legendary"] },
			{ id: 151, name: "Mewtwo", img: baseSprite(150), imgS: shinySprite(150), dexSync: nationalDex(150), tags: ["mega", "legendary"] }
		]
	},
});
