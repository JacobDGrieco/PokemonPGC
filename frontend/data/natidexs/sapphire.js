		...
		[game + "-national"]: [
			...
			{ id: 385, natiId: 385, name: "Jirachi", img: baseSprite(385), imgS: shinySprite(385), tags: ["mythical"], },
			{
				id: 386, natiId: 386, name: "Deoxys", img: baseSprite(386), imgS: shinySprite(386), tags: ["mythical"], forms: [
					...
					{ name: "Attack", img: baseSprite("386-a"), imgS: baseSprite("386-a"), },
					{ name: "Defense", img: baseSprite("386-d"), imgS: baseSprite("386-d"), },
					{ name: "Speed", img: baseSprite("386-s"), imgS: baseSprite("386-s"), },
				],
			},
		],
	},
