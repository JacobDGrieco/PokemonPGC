...
PPGC.register({
	dex: {
		[game + "-national"]: [
			...
			{ id: 81, name: "Magnemite", img: baseSprite(81), imgS: shinySprite(81), dexSync: [regionalDex(178)], },
			{ id: 82, name: "Magneton", img: baseSprite(82), imgS: shinySprite(82), dexSync: [regionalDex(179)], },
			...
			{ id: 108, name: "Lickitung", img: baseSprite(108), imgS: shinySprite(108), dexSync: [regionalDex(161)], },
			{ id: 109, name: "Koffing", img: baseSprite(109), imgS: shinySprite(109), },
			{ id: 110, name: "Weezing", img: baseSprite(110), imgS: shinySprite(110), },
			{
				id: 111, name: "Rhyhorn", img: baseSprite(111), imgS: shinySprite(111), dexSync: [regionalDex(186)], forms: [
					{ name: "Male", img: baseSprite(111), imgS: shinySprite(111), dexSync: [regionalDex(186, "Male")], },
					{ name: "Female", img: baseSprite("111-f"), imgS: shinySprite("111-f"), dexSync: [regionalDex(186, "Female")], },
				],
			},
			{
				id: 112, name: "Rhydon", img: baseSprite(112), imgS: shinySprite(112), dexSync: [regionalDex(187)], forms: [
					{ name: "Male", img: baseSprite(112), imgS: shinySprite(112), dexSync: [regionalDex(187, "Male")], },
					{ name: "Female", img: baseSprite("112-f"), imgS: shinySprite("112-f"), dexSync: [regionalDex(187, "Female")], },
				],
			},
			{ id: 113, name: "Chansey", img: baseSprite(113), imgS: shinySprite(113), dexSync: [regionalDex(97)], },
			{ id: 114, name: "Tangela", img: baseSprite(114), imgS: shinySprite(114), dexSync: [regionalDex(181)], },
			...
			{
				id: 123, name: "Scyther", img: baseSprite(123), imgS: shinySprite(123), dexSync: [regionalDex(195)], forms: [
					{ name: "Male", img: baseSprite(123), imgS: shinySprite(123), dexSync: [regionalDex(195, "Male")], },
					{ name: "Female", img: baseSprite("123-f"), imgS: shinySprite("123-f"), dexSync: [regionalDex(195, "Female")], },
				],
			},
			{ id: 124, name: "Jynx", img: baseSprite(124), imgS: shinySprite(124), },
			{ id: 125, name: "Electabuzz", img: baseSprite(125), imgS: shinySprite(125), dexSync: [regionalDex(198)], },
			{ id: 126, name: "Magmar", img: baseSprite(126), imgS: shinySprite(126), dexSync: [regionalDex(201)], },
			...
			{ id: 133, name: "Eevee", img: baseSprite(133), imgS: shinySprite(133), dexSync: [regionalDex(163)], },
			{ id: 134, name: "Vaporeon", img: baseSprite(134), imgS: shinySprite(134), dexSync: [regionalDex(164)], },
			{ id: 135, name: "Jolteon", img: baseSprite(135), imgS: shinySprite(135), dexSync: [regionalDex(165)], },
			{ id: 136, name: "Flareon", img: baseSprite(136), imgS: shinySprite(136), dexSync: [regionalDex(166)], },
			{ id: 137, name: "Porygon", img: baseSprite(137), imgS: shinySprite(137), dexSync: [regionalDex(192)], },
			...
			{ id: 175, name: "Togepi", img: baseSprite(175), imgS: shinySprite(175), dexSync: [regionalDex(173)], },
			{ id: 176, name: "Togetic", img: baseSprite(176), imgS: shinySprite(176), dexSync: [regionalDex(174)], },
			...
			{ id: 193, name: "Yanma", img: baseSprite(193), imgS: shinySprite(193), dexSync: [regionalDex(183)], },
			{
			...
			{ id: 196, name: "Espeon", img: baseSprite(196), imgS: shinySprite(196), dexSync: [regionalDex(167)], },
			{ id: 197, name: "Umbreon", img: baseSprite(197), imgS: shinySprite(197), dexSync: [regionalDex(168)], },
			{
			...
			{
				id: 207, name: "Gligar", img: baseSprite(207), imgS: shinySprite(207), dexSync: [regionalDex(153)], forms: [
					{ name: "Male", img: baseSprite(207), imgS: shinySprite(207), dexSync: [regionalDex(153, "Male")], },
					{ name: "Female", img: baseSprite("207-f"), imgS: shinySprite("207-f"), dexSync: [regionalDex(153, "Female")], },
				],
			},
			{
			...
			{
				id: 212, name: "Scizor", img: baseSprite(212), imgS: shinySprite(212), dexSync: [regionalDex(196)], forms: [
					{ name: "Male", img: baseSprite(212), imgS: shinySprite(212), dexSync: [regionalDex(196, "Male")], },
					{ name: "Female", img: baseSprite("212-f"), imgS: shinySprite("212-f"), dexSync: [regionalDex(196, "Female")], },
				],
			},
			...
			{ id: 220, name: "Swinub", img: baseSprite(220), imgS: shinySprite(220), dexSync: [regionalDex(203)], },
			{
				id: 221, name: "Piloswine", img: baseSprite(221), imgS: shinySprite(221), dexSync: [regionalDex(204)], forms: [
					{ name: "Male", img: baseSprite(221), imgS: shinySprite(221), dexSync: [regionalDex(204, "Male")], },
					{ name: "Female", img: baseSprite("221-f"), imgS: shinySprite("221-f"), dexSync: [regionalDex(204, "Female")], },
				],
			},
			...
			{ id: 228, name: "Houndour", img: baseSprite(228), imgS: shinySprite(228), dexSync: [regionalDex(176)], },
			{
				id: 229, name: "Houndoom", img: baseSprite(229), imgS: shinySprite(229), dexSync: [regionalDex(177)], forms: [
					{ name: "Male", img: baseSprite(229), imgS: shinySprite(229), dexSync: [regionalDex(177, "Male")], },
					{ name: "Female", img: baseSprite("229-f"), imgS: shinySprite("229-f"), dexSync: [regionalDex(177, "Female")], },
				],
			},
			...
			{ id: 233, name: "Porygon2", img: baseSprite(233), imgS: shinySprite(233), dexSync: [regionalDex(193)], },
			...
			{ id: 239, name: "Elekid", img: baseSprite(239), imgS: shinySprite(239), dexSync: [regionalDex(197)], },
			{ id: 240, name: "Magby", img: baseSprite(240), imgS: shinySprite(240), dexSync: [regionalDex(200)], },
			...
			{ id: 280, name: "Ralts", img: baseSprite(280), imgS: shinySprite(280), dexSync: [regionalDex(157)], },
			{ id: 281, name: "Kirlia", img: baseSprite(281), imgS: shinySprite(281), dexSync: [regionalDex(158)], },
			{ id: 282, name: "Gardevoir", img: baseSprite(282), imgS: shinySprite(282), dexSync: [regionalDex(159)], },
			...
			{ id: 299, name: "Nosepass", img: baseSprite(299), imgS: shinySprite(299), dexSync: [regionalDex(155)], },
			...
			{ id: 333, name: "Swablu", img: baseSprite(333), imgS: shinySprite(333), dexSync: [regionalDex(171)], },
			{ id: 334, name: "Altaria", img: baseSprite(334), imgS: shinySprite(334), dexSync: [regionalDex(172)], },
			...
			{ id: 355, name: "Duskull", img: baseSprite(355), imgS: shinySprite(355), dexSync: [regionalDex(189)], },
			{ id: 356, name: "Dusclops", img: baseSprite(356), imgS: shinySprite(356), dexSync: [regionalDex(190)], },
			{ id: 357, name: "Tropius", img: baseSprite(357), imgS: shinySprite(357), dexSync: [regionalDex(185)], },
			{ id: 358, name: "Chimecho", img: baseSprite(358), imgS: shinySprite(358), dexSync: [regionalDex(83)], },
			{ id: 359, name: "Absol", img: baseSprite(359), imgS: shinySprite(359), dexSync: [regionalDex(209)], },
			{ id: 360, name: "Wynaut", img: baseSprite(360), imgS: shinySprite(360), },
			{ id: 361, name: "Snorunt", img: baseSprite(361), imgS: shinySprite(361), dexSync: [regionalDex(206)], },
			{ id: 362, name: "Glalie", img: baseSprite(362), imgS: shinySprite(362), dexSync: [regionalDex(207)], },
			...
			{ id: 411, name: "Bastiodon", img: baseSprite(411), imgS: shinySprite(411), dexSync: [regionalDex(39)], },
			{
				id: 412, name: "Burmy", img: baseSprite(412), imgS: shinySprite(412), dexSync: [regionalDex(45)], forms: [
					{ name: "Plant Cloak", img: baseSprite(412), imgS: shinySprite(412), dexSync: [regionalDex(45, "Plant Cloak")], },
			...
			},
			{
				id: 413, name: "Wormadam", img: baseSprite(413), imgS: shinySprite(413), dexSync: [regionalDex(46)], forms: [
					{ name: "Plant Cloak", img: baseSprite(413), imgS: shinySprite(413), dexSync: [regionalDex(46, "Plant Cloak")], },
			...
			{ id: 420, name: "Cherubi", img: baseSprite(420), imgS: shinySprite(420), dexSync: [regionalDex(58)], },
			{
				id: 421, name: "Cherrim", img: baseSprite(421), imgS: shinySprite(421), dexSync: [regionalDex(59)], forms: [
					{ name: "Overcast", img: baseSprite(421), imgS: shinySprite(421), dexSync: [regionalDex(59, "Overcast")], },
			...
			},
			{
				id: 422, name: "Shellos", img: baseSprite(422), imgS: shinySprite(422), dexSync: [regionalDex(60)], forms: [
					{ name: "West Sea", img: baseSprite(422), imgS: shinySprite(422), dexSync: [regionalDex(60, "West Sea")], },
			...
			},
			{
				id: 423, name: "Gastrodon", img: baseSprite(423), imgS: shinySprite(423), dexSync: [regionalDex(61)], forms: [
					{ name: "West Sea", img: baseSprite(423), imgS: shinySprite(423), dexSync: [regionalDex(61, "West Sea")], },
			...
			{ id: 462, name: "Magnezone", img: baseSprite(462), imgS: shinySprite(462), dexSync: [regionalDex(180)], },
			{ id: 463, name: "Lickilicky", img: baseSprite(463), imgS: shinySprite(463), dexSync: [regionalDex(162)], },
			{
				id: 464, name: "Rhyperior", img: baseSprite(464), imgS: shinySprite(464), dexSync: [regionalDex(188)], forms: [
					{ name: "Male", img: baseSprite(464), imgS: shinySprite(464), dexSync: [regionalDex(188, "Male")], },
					{ name: "Female", img: baseSprite("464-f"), imgS: shinySprite("464-f"), dexSync: [regionalDex(188, "Female")], },
				],
			},
			{
				id: 465, name: "Tangrowth", img: baseSprite(465), imgS: shinySprite(465), dexSync: [regionalDex(182)], forms: [
					{ name: "Male", img: baseSprite(465), imgS: shinySprite(465), dexSync: [regionalDex(182, "Male")], },
					{ name: "Female", img: baseSprite("465-f"), imgS: shinySprite("465-f"), dexSync: [regionalDex(182, "Female")], },
				],
			},
			{ id: 466, name: "Electivire", img: baseSprite(466), imgS: shinySprite(466), dexSync: [regionalDex(199)], },
			{ id: 467, name: "Magmortar", img: baseSprite(467), imgS: shinySprite(467), dexSync: [regionalDex(202)], },
			{ id: 468, name: "Togekiss", img: baseSprite(468), imgS: shinySprite(468), dexSync: [regionalDex(175)], },
			{ id: 469, name: "Yanmega", img: baseSprite(469), imgS: shinySprite(469), dexSync: [regionalDex(184)], },
			{ id: 470, name: "Leafeon", img: baseSprite(470), imgS: shinySprite(470), dexSync: [regionalDex(169)], },
			{ id: 471, name: "Glaceon", img: baseSprite(471), imgS: shinySprite(471), dexSync: [regionalDex(170)], },
			{ id: 472, name: "Gliscor", img: baseSprite(472), imgS: shinySprite(472), dexSync: [regionalDex(154)], },
			{
				id: 473, name: "Mamoswine", img: baseSprite(473), imgS: shinySprite(473), dexSync: [regionalDex(205)], forms: [
					{ name: "Male", img: baseSprite(473), imgS: shinySprite(473), dexSync: [regionalDex(205, "Male")], },
					{ name: "Female", img: baseSprite("473-f"), imgS: shinySprite("473-f"), dexSync: [regionalDex(205, "Female")], },
				],
			},
			{ id: 474, name: "Porygon-Z", img: baseSprite(474), imgS: shinySprite(474), dexSync: [regionalDex(194)], },
			{ id: 475, name: "Gallade", img: baseSprite(475), imgS: shinySprite(475), dexSync: [regionalDex(160)], },
			{ id: 476, name: "Probopass", img: baseSprite(476), imgS: shinySprite(476), dexSync: [regionalDex(156)], },
			{ id: 477, name: "Dusknoir", img: baseSprite(477), imgS: shinySprite(477), dexSync: [regionalDex(191)], },
			{ id: 478, name: "Froslass", img: baseSprite(478), imgS: shinySprite(478), dexSync: [regionalDex(208)], },
			{
				id: 479, name: "Rotom", img: baseSprite(479), imgS: shinySprite(479), dexSync: [regionalDex(152)], forms: [
					{ name: "Normal", img: baseSprite(479), imgS: shinySprite(479), dexSync: [regionalDex(152, "Normal")], },
					{ name: "Fan", img: baseSprite("479-fa"), imgS: shinySprite("479-fa"), dexSync: [regionalDex(152, "Fan")], },
					{ name: "Frost", img: baseSprite("479-fr"), imgS: shinySprite("479-fr"), dexSync: [regionalDex(152, "Frost")], },
					{ name: "Heat", img: baseSprite("479-h"), imgS: shinySprite("479-h"), dexSync: [regionalDex(152, "Heat")], },
					{ name: "Mow", img: baseSprite("479-m"), imgS: shinySprite("479-m"), dexSync: [regionalDex(152, "Mow")], },
					{ name: "Wash", img: baseSprite("479-w"), imgS: shinySprite("479-w"), dexSync: [regionalDex(152, "Wash")], },
				],
			},
			...
			{
				id: 487, name: "Giratina", img: baseSprite(487), imgS: shinySprite(487), dexSync: [regionalDex(210)], forms: [
					{ name: "Altered", img: baseSprite(487), imgS: shinySprite(487), dexSync: [regionalDex(210, "Altered")], },
					{ name: "Origin", img: baseSprite("487-o"), imgS: shinySprite("487-o"), dexSync: [regionalDex(210, "Origin")], },
				],
			},
			...
			{ id: 490, name: "Manaphy", img: baseSprite(490), imgS: shinySprite(490), dexSync: [regionalDex(151)], mythical: true, },
