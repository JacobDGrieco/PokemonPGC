...
(function () {
	...
	const formsCatalog = {
		...
		492: { // Shaymin
			"land": { label: "Land", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"sky": { label: "Sky", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
		},
		493: { // Arceus
			"normal": { label: "Normal", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"bug": { label: "Bug", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			...
			"ghost": { label: "Ghost", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"grass": { label: "Grass", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"ground": { label: "Ground", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"ice": { label: "Ice", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"poison": { label: "Poison", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
			"psychic": { label: "Psychic", games: formSearch("gen4", "gen5", "gen6", "gen7", "bdsp", "la"), },
		...
		641: { // Tornadus
			"incarnate": { label: "Incarnate", games: formSearch("bw2", "gen6", "gen7", "la"), },
			"therian": { label: "Therian", games: formSearch("bw2", "gen6", "gen7", "la"), },
		},
		642: { // Thundurus
			"incarnate": { label: "Incarnate", games: formSearch("bw2", "gen6", "gen7", "la"), },
			"therian": { label: "Therian", games: formSearch("bw2", "gen6", "gen7", "la"), },
		...
		646: { // Kyurem
			"normal": { label: "Normal", games: formSearch("bw2", "gen6", "gen7"), },
			"black-kyurem": { label: "Black", games: formSearch("bw2", "gen6", "gen7"), },
			"white-kyurem": { label: "White", games: formSearch("bw2", "gen6", "gen7"), },
		},
		647: { // Keldeo
			"ordinary": { label: "Ordinary", games: formSearch("bw2", "gen6", "gen7", "swsh", "lza"), },
			"resolute": { label: "Resolute", games: formSearch("bw2", "gen6", "gen7", "swsh", "lza"), },
		},
		648: { // Meloetta
		...
		649: { // Genesect
			"normal": { label: "Incarnate", games: formSearch("gen5", "gen6", "gen7", "lza"), },
			"burn-drive": { label: "Burn Drive", games: formSearch("gen5", "gen6", "gen7", "lza"), },
			"chill-drive": { label: "Chill Drive", games: formSearch("gen5", "gen6", "gen7", "lza"), },
			"douse-drive": { label: "Douse Drive", games: formSearch("gen5", "gen6", "gen7", "lza"), },
			"shock-drive": { label: "Shock Drive", games: formSearch("gen5", "gen6", "gen7", "lza"), },
		},
		...
		716: { // Xerneas
			"neutral": { label: "Neutral", games: formSearch("gen6", "gen7", "lza"), },
			"active": { label: "Active", games: formSearch("gen6", "gen7", "lza"), },
		},
		718: { // Zygarde
		...
		720: { // Hoopa
			"confined": { label: "Confined", games: formSearch("gen6", "gen7", "lza"), },
			"unbound": { label: "Unbound", games: formSearch("gen6", "gen7", "lza"), },
		},
		...
		773: { // Silvally
			"normal": { label: "Normal", games: formSearch("gen7", "swsh"), },
			"bug": { label: "Bug", games: formSearch("gen7", "swsh"), },
			"dark": { label: "Dark", games: formSearch("gen7", "swsh"), },
			"dragon": { label: "Dragon", games: formSearch("gen7", "swsh"), },
			"electric": { label: "Electric", games: formSearch("gen7", "swsh"), },
			"fairy": { label: "Fairy", games: formSearch("gen7", "swsh"), },
			"fighting": { label: "Fighting", games: formSearch("gen7", "swsh"), },
			"fire": { label: "Fire", games: formSearch("gen7", "swsh"), },
			"flying": { label: "Flying", games: formSearch("gen7", "swsh"), },
			"ghost": { label: "Ghost", games: formSearch("gen7", "swsh"), },
			"grass": { label: "Grass", games: formSearch("gen7", "swsh"), },
			"ground": { label: "Ground", games: formSearch("gen7", "swsh"), },
			"ice": { label: "Ice", games: formSearch("gen7", "swsh"), },
			"poison": { label: "Poison", games: formSearch("gen7", "swsh"), },
			"psychic": { label: "Psychic", games: formSearch("gen7", "swsh"), },
			"rock": { label: "Rock", games: formSearch("gen7", "swsh"), },
			"steel": { label: "Steel", games: formSearch("gen7", "swsh"), },
			"water": { label: "Water", games: formSearch("gen7", "swsh"), },
		},
		774: { // Minior
		...
		800: { // Necrozma
			"normal": { label: "Normal", games: formSearch("usum"), },
			"dusk-mane": { label: "Dusk Mane", games: formSearch("usum"), },
			"dawn-wings": { label: "Dawn Wings", games: formSearch("usum"), },
		...
		802: { // Marshadow
			"normal": { label: "Normal", games: formSearch("gen7", "lza"), },
			"zenith": { label: "Zenith", games: formSearch("gen7", "lza"), },
		},
		807: { // Zeraora
			"normal": { label: "Normal", games: formSearch("lza"), },
			"mega": { label: "Mega", games: formSearch("lza"), },
		...
		888: { // Zacian
			"hero-of-many-battles": { label: "Hero of Many Battles", games: formSearch("swsh"), },
			"crowned-sword": { label: "Crowned Sword", games: formSearch("swsh"), },
		},
		889: { // Zamazenta
			"hero-of-many-battles": { label: "Hero of Many Battles", games: formSearch("swsh"), },
			"crowned-shield": { label: "Crowned Shield", games: formSearch("swsh"), },
		},
		890: { // Eternatus
			"normal": { label: "Normal", games: formSearch("swsh"), },
		...
		892: { // Urshifu
			"single-strike-style": { label: "Single Strike Style", games: formSearch("swsh"), },
			"rapid-strike-style": { label: "Rapid Strike Style", games: formSearch("swsh"), },
		...
		893: { // Zarude
			"normal": { label: "Normal", games: formSearch("swsh"), },
			"dada": { label: "Dada", games: formSearch("swsh"), },
		},
		898: { // Calyrex
			"normal": { label: "Normal", games: formSearch("swsh"), },
			"ice-rider": { label: "Ice Rider", games: formSearch("swsh"), },
			"shadow-rider": { label: "Shadow Rider", games: formSearch("swsh"), },
		},
		...
		905: { // Enamorus
			"incarnate": { label: "Incarnate", games: formSearch("la"), },
			"therian": { label: "Therian", games: formSearch("la"), },
		},
