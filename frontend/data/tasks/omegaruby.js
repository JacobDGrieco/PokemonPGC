		...
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					{ id: catching + "-1-01", text: "Trade for Kyogre", img: baseSprite(382), dexSync: [regionalDex(207), nationalDex(382)], },
					{ id: catching + "-1-02", text: "Catch Groudon", img: baseSprite(383), dexSync: [regionalDex(208), nationalDex(383)], },
