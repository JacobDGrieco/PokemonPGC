		...
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					{ id: catching + "-1-01", text: "Catch Xerneas", img: baseSprite(716), dexSync: [mountainDex(148), nationalDex(716)], },
					{ id: catching + "-1-02", text: "Trade for Yveltal", img: baseSprite(717), dexSync: [mountainDex(149), nationalDex(717)], },
