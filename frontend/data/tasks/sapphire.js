...
PPGC.register({
	...
	tasks: {
		...
		[story]: [
			{ id: story + "-1", text: "Collect all 8 Gym Badges and Defeat the Elite 4", img: _badges(["stone", "knuckle", "dynamo", "heat", "balance", "feather", "mind", "rain"]), noCenter: true, syncs: ["sapphire-upgrades-2-01"] },
		],
		[activities]: [
			{
				id: activities + "-1", text: "Master all the Contests", noCenter: true, syncs: ["sapphire-upgrades-2-02"], children: [
		...
		[upgrades]: [
			{ id: upgrades + "-1", text: "Obtain the National PokeDex", noCenter: true },
			{
				id: upgrades + "-2", text: "Obtain the Gold 4-Star Trainer Card", noCenter: true, children: [
					{ id: upgrades + "-2-01", text: "Defeat the Elite 4/Champion", syncs: ["sapphire-story-1"] },
					{ id: upgrades + "-2-02", text: "Win all Master Rank Contests", syncs: ["sapphire-activities-1"] },
