...
PPGC.register({
	...
	tasks: {
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					...
					{ id: catching + "-1-02", text: "Trade for Groudon", img: baseSprite(383), dexSync: [regionalDex(199), nationalDex(383)] },
					...
					{ id: catching + "-1-07", text: "Catch Latias", img: baseSprite(380), dexSync: [regionalDex(196), nationalDex(380)] },
					{ id: catching + "-1-08", text: "Trade for Latios", img: baseSprite(381), dexSync: [regionalDex(197), nationalDex(381)] },
				],
			},
			{
		...
		[story]: [
			{ id: story + "-1", text: "Collect all 8 Gym Badges and Defeat the Elite 4", img: _badges(["stone", "knuckle", "dynamo", "heat", "balance", "feather", "mind", "rain"]), noCenter: true, taskSync: ["sapphire-upgrades-2-01"] },
		],
		[activities]: [
			{
				id: activities + "-1", text: "Master all the Contests", noCenter: true, taskSync: ["sapphire-upgrades-2-02"], children: [
		...
		[battle]: [
			{ id: battle + "-1", text: "Master the Battle Tower", noCenter: true, type: "tiered", tiers: ["Singles", "Doubles", "Multi"], currentTier: 0, currentCount: 0, unit: "completed", },
		...
		[upgrades]: [
			{ id: upgrades + "-1", text: "Obtain the National PokeDex", noCenter: true },
			{
				id: upgrades + "-2", text: "Obtain the Gold 4-Star Trainer Card", noCenter: true, children: [
					{ id: upgrades + "-2-01", text: "Defeat the Elite 4/Champion", taskSync: ["sapphire-story-1"] },
					{ id: upgrades + "-2-02", text: "Win all Master Rank Contests", taskSync: ["sapphire-activities-1"] },
