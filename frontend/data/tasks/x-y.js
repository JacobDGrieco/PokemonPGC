(() => {
	...
	const TASKS_BY_SECTION = {
		...
		"mega-stones": [
			...
			{ id: 5, text: "Alakazite", img: () => [baseSprite("065-m"), megaStone("alakazite")], },
			{ id: 6, text: "Gengarite", img: () => [baseSprite("094-m"), megaStone("gengarite")], },
			{ id: 7, text: "Kangaskhanite", img: () => [baseSprite("115-m"), megaStone("kangaskhanite")], },
			{ id: 8, text: "Pinsirite", img: () => [baseSprite("127-m"), megaStone("pinsirite")], },
			{ id: 9, text: "Gyaradosite", img: () => [baseSprite("130-m"), megaStone("gyaradosite")], },
			{ id: 10, text: "Aerodactylite", img: () => [baseSprite("142-m"), megaStone("aerodactylite")], },
			{ id: 11, text: "Mewtwonite X", img: () => [baseSprite("150-mx"), megaStone("mewtwonite-x")], },
			{ id: 12, text: "Mewtwonite Y", img: () => [baseSprite("150-my"), megaStone("mewtwonite-y")], },
			{ id: 13, text: "Ampharosite", img: () => [baseSprite("181-m"), megaStone("ampharosite")], },
			{ id: 14, text: "Scizorite", img: () => [baseSprite("212-m"), megaStone("scizorite")], },
			{ id: 15, text: "Heracronite", img: () => [baseSprite("214-m"), megaStone("heracronite")], },
			{ id: 16, text: "Houndoominite", img: () => [baseSprite("229-m"), megaStone("houndoominite")], },
			{ id: 17, text: "Tyranitarite", img: () => [baseSprite("248-m"), megaStone("tyranitarite")], },
			{ id: 18, text: "Gardevoirite", img: () => [baseSprite("282-m"), megaStone("gardevoirite")], },
			{ id: 19, text: "Mawilite", img: () => [baseSprite("303-m"), megaStone("mawilite")], },
			{ id: 20, text: "Aggronite", img: () => [baseSprite("306-m"), megaStone("aggronite")], },
			{ id: 21, text: "Medichamite", img: () => [baseSprite("308-m"), megaStone("medichamite")], },
			{ id: 22, text: "Manectite", img: () => [baseSprite("310-m"), megaStone("manectite")], },
			{ id: 23, text: "Banettite", img: () => [baseSprite("354-m"), megaStone("banettite")], },
			{ id: 24, text: "Absolite", img: () => [baseSprite("359-m"), megaStone("absolite")], },
			{ id: 25, text: "Garchompite", img: () => [baseSprite("445-m"), megaStone("garchompite")], },
			{ id: 26, text: "Abomasite", img: () => [baseSprite("460-m"), megaStone("abomasite")], },
		],
		"thms": [
			{
