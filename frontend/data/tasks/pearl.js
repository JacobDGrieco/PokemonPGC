...
PPGC.register({
	...
	tasks: {
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					{ id: catching + "-1-01", text: "Trade for Dialga", img: baseSprite("483"), dexSync: [regionalDex(149), nationalDex(483)] },
					{ id: catching + "-1-02", text: "Catch Palkia", img: baseSprite("484"), dexSync: [regionalDex(150), nationalDex(484)] },
			...
			{ id: catching + "-3", text: "Catch Spiritomb", img: baseSprite("442") },
			{
				id: catching + "-4", text: "Obtain all In-Game Gift Pokémon", children: [
					...
					{ id: catching + "-4-02", text: "Happiny Egg", img: baseSprite("440") },
					{ id: catching + "-4-03", text: "Eevee", img: baseSprite("133") },
					{ id: catching + "-4-04", text: "Riolu", img: baseSprite("447") },
				]
			},
			{
		...
		[battle]: [
			{
				id: battle + "-1", text: "Defeat Tower Tycoon Palmer in Single Battles", children: [
					{ id: battle + "-1-01", text: "After 21st Battle" },
					{ id: battle + "-1-02", text: "After 49th Battle" },
				],
			},
			{
				id: battle + "-2", text: "Defeat Tower Tycoon Palmer in Double Battles", children: [
					{ id: battle + "-2-01", text: "After 21st Battle" },
					{ id: battle + "-2-02", text: "After 49th Battle" },
				],
			},
		],
		[upgrades]: [
