		...
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					...
					{ id: catching + "-1-04", text: "Catch Mewtwo", img: baseSprite(150), imgS: shinySprite(150), tooltip: "Found at the bottom of Cerulean Cave", syncs: ["blue-story-2-01"], dexSync: [regionalDex(150)] },
				],
			},
			{
		...
		[story]: [
			{ id: story + "-1", text: "Collect all 8 Gym Badges and Defeat the Elite 4", img: _badges(["boulder", "cascade", "thunder", "rainbow", "soul", "marsh", "volcano", "earth"]), noCenter: true, },
			{
				id: story + "-2", text: "Epilogue", noCenter: true, children: [
					{ id: story + "-2-01", text: "Catch Mewtwo", img: baseSprite(150), imgS: shinySprite(150), tooltip: "Found at the bottom of Cerulean Cave", syncs: ["blue-catching-1-04"], dexSync: [regionalDex(150)] },
				],
			},
		],
		[collectables]: [
