...
PPGC.register({
	...
	tasks: {
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					...
					{ id: catching + "-1-09", text: "Trade for Ho-Oh", img: baseSprite(250), dexSync: [regionalDex(248)] },
				],
			},
		...
		[sideQuests]: [
			...
			{ id: sideQuests + "-5", text: "Return the lost doll", img: item("lost-item-mj"), tooltip: "The woman is in Saffron City" },
			{
