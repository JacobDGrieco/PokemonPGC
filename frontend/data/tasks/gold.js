...
PPGC.register({
	...
	tasks: {
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					...
					{ id: catching + "-1-08", text: "Trade for Lugia", img: baseSprite(249), dexSync: [regionalDex(247)] },
			...
			{ id: catching + "-4", text: "Catch/Defeat the Snorlax in Vermillion City", done: false, img: baseSprite(143) },
			{
				id: catching + "-5", text: "Obtain all In-Game Gift Pokémon", children: [
					{ id: catching + "-5-01", text: "Spearow", img: baseSprite(21) },
					{ id: catching + "-5-02", text: "Eevee", img: baseSprite(133) },
					{ id: catching + "-5-03", text: "Togepi", img: baseSprite(175) },
					{ id: catching + "-5-04", text: "Shuckle", img: baseSprite(213) },
					{ id: catching + "-5-05", text: "Tyrogue", img: baseSprite(236) },
				],
			},
			{
		...
		[story]: [
			{ id: story + "-1", text: "Collect all 8 Gym Badges and Defeat the Elite 4", img: _badges(["zephyr", "hive", "plain", "fog", "storm", "mineral", "glacier", "rising"]), noCenter: true },
			{
				id: story + "-2", text: "Explore the Kanto Region", children: [
					...
					{ id: story + "-2-03", text: "Defeat Blaine", img: npc("blaine"), tooltip: "Can be found at the Seafoam Islands", taskSync: ["gold-story-3-07"] },
			...
			},
			{
				id: story + "-3", text: "Collect all 8 Kanto Gym Badges", children: [
					...
					{ id: story + "-3-07", text: "Volcano Badge", img: _badges("volcano"), tooltip: "Defeat Blane at the Seafoam Islands", taskSync: ["gold-story-2-03"] },
		...
		[collectables]: [
			...
			{ id: collectables + "-2", text: "Find all hidden items with the Item Finder", img: item("item-finder"), noCenter: true, type: "tiered", tiers: [range(1, 88)], },
		],
		[thms]: [
			{
