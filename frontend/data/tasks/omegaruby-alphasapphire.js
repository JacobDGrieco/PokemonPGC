(() => {
	...
	const TASKS_BY_SECTION = {
		...
		"mega-stones": [
			{ id: 1, text: "Venusaurite", img: () => [baseSprite("003-m"), megaStone("venusaurite")], },
			{ id: 2, text: "Charizardite X", img: () => [baseSprite("006-mx"), megaStone("charizardite-x")], },
			{ id: 3, text: "Charizardite Y", img: () => [baseSprite("006-my"), megaStone("charizardite-y")], },
			{ id: 4, text: "Blastoisinite", img: () => [baseSprite("009-m"), megaStone("blastoisinite")], },
			{ id: 5, text: "Beedrillite", img: () => [baseSprite("015-m"), megaStone("beedrillite")], },
			{ id: 6, text: "Pidgeotite", img: () => [baseSprite("018-m"), megaStone("pidgeotite")], },
			{ id: 7, text: "Alakazite", img: () => [baseSprite("065-m"), megaStone("alakazite")], },
			{ id: 8, text: "Slowbronite", img: () => [baseSprite("080-m"), megaStone("slowbronite")], },
			{ id: 9, text: "Gengarite", img: () => [baseSprite("094-m"), megaStone("gengarite")], },
			{ id: 10, text: "Kangaskhanite", img: () => [baseSprite("115-m"), megaStone("kangaskhanite")], },
			{ id: 11, text: "Pinsirite", img: () => [baseSprite("127-m"), megaStone("pinsirite")], },
			{ id: 12, text: "Gyaradosite", img: () => [baseSprite("130-m"), megaStone("gyaradosite")], },
			{ id: 13, text: "Aerodactylite", img: () => [baseSprite("142-m"), megaStone("aerodactylite")], },
			{ id: 14, text: "Mewtwonite X", img: () => [baseSprite("150-mx"), megaStone("mewtwonite-x")], },
			{ id: 15, text: "Mewtwonite Y", img: () => [baseSprite("150-my"), megaStone("mewtwonite-y")], },
			{ id: 16, text: "Ampharosite", img: () => [baseSprite("181-m"), megaStone("ampharosite")], },
			{ id: 17, text: "Steelixite", img: () => [baseSprite("208-m"), megaStone("steelixite")], },
			{ id: 18, text: "Scizorite", img: () => [baseSprite("212-m"), megaStone("scizorite")], },
			{ id: 19, text: "Heracronite", img: () => [baseSprite("214-m"), megaStone("heracronite")], },
			{ id: 20, text: "Houndoominite", img: () => [baseSprite("229-m"), megaStone("houndoominite")], },
			{ id: 21, text: "Tyranitarite", img: () => [baseSprite("248-m"), megaStone("tyranitarite")], },
			{ id: 22, text: "Sceptilite", img: () => [baseSprite("254-m"), megaStone("sceptilite")], },
			{ id: 23, text: "Blazikenite", img: () => [baseSprite("257-m"), megaStone("blazikenite")], },
			{ id: 24, text: "Swampertite", img: () => [baseSprite("260-m"), megaStone("swampertite")], },
			{ id: 25, text: "Gardevoirite", img: () => [baseSprite("282-m"), megaStone("gardevoirite")], },
			{ id: 26, text: "Sablenite", img: () => [baseSprite("302-m"), megaStone("sablenite")], },
			{ id: 27, text: "Mawilite", img: () => [baseSprite("303-m"), megaStone("mawilite")], },
			{ id: 28, text: "Aggronite", img: () => [baseSprite("306-m"), megaStone("aggronite")], },
			{ id: 29, text: "Medichamite", img: () => [baseSprite("308-m"), megaStone("medichamite")], },
			{ id: 30, text: "Manectite", img: () => [baseSprite("310-m"), megaStone("manectite")], },
			{ id: 31, text: "Sharpedonite", img: () => [baseSprite("319-m"), megaStone("sharpedonite")], },
			{ id: 32, text: "Cameruptite", img: () => [baseSprite("323-m"), megaStone("cameruptite")], },
			{ id: 33, text: "Altarianite", img: () => [baseSprite("334-m"), megaStone("altarianite")], },
			{ id: 34, text: "Banettite", img: () => [baseSprite("354-m"), megaStone("banettite")], },
			{ id: 35, text: "Absolite", img: () => [baseSprite("359-m"), megaStone("absolite")], },
			{ id: 36, text: "Glalitite", img: () => [baseSprite("362-m"), megaStone("glalitite")], },
			{ id: 37, text: "Salamenceite", img: () => [baseSprite("373-m"), megaStone("salamencite")], },
			{ id: 38, text: "Metagrossite", img: () => [baseSprite("376-m"), megaStone("metagrossite")], },
			{ id: 39, text: "Latiasite", img: () => [baseSprite("380-m"), megaStone("latiasite")] },
			{ id: 40, text: "Latiosite", img: () => [baseSprite("381-m"), megaStone("latiosite")] },
			{ id: 41, text: "Lopunnite", img: () => [baseSprite("428-m"), megaStone("lopunnite")], },
			{ id: 42, text: "Garchompite", img: () => [baseSprite("445-m"), megaStone("garchompite")], },
			{ id: 43, text: "Lucarionite", img: () => [baseSprite("448-m"), megaStone("lucarionite")], },
			{ id: 44, text: "Abomasite", img: () => [baseSprite("460-m"), megaStone("abomasite")], },
			{ id: 45, text: "Galladite", img: () => [baseSprite("475-m"), megaStone("galladite")], },
			{ id: 46, text: "Audinite", img: () => [baseSprite("531-m"), megaStone("audinite")], },
		],
		"thms": [
			{
		...
		"extra-credit": [
			{
				id: 1, text: "Get Mega Stones from Distributions", children: [
					{ id: 1, text: "Diancite", img: () => [baseSprite("719-m"), megaStone("diancite")], },
				],
			},
		]
	};
