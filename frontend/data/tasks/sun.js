...
PPGC.register({
	...
	tasks: {
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					{ id: catching + "-1-01", text: "Catch Solgaleo", img: baseSprite(791), dexSync: [alolaDex(291)], },
					{ id: catching + "-1-02", text: "Trade for Lunala", img: baseSprite(792), dexSync: [alolaDex(292)], },
					{ id: catching + "-1-03", text: "Catch Necrozma", img: baseSprite(800), dexSync: [alolaDex(293)], },
				],
			},
		],
		[megaStones]: [
			...
			{ id: megaStones + "-06", text: "Slowbronite", img: [baseSprite("080-m"), megaStone("slowbronite")], },
			{ id: megaStones + "-07", text: "Gengarite", img: [baseSprite("094-m"), megaStone("gengarite")], },
			{ id: megaStones + "-08", text: "Kangaskhanite", img: [baseSprite("115-m"), megaStone("kangaskhanite")], },
			{ id: megaStones + "-09", text: "Pinsirite", img: [baseSprite("127-m"), megaStone("pinsirite")], },
			{ id: megaStones + "-10", text: "Gyaradosite", img: [baseSprite("130-m"), megaStone("gyaradosite")], },
			{ id: megaStones + "-11", text: "Aerodactylite", img: [baseSprite("142-m"), megaStone("aerodactylite")], },
			{ id: megaStones + "-12", text: "Scizorite", img: [baseSprite("212-m"), megaStone("scizorite")], },
			{ id: megaStones + "-13", text: "Sablenite", img: [baseSprite("302-m"), megaStone("sablenite")], },
			{ id: megaStones + "-14", text: "Sharpedonite", img: [baseSprite("319-m"), megaStone("sharpedonite")], },
			{ id: megaStones + "-15", text: "Absolite", img: [baseSprite("359-m"), megaStone("absolite")], },
			{ id: megaStones + "-16", text: "Glalitite", img: [baseSprite("362-m"), megaStone("glalitite")], },
			{ id: megaStones + "-17", text: "Salamenceite", img: [baseSprite("373-m"), megaStone("salamencite")], },
			{ id: megaStones + "-18", text: "Metagrossite", img: [baseSprite("376-m"), megaStone("metagrossite")], },
			{ id: megaStones + "-19", text: "Garchompite", img: [baseSprite("445-m"), megaStone("garchompite")], },
			{ id: megaStones + "-20", text: "Lucarionite", img: [baseSprite("448-m"), megaStone("lucarionite")], },
		],
		[zCrystals]: [
			{
		...
		[thms]: [
			{
				id: thms + "-1", text: "Obtain all Ride Pokemon", children: [
					...
					{ id: thms + "-1-04", text: "Charizard Glide", img: hm("charizard-glide") },
					{ id: thms + "-1-05", text: "Mudsdale Gallop", img: hm("mudsdale-gallop") },
					{ id: thms + "-1-06", text: "Sharpedo Jet", img: hm("sharpedo-jet") },
					{ id: thms + "-1-07", text: "Machamp Shove", img: hm("machamp-shove") },
				],
			},
			{
		...
		[extraCredit]: [
			{
				id: extraCredit + "-1", text: "Get Mega Stones from Distribution Codes", children: [
					{ id: extraCredit + "-1-01", text: "Beedrillite", img: [baseSprite("015-m"), megaStone("beedrillite")], },
					{ id: extraCredit + "-1-02", text: "Pidgeotite", img: [baseSprite("018-m"), megaStone("pidgeotite")], },
					{ id: extraCredit + "-1-03", text: "Mewtwonite X", img: [baseSprite("150-mx"), megaStone("mewtwonite-x")], },
					{ id: extraCredit + "-1-04", text: "Mewtwonite Y", img: [baseSprite("150-my"), megaStone("mewtwonite-y")], },
					{ id: extraCredit + "-1-05", text: "Ampharosite", img: [baseSprite("181-m"), megaStone("ampharosite")], },
					{ id: extraCredit + "-1-06", text: "Steelixite", img: [baseSprite("208-m"), megaStone("steelixite")], },
					{ id: extraCredit + "-1-07", text: "Heracronite", img: [baseSprite("214-m"), megaStone("heracronite")], },
					{ id: extraCredit + "-1-08", text: "Houndoominite", img: [baseSprite("229-m"), megaStone("houndoominite")], },
					{ id: extraCredit + "-1-09", text: "Tyranitarite", img: [baseSprite("248-m"), megaStone("tyranitarite")], },
					{ id: extraCredit + "-1-10", text: "Sceptilite", img: [baseSprite("254-m"), megaStone("sceptilite")], },
					{ id: extraCredit + "-1-11", text: "Blazikenite", img: [baseSprite("257-m"), megaStone("blazikenite")], },
					{ id: extraCredit + "-1-12", text: "Swampertite", img: [baseSprite("260-m"), megaStone("swampertite")], },
					{ id: extraCredit + "-1-13", text: "Gardevoirite", img: [baseSprite("282-m"), megaStone("gardevoirite")], },
					{ id: extraCredit + "-1-14", text: "Mawilite", img: [baseSprite("303-m"), megaStone("mawilite")], },
					{ id: extraCredit + "-1-15", text: "Aggronite", img: [baseSprite("306-m"), megaStone("aggronite")], },
					{ id: extraCredit + "-1-16", text: "Medichamite", img: [baseSprite("308-m"), megaStone("medichamite")], },
					{ id: extraCredit + "-1-17", text: "Manectite", img: [baseSprite("310-m"), megaStone("manectite")], },
					{ id: extraCredit + "-1-18", text: "Cameruptite", img: [baseSprite("323-m"), megaStone("cameruptite")], },
					{ id: extraCredit + "-1-19", text: "Altarianite", img: [baseSprite("334-m"), megaStone("altarianite")], },
					{ id: extraCredit + "-1-20", text: "Banettite", img: [baseSprite("354-m"), megaStone("banettite")], },
					{ id: extraCredit + "-1-21", text: "Latiasite", img: [baseSprite("380-m"), megaStone("latiasite")] },
					{ id: extraCredit + "-1-22", text: "Latiosite", img: [baseSprite("381-m"), megaStone("latiosite")] },
					{ id: extraCredit + "-1-23", text: "Lopunnite", img: [baseSprite("428-m"), megaStone("lopunnite")], },
