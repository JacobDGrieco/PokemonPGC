		...
		[sideQuests]: [
			...
			},
			{
				id: sideQuests + "-2", text: "Complete all Side Quests", children: [
					...
					{ id: sideQuests + "-2-20", text: "Quest 139 - ", },
					{ id: sideQuests + "-2-21", text: "Quest 140 - ", },
					{ id: sideQuests + "-2-22", text: "Quest 141 - ", },
					{ id: sideQuests + "-2-23", text: "Quest 142 - That's Some Nacli Coffee", },
					{ id: sideQuests + "-2-24", text: "Quest 143 - Which Meowth Do You Purrfer", },
					{ id: sideQuests + "-2-25", text: "Quest 144 - Imitation Is the Sincerest Form of Flattery", },
					{ id: sideQuests + "-2-26", text: "Quest 145 - My Neightbor Tinkatuff", },
					{ id: sideQuests + "-2-27", text: "Quest 146 - Terror in the Sands", },
					{ id: sideQuests + "-2-28", text: "Quest 147 - Our Gluttonous Gulpin", },
					{ id: sideQuests + "-2-29", text: "Quest 148 - A Sorta Scary Cemetary Story", },
					{ id: sideQuests + "-2-30", text: "Quest 149 - Scovillain's Spice-Off", },
					{ id: sideQuests + "-2-31", text: "Quest 150 - Corvisquire's Search", },
				],
			},
