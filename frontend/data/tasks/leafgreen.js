		...
		[catching]: [
			{
				id: catching + "-1", text: "Catch all the Legendaries", children: [
					...
					{ id: catching + "-1-04", text: "Catch Mewtwo", img: baseSprite(150), syncs: ["leafgreen-story-2-01"], dexSync: [regionalDex(150), nationalDex(150)] },
		...
		[story]: [
			{ id: story + "-1", text: "Collect all 8 Gym Badges and Defeat the Elite 4", img: _badges(["boulder", "cascade", "thunder", "rainbow", "soul", "marsh", "volcano", "earth"]), noCenter: true },
			{
				id: story + "-2", text: "Epilogue", noCenter: true, children: [
					{ id: story + "-2-01", text: "Catch Mewtwo", img: baseSprite(150), tooltip: "Found at the bottom of Cerulean Cave", syncs: ["leafgreen-catching-1-04"], dexSync: [regionalDex(150), nationalDex(150)] },
				],
			},
		],
		[battle]: [
		...
		[upgrades]: [
			{ id: upgrades + "-1", text: "Obtain the National Dex", img: item("kanto-nati-dex"), noCenter: true },
			{
				id: upgrades + "-2", text: "Obtain the Gold 4 Star Trainer Card", children: [
					{ id: upgrades + "-2-01", text: "Collect all 8 Gym Badges and Defeat the Elite 4", syncs: ["leafgreen-story-1"] },
