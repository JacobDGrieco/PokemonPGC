		...
		[story]: [
			{ id: story + "-1", text: "Collect all 8 Gym Badges and Defeat the Elite 4", img: _badges(["zephyr", "hive", "plain", "fog", "storm", "mineral", "glacier", "rising"]), noCenter: true },
			{
				id: story + "-2", text: "Explore the Kanto Region", children: [
					...
					{ id: story + "-2-03", text: "Defeat Blaine", img: npc("blaine"), tooltip: "Can be found at the Seafoam Islands", taskSync: ["crystal-story-3-07"] },
			...
			},
			{
				id: story + "-3", text: "Collect all 8 Kanto Gym Badges", children: [
					...
					{ id: story + "-3-07", text: "Volcano Badge", img: _badges("volcano"), tooltip: "Defeat Blane at the Seafoam Islands", taskSync: ["crystal-story-2-03"] },
