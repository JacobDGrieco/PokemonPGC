		...
		desktop: {
			taskRows: {
				[catching]: [
					...
					[catching + "-1-05", catching + "-1-06", catching + "-1-07"],
					[catching + "-2"],
					[catching + "-2-01", catching + "-2-02"],
					[catching + "-3"],
					[catching + "-3-01", catching + "-3-02", catching + "-3-03"],
					[catching + "-3-04", catching + "-3-05", catching + "-3-06"],
					[catching + "-4"],
				...
				[battle]: [
					...
					[battle + "-2-03", battle + "-2-04"],
				],
				[upgrades]: [
					[upgrades + "-1"],
					[upgrades + "-2"],
					[upgrades + "-2-01", upgrades + "-2-02", upgrades + "-2-03"],
					[upgrades + "-2-04", upgrades + "-2-05"],
				],
				[collectables]: [
					[collectables + "-1"],
				...
				[thms]: [
					...
					[thms + "-1-05", thms + "-1-06", thms + "-1-07", spacer],
					[thms + "-2"],
