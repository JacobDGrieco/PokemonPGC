		...
		desktop: {
			taskRows: {
				...
				[battle]: [
					[battle + "-1"],
					[battle + "-2"],
					[battle + "-2-01", battle + "-2-02", battle + "-2-03", battle + "-2-04"],
					[battle + "-3"],
					[battle + "-3-01", battle + "-3-02", battle + "-3-03"],
					[battle + "-4"],
					[battle + "-4-01", battle + "-4-02", battle + "-4-03", battle + "-4-04"],
					[battle + "-4-05", battle + "-4-06", battle + "-4-07", spacer],
					[battle + "-5"],
					[battle + "-5-01", battle + "-5-02", battle + "-5-03", battle + "-5-04"],
					[battle + "-5-05", battle + "-5-06", battle + "-5-07", spacer],
				],
				[upgrades]: [
					[upgrades + "-1"],
					[upgrades + "-2"],
