...
defineSyncsMany(GAME_KEYS, (gameKey, { taskSync, regionalSync, nationalSync }) => [
...
defineSyncsMany(GAME_KEYS2, (gameKey, { taskSync, regionalSync, nationalSync }) => [
...
defineSyncsMany([GAME_KEYS[0], GAME_KEYS[1]], (gameKey, { taskSync, regionalSync, nationalSync }) => [
	{ name: "Obtain Deoxys", members: [taskSync("extra-credit", 2), regionalSync(202, "Normal"), nationalSync(386, "Normal")], },
]);
defineSyncsMany([GAME_KEYS[2]], (gameKey, { taskSync, regionalSync, nationalSync }) => [
