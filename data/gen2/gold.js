PPGC.register({
    ...
    tasks: {
        "gold-catching": [
            {
                id: "gold-catching-1", text: "Catch all the Legendaries", done: false, children: [
            ...
            {
                id: "gold-catching-2", text: "Catch/Defeat the Sudowoodo on Route 36", done: false
            },
            {
                id: "gold-catching-3", text: "Catch/Defeat the \"Red\" Gyarados at the Lake of Rage", done: false
            },
            {
                id: "gold-catching-4", text: "Catch the Lapras in Union Cave", done: false
            },
            {
                id: "gold-catching-5", text: "Catch/Defeat the Snorlax in Vermillion City", done: false
            },
            {
                id: "gold-catching-6", text: "Obtain all In-Game Gift Pokemon", done: false, children: [
            ...
            {
                id: "gold-catching-7", text: "Complete all In-Game Trades", done: false, children: [
                    ...
                    { id: "gold-catching-7-d", text: "Dragonair for Rhydon", done: false },
                    { id: "gold-catching-7-e", text: "Gloom for Rapidash", done: false },
                    { id: "gold-catching-7-f", text: "Chansey for Aerodactyl", done: false },
                ]
            },
        ],
        "gold-story": [
            ...
            {
                id: "gold-story-2", text: "Epilogue", done: false, children: [
                    { id: "gold-story-2-a", text: "Restore power to the Kanto Power Plant", done: false },
                    { id: "gold-story-2-b", text: "Find Champion Blue on Cinnabar Island", done: false },
                    { id: "gold-story-2-c", text: "Defeat Blain on the Seafoam Islands", done: false },
                    { id: "gold-story-2-d", text: "Defeat Red atop Mt. Silver", done: false },
                    {
                        id: "gold-story-2-e", text: "Collect all 8 Kanto Gym Badges", done: false, children: [
        ...
        "gold-sidequests": [
            { id: "gold-sidequests-1", text: "Show Elm the hatched egg", done: false },
            { id: "gold-sidequests-2", text: "Deliver the mail for the guard on Route 36 to the fat guy on Route 31", done: false },
            { id: "gold-sidequests-3", text: "Cure the Miltank on Route 39", done: false },
            { id: "gold-sidequests-4", text: "Talk to Mary in the Radio Tower after beating Team Rocket", done: false },
            { id: "gold-sidequests-5", text: "Return the lost doll to the woman in Saffrom City", done: false },
            {
                id: "gold-sidequests-6", text: "Meet all the Week Siblings", done: false, children: [
        ...
        "gold-collectables": [
            ...
            { id: "gold-collectables-3", text: "Obtain the Squirtbottle", done: false },
            { id: "gold-collectables-4", text: "Obtain the Exp. Share", done: false },
            { id: "gold-collectables-5", text: "Obtain the EXPN Card", done: false },
            {
                id: "gold-collectables-6", text: "Obtain all 3 fishing rods", done: false, children: [
            ...
            { id: "gold-collectables-7", text: "Obtain the Item Finder", done: false },
            { id: "gold-collectables-8", text: "Find all hidden items with the Item Fidner", done: false }, // need to add a number input 0-88
        ],
        "gold-thms": [
            {
                id: "gold-thms-1", text: "Collect all HMs", done: false, children: [
