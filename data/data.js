...
PPGC.register({
  ...
  games: {
    ...
    gen8: [
      ...
      {
        key: "shield-ct",
        label: "Shield - Crown Tunrdra DLC",
        color: "#0c343d",
        flags: ["shiny", "caught", "seen", "unknown"],
        completionFlags: ["shiny", "caught"],
      },
    ...
    gen10: [
      ...
      {
        key: "legends-za-md",
        label: "Legends: Z-A - Mega Dimensions DLC",
        color: "#64f29b",
        flags: ["shiny alpha", "shiny", "alpha", "caught", "seen", "unknown"],
        completionFlags: ["shiny alpha", "shiny", "alpha", "caught"],
      },
  ...
  layout: {
    gameRows: {
      ...
      gen7_2: [["lets-go-pikachu", "lets-go-eevee"]],
      gen8: [
        ["sword", "sword-ioa", "sword-ct"],
        ["shield", "shield-ioa", "shield-ct"],
      ],
      gen8_2: [["brilliant-diamond", "shining-pearl", "legends-arceus"]],
      gen9: [
        ["scarlet", "scarlet-tm", "scarlet-id"],
        ["violet", "violet-tm", "violet-id"],
      ],
      gen10: [["legends-za", "legends-za-md"]],
    },
  },
