...
PPGC.register({
  ...
  games: {
    ...
    gen6: [
      ...
      { key: "omegaruby", label: "Omega Ruby", color: "#ff0000", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "alphasapphire", label: "Alpha Sapphire", color: "#1155cc", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
    ],
    gen7: [
      ...
      { key: "ultrasun", label: "Ultra Sun", color: "#f5ad58", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "ultramoon", label: "Ultra Moon", color: "#674ea7", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
    ],
    gen7_2: [
      { key: "lgp", label: "Let's Go, Pikachu!", color: "#ffff00", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "lge", label: "Let's Go, Eevee!", color: "#b45f06", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
    ],
    gen8: [
      { key: "sword", label: "Sword", color: "#0b5394", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "swordioa", label: "Sword - Isle of Armor DLC", color: "#c5980f", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "swordct", label: "Sword - Crown Tundra DLC", color: "#0c343d", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "shield", label: "Shield", color: "#ee4444", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "shieldioa", label: "Shield - Isle of Armor DLC", color: "#c5980f", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "shieldct", label: "Shield - Crown Tunrdra DLC", color: "#0c343d", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
    ],
    gen8_2: [
      { key: "brilliantdiamond", label: "Brilliant Diamond", color: "#00ffff", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "shiningpearl", label: "Shining Pearl", color: "#a2c4c9", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "legendsarceus", label: "Legends: Arceus", color: "#999999", flags: ["shiny alpha", "shiny", "alpha", "caught", "seen", "unknown"], completionFlags: ["shiny alpha", "shiny", "alpha", "caught"] },
    ],
    gen9: [
      { key: "scarlet", label: "Scarlet", color: "#ff2400", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "scarlettm", label: "Scarlet - Teal Mask DLC", color: "#008080", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "scarletid", label: "Scarlet - Indigo Disk DLC", color: "#4b0082", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "violet", label: "Violet", color: "#8f00ff", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "violettm", label: "Violet - Teal Mask DLC", color: "#008080", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
      { key: "violetid", label: "Violet - Indigo Disk DLC", color: "#4b0082", flags: ["shiny", "caught", "seen", "unknown"], completionFlags: ["shiny", "caught"] },
    ],
    gen10: [
      { key: "legendsza", label: "Legends: Z-A", color: "#64f29b", flags: ["shiny alpha", "shiny", "alpha", "caught", "seen", "unknown"], completionFlags: ["shiny alpha", "shiny", "alpha", "caught"] },
      { key: "legendszamd", label: "Legends: Z-A - Mega Dimensions DLC", color: "#64f29b", flags: ["shiny alpha", "shiny", "alpha", "caught", "seen", "unknown"], completionFlags: ["shiny alpha", "shiny", "alpha", "caught"] },
    ],
  },
