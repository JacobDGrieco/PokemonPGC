PPGC.register({
    ...
    tasks: {
        "red-catching": [
            {
                id: "red-catching-1", text: "Catch all the Legendaries", done: false, children: [
                    { id: "red-catching-1-a", text: "Catch Articuno", done: false },
                    { id: "red-catching-1-b", text: "Catch Zapdos", done: false },
                    { id: "red-catching-1-c", text: "Catch Moltres", done: false },
                    { id: "red-catching-1-d", text: "Catch Mewtwo", done: false },
                ]
            },
            {
                id: "red-catching-2", text: "Obtain all the Mythicals", done: false, children: [
                    { id: "red-catching-2-a", text: "Obtain Mew", done: false },
                ]
            },
            {
                id: "red-catching-3", text: "Catch both Snorlax", done: false, children: [
                    { id: "red-catching-3-a", text: "Route 12", done: false },
                    { id: "red-catching-3-b", text: "Route 16", done: false }
                ]
            },
            {
                id: "red-catching-4", text: "Obtain all In-Game Gift Pokemon", done: false, children: [
            ...
            {
                id: "red-catching-5", text: "Complete all In-Game Trades", done: false, children: [
                    { id: "red-catching-5-a", text: "Abra for Mr. Mime", done: false },
                    { id: "red-catching-5-b", text: "Nidoran ♂ for Nidoran ♀	", done: false },
                    { id: "red-catching-5-c", text: "Nidorino for Nidorina", done: false },
                    { id: "red-catching-5-d", text: "Slowbro for Lickitung", done: false },
                    { id: "red-catching-5-e", text: "Poliwhirl for Jynx", done: false },
                    { id: "red-catching-5-f", text: "Spearow for Farfetch'd", done: false },
        ...
        "red-thms": [
            {
                id: "red-thms-1", text: "Collect all HMs", done: false, children: [
